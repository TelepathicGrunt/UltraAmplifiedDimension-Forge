...
public class UADFeatures {
    ...
    public static final RegistryObject<Feature<NoFeatureConfig>> CONTAIN_LIQUID_FOR_OCEANS = FEATURES.register("contain_liquid_for_oceans", () -> new ContainLiquidForOceans(NoFeatureConfig.field_236558_a_));
    public static final RegistryObject<Feature<NoFeatureConfig>> CONTAIN_UNDERGROUND_LIQUIDS = FEATURES.register("contain_underground_liquids", () -> new ContainUndergroundLiquids(NoFeatureConfig.field_236558_a_));
    ...
    public static final RegistryObject<Feature<BlockStateFeatureConfig>> LAKE_WIDE_SHALLOW = FEATURES.register("lake_wide_shallow", () -> new LakeWideShallow(BlockStateFeatureConfig.field_236455_a_));
    ...
    public static final RegistryObject<Feature<NoFeatureConfig>> NETHER_SEA_ADJUSTER = FEATURES.register("nether_sea_adjuster", () -> new NetherSeaAdjuster(NoFeatureConfig.field_236558_a_));
    public static final RegistryObject<Feature<NoFeatureConfig>> NETHER_LAVA_SPOT = FEATURES.register("nether_lava_spot", () -> new NetherLavaSpot(NoFeatureConfig.field_236558_a_));
    public static final RegistryObject<Feature<RootConfig>> ROOTS = FEATURES.register("roots", () -> new Roots(RootConfig.CODEC));
    public static final RegistryObject<Feature<NoFeatureConfig>> SNOW_ICE_LAYER_HANDLER_FEATURE = FEATURES.register("snow_ice_layer_handler_feature", () -> new SnowIceLayerHandlerFeature(NoFeatureConfig.field_236558_a_));
    public static final RegistryObject<Feature<NoFeatureConfig>> SNOW_ICE_ALL_LAYERS = FEATURES.register("snow_ice_all_layers", () -> new SnowIceAllLayers(NoFeatureConfig.field_236558_a_));
    public static final RegistryObject<Feature<NoFeatureConfig>> SNOW_ICE_TOP_LAYER = FEATURES.register("snow_ice_top_layer", () -> new SnowIceTopLayer(NoFeatureConfig.field_236558_a_));
    public static final RegistryObject<Feature<NoFeatureConfig>> SNOW_LAYER_WITHOUT_ICE = FEATURES.register("snow_layer_without_ice", () -> new SnowLayerWithoutIceFeature(NoFeatureConfig.field_236558_a_));
    ...
    public static final RegistryObject<Feature<NoFeatureConfig>> SWAMP_CROSS = FEATURES.register("swamp_cross", () -> new SwampCross(NoFeatureConfig.field_236558_a_));
    ...
    public static final RegistryObject<Feature<NoFeatureConfig>> VINES_LONG = FEATURES.register("vines_long", () -> new VinesLong(NoFeatureConfig.field_236558_a_));
    ...
    public static final RegistryObject<Feature<NoFeatureConfig>> HANGING_RUINS = FEATURES.register("hanging_ruins", () -> new HangingRuins(NoFeatureConfig.field_236558_a_));
    ...
    public static final RegistryObject<Feature<BlockStateFeatureConfig>> ICEBERG_WITHOUT_AIR = FEATURES.register("iceberg_without_air", () -> new IcebergWithoutAir(BlockStateFeatureConfig.field_236455_a_));
