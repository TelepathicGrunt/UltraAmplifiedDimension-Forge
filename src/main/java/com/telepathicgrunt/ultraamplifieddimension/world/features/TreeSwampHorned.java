...
public class TreeSwampHorned extends AbstractTreeFeature<TreeFeatureConfig>
{
	...
	@Override
	public boolean generate(ISeedReaderGenerationReader worldReader, Random rand, BlockPos position, Set<BlockPos> leafSet, Set<BlockPos> trunkSet, MutableBoundingBox boundingBox, TreeFeatureConfig p_225557_7_)
	{
