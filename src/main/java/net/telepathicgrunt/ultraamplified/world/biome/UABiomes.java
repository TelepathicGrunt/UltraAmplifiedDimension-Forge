...
public class UABiomes
{
	...
	public static void registerBiomes(RegistryEvent.Register<Biome> event)
	{
		...
		ROCKY_FIELD = initBiome(registry, new RockyFieldBiomeUA(), "rocky_field", BiomeType.COOL, Type.MOUNTAIN, Type.HILLS);
		...
		END_FIELD = initBiome(registry, new EndFieldBiomeUA(), "end_field", BiomeType.COOL, Type.END, Type.SPOOKY, Type.COLD, Type.DRY);
		SNOWY_TUNDRA = initBiome(registry, new SnowyTundraBiomeUA(), "snowy_tundra", BiomeType.ICY, Type.COLD, Type.WASTELAND, Type.SNOWY);
		ICED_TERRAIN = initBiome(registry, new IcedTerrainBiomeUA(), "iced_terrain", BiomeType.ICY, Type.COLD, Type.MOUNTAIN, Type.SNOWY);
		MUSHROOM_FIELDS = initBiome(registry, new MushroomFieldsBiomeUA(), "mushroom_field", BiomeType.WARM, Type.MAGICAL, Type.MUSHROOM, Type.RARE);
		RELIC_DESERT = initBiome(registry, new DesertRelicBiomeUA(), "relic_desert", BiomeType.DESERT, Type.DRY, Type.HOT, Type.SANDY, Type.HILLS);
		RELIC_FOREST = initBiome(registry, new ForestRelicBiomeUA(), "relic_forest", BiomeType.WARM, Type.FOREST, Type.DENSE, Type.HILLS);
		RELIC_TAIGA = initBiome(registry, new TaigaRelicBiomeUA(), "relic_taiga", BiomeType.COOL, Type.CONIFEROUS);
		BAMBOO_JUNGLE = initBiome(registry, new BambooJungleBiomeUA(), "bamboo_jungle", BiomeType.WARM, Type.HOT, Type.WET, Type.DENSE, Type.JUNGLE);
		RELIC_BAMBOO_JUNGLE = initBiome(registry, new BambooJungleRelicBiomeUA(), "relic_bamboo_jungle", BiomeType.WARM, Type.HOT, Type.WET, Type.DENSE, Type.JUNGLE);
		JUNGLE = initBiome(registry, new JungleBiomeUA(), "jungle", BiomeType.WARM, Type.HOT, Type.WET, Type.DENSE, Type.JUNGLE);
		RELIC_JUNGLE = initBiome(registry, new JungleRelicBiomeUA(), "relic_jungle", BiomeType.WARM, Type.HOT, Type.WET, Type.DENSE, Type.JUNGLE, Type.HILLS);
		JUNGLE_EDGE = initBiome(registry, new JungleEdgeBiomeUA(), "jungle_edge", BiomeType.WARM, Type.HOT, Type.WET, Type.DENSE, Type.JUNGLE, Type.RARE);
		STONE_PLAINS = initBiome(registry, new StonePlainsBiomeUA(), "stone_plains", BiomeType.COOL, Type.BEACH);
		FROZEN_DESERT = initBiome(registry, new FrozenDesertBiomeUA(), "frozen_desert", BiomeType.ICY, Type.BEACH, Type.SNOWY, Type.COLD);
		BIRCH_FOREST = initBiome(registry, new BirchForestBiomeUA(), "birch_forest", BiomeType.WARM, Type.FOREST);
		RELIC_BIRCH_FOREST = initBiome(registry, new BirchForestBiomeUA(), "relic_birch_forest", BiomeType.WARM, Type.FOREST, Type.HILLS);
		DARK_FOREST = initBiome(registry, new DarkForestBiomeUA(), "dark_forest", BiomeType.WARM, Type.FOREST, Type.DENSE, Type.SPOOKY);
		SNOWY_TAIGA = initBiome(registry, new SnowyTaigaBiomeUA(), "snowy_taiga", BiomeType.ICY, Type.FOREST, Type.CONIFEROUS, Type.SNOWY, Type.COLD);
		RELIC_SNOWY_TAIGA = initBiome(registry, new SnowyTaigaRelicBiomeUA(), "relic_snowy_taiga", BiomeType.ICY, Type.FOREST, Type.CONIFEROUS, Type.SNOWY, Type.COLD, Type.HILLS);
		GIANT_TREE_TAIGA = initBiome(registry, new GiantTreeTaigaBiomeUA(), "giant_tree_taiga", BiomeType.COOL, Type.COLD, Type.CONIFEROUS, Type.FOREST);
		RELIC_GIANT_TREE_TAIGA = initBiome(registry, new GiantTreeTaigaRelicBiomeUA(), "relic_giant_tree_taiga", BiomeType.COOL, Type.COLD, Type.CONIFEROUS, Type.FOREST, Type.HILLS);
		WOODED_ROCKY_FIELD = initBiome(registry, new RockyFieldWoodedBiomeUA(), "wooden_rocky_field", BiomeType.COOL, Type.MOUNTAIN, Type.FOREST, Type.SPARSE);
		SAVANNA = initBiome(registry, new SavannaBiomeUA(), "savanna", BiomeType.DESERT, Type.HOT, Type.SAVANNA, Type.PLAINS, Type.SPARSE);
		SAVANNA_TERRACE = initBiome(registry, new SavannaTerraceBiomeUA(), "savanna_terrace", BiomeType.DESERT, Type.HOT, Type.SAVANNA, Type.PLAINS, Type.SPARSE, Type.RARE);
		BADLANDS = initBiome(registry, new BadlandsBiomeUA(), "badlands", BiomeType.DESERT, Type.MESA, Type.SANDY);
		WOODED_BADLANDS = initBiome(registry, new BadlandsWoodedBiomeUA(), "wooded_badlands", BiomeType.DESERT, Type.MESA, Type.SANDY, Type.SPARSE);
		SANDLESS_BADLANDS = initBiome(registry, new BadlandsSandlessBiomeUA(), "sandless_badlands", BiomeType.DESERT, Type.MESA, Type.SANDY);
		SUNFLOWER_PLAINS = initBiome(registry, new SunflowerPlainsBiomeUA(), "sunflower_plains", BiomeType.WARM, Type.PLAINS, Type.RARE);
		DESERT_LAKES = initBiome(registry, new DesertLakesBiomeUA(), "desert_lakes", BiomeType.DESERT, Type.HOT, Type.SANDY, Type.RARE);
		GRAVELLY_FIELD = initBiome(registry, new GravellyFieldBiomeUA(), "gravelly_field", BiomeType.COOL, Type.MOUNTAIN, Type.SPARSE, Type.RARE);
		FLOWER_FOREST = initBiome(registry, new FlowerForestBiomeUA(), "flower_forest", BiomeType.WARM, Type.FOREST, Type.HILLS, Type.RARE);
		ROCKY_TAIGA = initBiome(registry, new TaigaRockyBiomeUA(), "rocky_taiga", BiomeType.COOL, Type.COLD, Type.CONIFEROUS, Type.FOREST, Type.MOUNTAIN, Type.RARE);
		SPOOKY_SWAMP = initBiome(registry, new SwampSpookyBiomeUA(), "spooky_swampland", BiomeType.WARM, Type.SWAMP, Type.WET, Type.HILLS, Type.RARE);
		ICE_SPIKES = initBiome(registry, new IceSpikesBiomeUA(), "ice_spikes", BiomeType.ICY, Type.COLD, Type.SNOWY, Type.HILLS, Type.RARE);
		FLOWER_JUNGLE = initBiome(registry, new FlowerJungleBiomeUA(), "flower_jungle", BiomeType.WARM, Type.HOT, Type.WET, Type.JUNGLE, Type.MOUNTAIN, Type.RARE, Type.DENSE);
		FLOWER_JUNGLE_EDGE = initBiome(registry, new FlowerJungleEdgeBiomeUA(), "flower_jungle_edge", BiomeType.WARM, Type.HOT, Type.SPARSE, Type.HILLS, Type.JUNGLE, Type.RARE);
		TALL_BIRCH_FOREST = initBiome(registry, new TallBirchForestBiomeUA(), "tall_birch_forest", BiomeType.WARM, Type.FOREST, Type.DENSE, Type.HILLS, Type.RARE);
		RELIC_TALL_BIRCH_FOREST = initBiome(registry, new TallBirchForestRelicBiomeUA(), "relic_tall_birch_forest", BiomeType.WARM, Type.FOREST, Type.DENSE, Type.MOUNTAIN, Type.RARE);
		RELIC_DARK_FOREST = initBiome(registry, new DarkForestRelicBiomeUA(), "relic_dark_forest", BiomeType.WARM, Type.SPOOKY, Type.DENSE, Type.FOREST, Type.MOUNTAIN, Type.RARE);
		SNOWY_ROCKY_TAIGA = initBiome(registry, new SnowyTaigaRockyBiomeUA(), "snowy_rocky_taiga", BiomeType.ICY, Type.COLD, Type.SNOWY, Type.CONIFEROUS, Type.MOUNTAIN, Type.FOREST, Type.RARE);
		GIANT_SPRUCE_TAIGA_PILLARS = initBiome(registry, new GiantSpruceTaigaPillarsBiomeUA(), "giant_spruce_taiga_pillars", BiomeType.COOL, Type.DENSE, Type.FOREST, Type.RARE);
		RELIC_GIANT_SPRUCE_TAIGA_PILLARS = initBiome(registry, new GiantSpruceTaigaRelicPillarsBiomeUA(), "relic_giant_spruce_taiga_pillars", BiomeType.COOL, Type.DENSE, Type.FOREST, Type.HILLS, Type.RARE);
		GRAVELLY_COLUMNS_FIELD = initBiome(registry, new GravellyColumnsFieldBiomeUA(), "gravelly_columns_field", BiomeType.COOL, Type.MOUNTAIN, Type.SPARSE, Type.RARE);
		SHATTERED_SAVANNA = initBiome(registry, new ShatteredSavannaBiomeUA(), "shattered_savanna", BiomeType.DESERT, Type.HOT, Type.DRY, Type.SPARSE, Type.SAVANNA, Type.MOUNTAIN, Type.RARE);
		SHATTERED_SAVANNA_TERRACE = initBiome(registry, new ShatteredSavannaTerraceBiomeUA(), "shattered_savanna_terrace", BiomeType.DESERT, Type.HOT, Type.DRY, Type.SPARSE, Type.SAVANNA, Type.HILLS, Type.RARE);
		SPIKY_BADLANDS = initBiome(registry, new BadlandsSpikyBiomeUA(), "spiky_badlands", BiomeType.DESERT, Type.HOT, Type.DRY, Type.SPARSE, Type.MESA, Type.MOUNTAIN, Type.RARE);
		DENSED_WOODED_BADLANDS = initBiome(registry, new BadlandsDensedWoodedBiomeUA(), "densed_wooded_badlands", BiomeType.DESERT, Type.HOT, Type.DRY, Type.SPARSE, Type.MESA, Type.HILLS, Type.RARE);
		DISSECTED_PLATEAU_BADLANDS = initBiome(registry, new BadlandsDissectedPlateauBiomeUA(), "dissected_plateau_badlands", BiomeType.DESERT, Type.HOT, Type.DRY, Type.SPARSE, Type.MESA, Type.MOUNTAIN, Type.RARE);
		COLD_OCEAN = initBiome(registry, new OceanColdBiomeUA(), "cold_ocean", BiomeType.COOL, Type.OCEAN);
		DEEP_COLD_OCEAN = initBiome(registry, new OceanDeepColdBiomeUA(), "deep_cold_ocean", BiomeType.COOL, Type.OCEAN, Type.COLD);
		DEEP_FROZEN_OCEAN = initBiome(registry, new OceanDeepFrozenBiomeUA(), "deep_frozen_ocean", BiomeType.ICY, Type.OCEAN, Type.COLD);
		DEEP_LUKEWARM_OCEAN = initBiome(registry, new OceanDeepLukewarmBiomeUA(), "deep_lukewarm_ocean", BiomeType.WARM, Type.OCEAN);
		DEEP_OCEAN = initBiome(registry, new OceanDeepBiomeUA(), "deep_ocean", BiomeType.COOL, Type.OCEAN);
		DEEP_WARM_OCEAN = initBiome(registry, new OceanDeepWarmBiomeUA(), "deep_warm_ocean", BiomeType.WARM, Type.OCEAN, Type.HOT);
		FROZEN_OCEAN = initBiome(registry, new OceanFrozenBiomeUA(), "frozen_ocean", BiomeType.ICY, Type.OCEAN, Type.COLD);
		LUKEWARM_OCEAN = initBiome(registry, new OceanLukewarmBiomeUA(), "lukewarm_ocean", BiomeType.WARM, Type.OCEAN);
		OCEAN = initBiome(registry, new OceanBiomeUA(), "ocean", BiomeType.COOL, Type.OCEAN);
		WARM_OCEAN = initBiome(registry, new OceanWarmBiomeUA(), "warm_ocean", BiomeType.WARM, Type.OCEAN, Type.HOT);
		BARREN_END_FIELD = initBiome(registry, new EndBarrenFieldBiomeUA(), "barren_end_field", BiomeType.COOL, Type.END, Type.SPOOKY, Type.COLD, Type.DRY);

		mapHillsBiomes();
		mapMBiomes();

		//adds to a list which we then need in biomeProviderUA
		allRegisteredBiomes = ImmutableSet.of(PLAINS, DESERT, ROCKY_FIELD, FOREST, TAIGA, SWAMP, NETHERLAND, END_FIELD, SNOWY_TUNDRA, ICED_TERRAIN, MUSHROOM_FIELDS, RELIC_DESERT, RELIC_FOREST, RELIC_TAIGA, BAMBOO_JUNGLE, RELIC_BAMBOO_JUNGLE, JUNGLE, RELIC_JUNGLE, JUNGLE_EDGE, STONE_PLAINS, FROZEN_DESERT, BIRCH_FOREST, RELIC_BIRCH_FOREST, DARK_FOREST, SNOWY_TAIGA, RELIC_SNOWY_TAIGA, GIANT_TREE_TAIGA, RELIC_GIANT_TREE_TAIGA, WOODED_ROCKY_FIELD, SAVANNA, SAVANNA_TERRACE, BADLANDS, WOODED_BADLANDS,
