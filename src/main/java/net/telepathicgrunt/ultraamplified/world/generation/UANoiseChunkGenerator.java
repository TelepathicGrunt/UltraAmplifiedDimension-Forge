...
public abstract class UANoiseChunkGenerator<T extends GenerationSettings> extends NoiseChunkGenerator<T>
{
    ...
    public UANoiseChunkGenerator(IWorld world, BiomeProvider biomeProvider, int horizontalNoiseGranularityIn, int verticalNoiseGranularityIn, int maximumHeight, T settings) {
	super(world, biomeProvider, horizontalNoiseGranularityIn, verticalNoiseGranularityIn, maximumHeight, settings, true);
    ...
    @Override
    protected double[] func_222547_b(int x, int z) {
