...
public class StrongholdPiecesUA
{
	...
	private static boolean canAddStructurePieces()
	{
		...
		for (StrongholdPiecesUA.PieceWeight structurestrongholdpieces$pieceweight : structurePieceList)
		{
			...
			if (structurestrongholdpieces$pieceweight.instancesLimit > 0)
			{
				...
				{
					int maxLimit = (int)(structurestrongholdpieces$pieceweight.instancesLimit * (UltraAmplified.UAStructuresConfig.strongholdSizeSH.get() * 0.01D));
	...
	private static StrongholdPiecesUA.Stronghold findAndCreatePieceFactory(Class<? extends StrongholdPiecesUA.Stronghold> clazz, List<StructurePiece> p_175954_1_, Random p_175954_2_, int p_175954_3_, int p_175954_4_, int p_175954_5_, @Nullable Direction p_175954_6_, int p_175954_7_)
	{
	...
	{
		int maxComponents = (int)(50 * (UltraAmplified.UAStructuresConfig.strongholdSizeSH.get() * 0.01D));
	...
	public static class ChestCorridor extends StrongholdPiecesUA.Stronghold
	{
		...
		public static StrongholdPiecesUA.ChestCorridor createPiece(List<StructurePiece> p_175868_0_, Random p_175868_1_, int p_175868_2_, int p_175868_3_, int p_175868_4_, Direction p_175868_5_, int p_175868_6_)
		{
		...
		public boolean create(IWorld world, ChunkGenerator<?> p_225577_2_, Random random, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_)
		{
			...
			this.placeDoor(world, random, structureBoundingBoxIn, StrongholdPiecesUA.Stronghold.Door.OPENING, 1, 1, 6);
	...
	public static class Crossing extends StrongholdPiecesUA.Stronghold
	{
		...
		public static StrongholdPiecesUA.Crossing createPiece(List<StructurePiece> p_175866_0_, Random p_175866_1_, int p_175866_2_, int p_175866_3_, int p_175866_4_, Direction p_175866_5_, int p_175866_6_)
		{
		...
		public boolean create(IWorld world, ChunkGenerator<?> p_225577_2_, Random random, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_)
		{
			...
			this.fillWithRandomizedBlocks(world, structureBoundingBoxIn, 1, 2, 1, 8, 2, 6, false, random, StrongholdPiecesUA.STRONGHOLD_STONES);
			this.fillWithRandomizedBlocks(world, structureBoundingBoxIn, 4, 1, 5, 4, 4, 9, false, random, StrongholdPiecesUA.STRONGHOLD_STONES);
			this.fillWithRandomizedBlocks(world, structureBoundingBoxIn, 8, 1, 5, 8, 4, 9, false, random, StrongholdPiecesUA.STRONGHOLD_STONES);
			this.fillWithRandomizedBlocks(world, structureBoundingBoxIn, 1, 4, 7, 3, 4, 9, false, random, StrongholdPiecesUA.STRONGHOLD_STONES);
			this.fillWithRandomizedBlocks(world, structureBoundingBoxIn, 1, 3, 5, 3, 3, 6, false, random, StrongholdPiecesUA.STRONGHOLD_STONES);
			...
			this.fillWithRandomizedBlocks(world, structureBoundingBoxIn, 5, 1, 7, 7, 1, 8, false, random, StrongholdPiecesUA.STRONGHOLD_STONES);
	...
	public static class LeftTurn extends StrongholdPiecesUA.Turn
	{
		...
		public static StrongholdPiecesUA.LeftTurn createPiece(List<StructurePiece> p_175867_0_, Random p_175867_1_, int p_175867_2_, int p_175867_3_, int p_175867_4_, Direction p_175867_5_, int p_175867_6_)
		{
	...
	public static class Library extends StrongholdPiecesUA.Stronghold
	{
		...
		public static StrongholdPiecesUA.Library createPiece(List<StructurePiece> p_175864_0_, Random p_175864_1_, int p_175864_2_, int p_175864_3_, int p_175864_4_, Direction p_175864_5_, int p_175864_6_)
		{
		...
		public boolean create(IWorld world, ChunkGenerator<?> p_225577_2_, Random random, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_)
		{
			...
			this.fillWithRandomizedBlocks(world, structureBoundingBoxIn, 0, 0, 0, 13, i - 1, 14, false, random, StrongholdPiecesUA.STRONGHOLD_STONES);
	...
	static class PieceWeight
	{
		...
		public boolean canSpawnMoreStructures(int distanceFromStart)
		{
			int maxLimit = (int)(this.instancesLimit * (UltraAmplified.UAStructuresConfig.strongholdSizeSH.get() * 0.01D));
	...
	public static class PortalRoom extends StrongholdPiecesUA.Stronghold
	{
		...
		public static StrongholdPiecesUA.PortalRoom createPiece(List<StructurePiece> p_175865_0_, Random p_175865_1_, int p_175865_2_, int p_175865_3_, int p_175865_4_, Direction p_175865_5_, int p_175865_6_)
		{
		...
		public boolean create(IWorld world, ChunkGenerator<?> p_225577_2_, Random random, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_)
		{
			...
			int i = 6;
			this.fillWithRandomizedBlocks(world, structureBoundingBoxIn, 1, i, 1, 1, i, 14, false, random, StrongholdPiecesUA.STRONGHOLD_STONES);
			this.fillWithRandomizedBlocks(world, structureBoundingBoxIn, 9, i, 1, 9, i, 14, false, random, StrongholdPiecesUA.STRONGHOLD_STONES);
			this.fillWithRandomizedBlocks(world, structureBoundingBoxIn, 2, i, 1, 8, i, 2, false, random, StrongholdPiecesUA.STRONGHOLD_STONES);
			this.fillWithRandomizedBlocks(world, structureBoundingBoxIn, 2, i, 14, 8, i, 14, false, random, StrongholdPiecesUA.STRONGHOLD_STONES);
			this.fillWithRandomizedBlocks(world, structureBoundingBoxIn, 1, 1, 1, 2, 1, 4, false, random, StrongholdPiecesUA.STRONGHOLD_STONES);
			this.fillWithRandomizedBlocks(world, structureBoundingBoxIn, 8, 1, 1, 9, 1, 4, false, random, StrongholdPiecesUA.STRONGHOLD_STONES);
			...
			this.fillWithRandomizedBlocks(world, structureBoundingBoxIn, 3, 1, 8, 7, 1, 12, false, random, StrongholdPiecesUA.STRONGHOLD_STONES);
			...
			this.fillWithRandomizedBlocks(world, structureBoundingBoxIn, 4, 1, 5, 6, 1, 7, false, random, StrongholdPiecesUA.STRONGHOLD_STONES);
			this.fillWithRandomizedBlocks(world, structureBoundingBoxIn, 4, 2, 6, 6, 2, 7, false, random, StrongholdPiecesUA.STRONGHOLD_STONES);
			this.fillWithRandomizedBlocks(world, structureBoundingBoxIn, 4, 3, 7, 6, 3, 7, false, random, StrongholdPiecesUA.STRONGHOLD_STONES);
			...
			if (!this.hasSpawner)
			{
				...
				if (structureBoundingBoxIn.isVecInside(blockpos))
				{
					...
					{
						if (UltraAmplified.UAStructuresConfig.allowSilverfishSpawnerStronghold.get())
						{
	...
	public static class Prison extends StrongholdPiecesUA.Stronghold
	{
		...
		public static StrongholdPiecesUA.Prison createPiece(List<StructurePiece> p_175860_0_, Random p_175860_1_, int p_175860_2_, int p_175860_3_, int p_175860_4_, Direction p_175860_5_, int p_175860_6_)
		{
		...
		public boolean create(IWorld world, ChunkGenerator<?> p_225577_2_, Random random, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_)
		{
			...
			this.fillWithRandomizedBlocks(world, structureBoundingBoxIn, 4, 1, 1, 4, 3, 1, false, random, StrongholdPiecesUA.STRONGHOLD_STONES);
			this.fillWithRandomizedBlocks(world, structureBoundingBoxIn, 4, 1, 3, 4, 3, 3, false, random, StrongholdPiecesUA.STRONGHOLD_STONES);
			this.fillWithRandomizedBlocks(world, structureBoundingBoxIn, 4, 1, 7, 4, 3, 7, false, random, StrongholdPiecesUA.STRONGHOLD_STONES);
			this.fillWithRandomizedBlocks(world, structureBoundingBoxIn, 4, 1, 9, 4, 3, 9, false, random, StrongholdPiecesUA.STRONGHOLD_STONES);
	...
	public static class RightTurn extends StrongholdPiecesUA.Turn
	{
		...
		public static StrongholdPiecesUA.RightTurn createPiece(List<StructurePiece> p_214824_0_, Random p_214824_1_, int p_214824_2_, int p_214824_3_, int p_214824_4_, Direction p_214824_5_, int p_214824_6_)
		{
			...
			return canStrongholdGoDeeper(mutableboundingbox) && StructurePiece.findIntersecting(p_214824_0_, mutableboundingbox) == null ? new StrongholdPiecesUA.RightTurn(p_214824_6_, p_214824_1_, mutableboundingbox, p_214824_5_) : null;
		}
	}
	...
	public static class RoomCrossing extends StrongholdPiecesUA.Stronghold
	{
		...
		public static StrongholdPiecesUA.RoomCrossing createPiece(List<StructurePiece> p_175859_0_, Random p_175859_1_, int p_175859_2_, int p_175859_3_, int p_175859_4_, Direction p_175859_5_, int p_175859_6_)
		{
	...
	public static class Stairs extends StrongholdPiecesUA.Stronghold
	{
		...
		public static StrongholdPiecesUA.Stairs createPiece(List<StructurePiece> p_175863_0_, Random p_175863_1_, int p_175863_2_, int p_175863_3_, int p_175863_4_, Direction p_175863_5_, int p_175863_6_)
		{
		...
		public boolean create(IWorld world, ChunkGenerator<?> p_225577_2_, Random random, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_)
		{
			...
			this.placeDoor(world, random, structureBoundingBoxIn, StrongholdPiecesUA.Stronghold.Door.OPENING, 1, 1, 4);
	...
	public static class StairsStraight extends StrongholdPiecesUA.Stronghold
	{
		...
		public static StrongholdPiecesUA.StairsStraight createPiece(List<StructurePiece> p_175861_0_, Random p_175861_1_, int p_175861_2_, int p_175861_3_, int p_175861_4_, Direction p_175861_5_, int p_175861_6_)
		{
		...
		public boolean create(IWorld world, ChunkGenerator<?> p_225577_2_, Random random, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_)
		{
			...
			this.placeDoor(world, random, structureBoundingBoxIn, this.entryDoor, 1, 7, 0);
			this.placeDoor(world, random, structureBoundingBoxIn, StrongholdPiecesUA.Stronghold.Door.OPENING, 1, 1, 7);
	...
	static class Stones extends StructurePiece.BlockSelector
	{
		...
		public void selectBlocks(Random rand, int x, int y, int z, boolean p_75062_5_)
		{
			if (p_75062_5_)
			{
				...
				if (f < (float) (UltraAmplified.UAStructuresConfig.silverfishStrongholdSpawnrate.get() / 100))
				{
	...
	public static class Straight extends StrongholdPiecesUA.Stronghold
	{
		...
		public static StrongholdPiecesUA.Straight createPiece(List<StructurePiece> p_175862_0_, Random p_175862_1_, int p_175862_2_, int p_175862_3_, int p_175862_4_, Direction p_175862_5_, int p_175862_6_)
		{
	...
	abstract static class Stronghold extends StructurePiece
	{
		...
		protected void placeDoor(IWorld world, Random p_74990_2_, MutableBoundingBox p_74990_3_, StrongholdPiecesUA.Stronghold.Door p_74990_4_, int p_74990_5_, int p_74990_6_, int p_74990_7_)
		{
			switch (p_74990_4_)
			{
				case OPENING:
		...
		protected StructurePiece getNextComponentX(StrongholdPiecesUA.EntranceStairs p_74989_1_, List<StructurePiece> p_74989_2_, Random p_74989_3_, int p_74989_4_, int p_74989_5_)
		{
			...
			if (enumfacing != null)
			{
				...
				{
					case NORTH:
						return StrongholdPiecesUA.generateAndAddPiece(p_74989_1_, p_74989_2_, p_74989_3_, this.boundingBox.minX - 1, this.boundingBox.minY + p_74989_4_, this.boundingBox.minZ + p_74989_5_, Direction.WEST, this.getComponentType());

					case SOUTH:
						return StrongholdPiecesUA.generateAndAddPiece(p_74989_1_, p_74989_2_, p_74989_3_, this.boundingBox.minX - 1, this.boundingBox.minY + p_74989_4_, this.boundingBox.minZ + p_74989_5_, Direction.WEST, this.getComponentType());

					case WEST:
						return StrongholdPiecesUA.generateAndAddPiece(p_74989_1_, p_74989_2_, p_74989_3_, this.boundingBox.minX + p_74989_5_, this.boundingBox.minY + p_74989_4_, this.boundingBox.minZ - 1, Direction.NORTH, this.getComponentType());
		...
		protected StructurePiece getNextComponentZ(StrongholdPiecesUA.EntranceStairs p_74987_1_, List<StructurePiece> p_74987_2_, Random p_74987_3_, int p_74987_4_, int p_74987_5_)
		{
			...
			if (enumfacing != null)
			{
				...
				{
					case NORTH:
						return StrongholdPiecesUA.generateAndAddPiece(p_74987_1_, p_74987_2_, p_74987_3_, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74987_4_, this.boundingBox.minZ + p_74987_5_, Direction.EAST, this.getComponentType());

					case SOUTH:
						return StrongholdPiecesUA.generateAndAddPiece(p_74987_1_, p_74987_2_, p_74987_3_, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74987_4_, this.boundingBox.minZ + p_74987_5_, Direction.EAST, this.getComponentType());

					case WEST:
						return StrongholdPiecesUA.generateAndAddPiece(p_74987_1_, p_74987_2_, p_74987_3_, this.boundingBox.minX + p_74987_5_, this.boundingBox.minY + p_74987_4_, this.boundingBox.maxZ + 1, Direction.SOUTH, this.getComponentType());
