...
public class FeatureUA
{
	...
	public static void registerFeatures(RegistryEvent.Register<Feature<?>> event)
	{
		...
		RegUtil.register(registry, MESA_DUNGEONS, "dungeons_badlands_ua");
		RegUtil.register(registry, DARK_FOREST_DUNGEONS, "dungeons_dark_forest_ua");
		RegUtil.register(registry, DESERT_DUNGEONS, "dungeons_desert_ua");
		RegUtil.register(registry, END_DUNGEONS, "dungeons_end_ua");
		RegUtil.register(registry, NETHER_DUNGEONS, "dungeons_nether_ua");
		RegUtil.register(registry, SNOW_DUNGEONS, "dungeons_snow_ua");
		RegUtil.register(registry, SWAMP_DUNGEONS, "dungeons_swamp_ua");
		RegUtil.register(registry, MUSHROOM_DUNGEONS, "dungeons_mushroom_ua");
		RegUtil.register(registry, JUNGLE_DUNGEONS, "dungeons_jungle_ua");
		RegUtil.register(registry, CROSS, "swamp_cross_ua");
		RegUtil.register(registry, HAY_BALE, "hay_bale_pile_ua");
		RegUtil.register(registry, TINY_HAY_BALE, "hay_bale_tiny_pile_ua");
		RegUtil.register(registry, STONEHENGE, "stonehenge_ua");
		RegUtil.register(registry, SUN_SHRINE, "sun_shrine_ua");
		RegUtil.register(registry, HANGING_RUINS, "hanging_ruins_ua");
		RegUtil.register(registry, FOSSILS_UA, "fossil_ua");
		RegUtil.register(registry, SINGLE_BLOCK, "single_block_ua");
		RegUtil.register(registry, ICEBERG_UA, "iceberg_ua");
		RegUtil.register(registry, MARKED_TREASURE_CHEST_UA, "marked_treasure_chest_ua");
		RegUtil.register(registry, LARGE_STACKABLE_BOULDER, "giant_stackable_boulder_ua");
		RegUtil.register(registry, LARGE_BOULDER, "boulder_giant_ua");
		RegUtil.register(registry, MEDIUM_BOULDER, "boulder_normal_ua");
		...
		RegUtil.register(registry, COLUMN, "column_ua");
		RegUtil.register(registry, RAMP, "ramp_column_ua");
		RegUtil.register(registry, GLOWPATCH, "glowpatch_ua");
		RegUtil.register(registry, BLUE_ICE_WATERFALL, "blue_ice_waterfall_ua");
		RegUtil.register(registry, SNOW_AND_ICE_LAYERER, "snow_and_ice_layerer_ua");
		RegUtil.register(registry, LONG_VINES, "vines_long_ua");
		RegUtil.register(registry, SHORT_VINES, "vines_short_ua");
		RegUtil.register(registry, SEA_GRASS_UA, "sea_grass_ua");
		RegUtil.register(registry, KELP_UA, "kelp_ua");
		RegUtil.register(registry, SEA_PICKLE_UA, "sea_pickle_ua");
		RegUtil.register(registry, CORAL_CLAW_UA, "coral_claw_ua");
		RegUtil.register(registry, CORAL_TREE_UA, "coral_tree_ua");
		RegUtil.register(registry, CORAL_MUSHROOM_UA, "coral_mushroom_ua");
		RegUtil.register(registry, BAMBOO_UA, "bamboo_ua");
		RegUtil.register(registry, ROOTS, "roots_ua");
		RegUtil.register(registry, HORNED_SWAMP_TREE, "horned_swamp_tree_ua");
		RegUtil.register(registry, GIANT_BIRCH_TREE, "giant_birch_tree_ua");
		RegUtil.register(registry, GIANT_PINE_TREE_1_UA, "giant_pine_1_tree_ua");
		RegUtil.register(registry, GIANT_PINE_TREE_2_UA, "giant_pine_2_tree_ua");
