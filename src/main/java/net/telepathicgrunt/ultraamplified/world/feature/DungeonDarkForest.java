                ...
                for (int i4 = 3; i4 >= -1; --i4)
                {
                    for (int k4 = l1; k4 <= i2; ++k4)
                    {
                        ...
                        else if (world.getBlockState(blockpos1).getMaterial().isSolid() && world.getBlockState(blockpos1).getBlock() != Blocks.CHEST && world.getBlockState(blockpos1).getBlock() != Blocks.SPAWNER)
                        {
                            ...
                            {
                                world.setBlockState(blockpos1, Blocks.DARK_OAK_PLANKS.getDefaultState(), 2);
                            }
                            else
                            {
                            	if(rand.nextInt(3) == 0) 
                            	{
                                    world.setBlockState(blockpos1, Blocks.DARK_OAK_LOG.getDefaultState(), 2);
                            	}
                            	else {
                            		world.setBlockState(blockpos1, Blocks.DARK_OAK_LEAVES.getDefaultState(), 2);
                            	}
                            }
                        }
                    }
