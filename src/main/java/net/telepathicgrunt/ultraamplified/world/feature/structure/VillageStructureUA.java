...
public class VillageStructureUA extends Structure<VillageConfigUA> {
	...
	public static class Start extends StructureStart {
		...
		public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ,
				Biome biomeIn) {
			VillageConfigUA villageconfig = (VillageConfigUA) generator.getStructureConfig(biomeIn,
					FeatureUA.VILLAGE_UA);
			...
			if (genVanillaVillage) {
				...
				VillagePieces.func_214838_a(generator, templateManagerIn, blockpos, this.components, this.rand,
						vanillaVillageConfig);
