...
public class UAPlacement
{
    ...
    public static void registerPlacements(RegistryEvent.Register<Placement<?>> event)
    {
    	...
    	RegUtil.register(registry, TWICE_SURFACE_WITH_CHANCE_UA, "twice_surface_with_chance_ua");
    	...
    	RegUtil.register(registry, CHANCE_ON_ALL_SURFACES_UA, "chance_on_all_surfaces_ua");
    	RegUtil.register(registry, CHANCE_ON_ALL_WATER_SURFACES_UA, "chance_on_all_water_surfaces_ua");
    	RegUtil.register(registry, CHANCE_ON_ALL_WATER_BOTTOMS_UA, "chance_on_all_water_bottoms_ua");
    	RegUtil.register(registry, NETHERWART_SOUL_SAND_SURFACES_UA, "netherwart_soul_sand_surfaces_ua");
    	RegUtil.register(registry, AT_SURFACE_WITH_EXTRA_UA, "at_surface_with_extra_ua");
    	RegUtil.register(registry, AT_SURFACE_BELOW_TOP_LAYER_WITH_EXTRA_UA, "at_surface_below_top_layer_with_extra_ua");
    	RegUtil.register(registry, AT_SURFACE_THROUGH_WATER_WITH_EXTRA_UA, "at_surface_through_water_with_extra_ua");
    	RegUtil.register(registry, ROOFED_TREE_UA, "roofed_tree_ua");
    	...
    	RegUtil.register(registry, HEIGHT_BIASED_RANGE_UA, "height_biased_range_ua");
    	RegUtil.register(registry, HEIGHT_BIASED_END_ISLAND_RANGE_UA, "height_biased_end_island_range_ua");
