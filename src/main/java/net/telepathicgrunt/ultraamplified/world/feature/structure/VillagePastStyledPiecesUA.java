...
public class VillagePastStyledPiecesUA
{
	...
	public static List<PieceWeightUA> getStructureVillageWeightedPieceList(Random random, int size)
	{
		...
		list.add(new VillagePastStyledPiecesUA.PieceWeightUA(VillagePastStyledPiecesUA.FlatTopTinyHouse.class, 4, MathHelper.nextInt(random, 2 + size, 4 + size * 2)));
		list.add(new VillagePastStyledPiecesUA.PieceWeightUA(VillagePastStyledPiecesUA.Church.class, 20, MathHelper.nextInt(random, 0 + size, 1 + size)));
		list.add(new VillagePastStyledPiecesUA.PieceWeightUA(VillagePastStyledPiecesUA.LibraryHouse.class, 20, MathHelper.nextInt(random, 0 + size, 2 + size)));
		list.add(new VillagePastStyledPiecesUA.PieceWeightUA(VillagePastStyledPiecesUA.TinyHouse.class, 3, MathHelper.nextInt(random, 2 + size, 5 + size * 3)));
		list.add(new VillagePastStyledPiecesUA.PieceWeightUA(VillagePastStyledPiecesUA.WorkHouse.class, 15, MathHelper.nextInt(random, 0 + size, 2 + size)));
		list.add(new VillagePastStyledPiecesUA.PieceWeightUA(VillagePastStyledPiecesUA.Field1.class, 3, MathHelper.nextInt(random, 1 + size, 4 + size)));
		list.add(new VillagePastStyledPiecesUA.PieceWeightUA(VillagePastStyledPiecesUA.Field2.class, 3, MathHelper.nextInt(random, 2 + size, 4 + size * 2)));
		list.add(new VillagePastStyledPiecesUA.PieceWeightUA(VillagePastStyledPiecesUA.Blacksmith.class, 15, MathHelper.nextInt(random, 0, 1 + size)));
		list.add(new VillagePastStyledPiecesUA.PieceWeightUA(VillagePastStyledPiecesUA.LargeHouse.class, 8, MathHelper.nextInt(random, 0 + size, 3 + size * 2)));
	...
	private static VillagePastStyledPiecesUA.Village findAndCreateComponentFactory(VillagePastStyledPiecesUA.Start start, VillagePastStyledPiecesUA.PieceWeightUA weight, List<StructurePiece> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, Direction facing, int componentType)
	{
		...
		{
			villagepieces$village = VillagePastStyledPiecesUA.FlatTopTinyHouse.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
		}
		else if (oclass == VillagePastStyledPiecesUA.Church.class)
		{
			villagepieces$village = VillagePastStyledPiecesUA.Church.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
		}
		else if (oclass == VillagePastStyledPiecesUA.LibraryHouse.class)
		{
			villagepieces$village = VillagePastStyledPiecesUA.LibraryHouse.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
		}
		else if (oclass == VillagePastStyledPiecesUA.TinyHouse.class)
		{
			villagepieces$village = VillagePastStyledPiecesUA.TinyHouse.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
		}
		else if (oclass == VillagePastStyledPiecesUA.WorkHouse.class)
		{
			villagepieces$village = VillagePastStyledPiecesUA.WorkHouse.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
		}
		else if (oclass == VillagePastStyledPiecesUA.Field1.class)
		{
			villagepieces$village = VillagePastStyledPiecesUA.Field1.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
		}
		else if (oclass == VillagePastStyledPiecesUA.Field2.class)
		{
			villagepieces$village = VillagePastStyledPiecesUA.Field2.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
		}
		else if (oclass == VillagePastStyledPiecesUA.Blacksmith.class)
		{
			villagepieces$village = VillagePastStyledPiecesUA.Blacksmith.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
		}
		else if (oclass == VillagePastStyledPiecesUA.LargeHouse.class)
		{
			villagepieces$village = VillagePastStyledPiecesUA.LargeHouse.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
		}
	...
	private static VillagePastStyledPiecesUA.Village generateComponent(VillagePastStyledPiecesUA.Start start, List<StructurePiece> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, Direction facing, int componentType)
	{
		...
		else
		{
			...
			while (j < 5)
			{
				...
				for (VillagePastStyledPiecesUA.PieceWeightUA villagepieces$pieceweight : start.structureVillageWeightedPieceList)
				{
					...
					if (k < 0)
					{
						...
						VillagePastStyledPiecesUA.Village villagepieces$village = findAndCreateComponentFactory(start, villagepieces$pieceweight, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
			...
			MutableBoundingBox mutableboundingbox = VillagePastStyledPiecesUA.Torch.findPieceBox(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing);
	...
	private static StructurePiece generateAndAddComponent(VillagePastStyledPiecesUA.Start start, List<StructurePiece> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, Direction facing, int componentType)
	{
		if (componentType > 50)
		{
			return null;
	...
	private static StructurePiece generateAndAddRoadPiece(VillagePastStyledPiecesUA.Start start, List<StructurePiece> p_176069_1_, Random rand, int p_176069_3_, int p_176069_4_, int p_176069_5_, Direction facing, int p_176069_7_)
	{
		...
		{
			MutableBoundingBox mutableboundingbox = VillagePastStyledPiecesUA.Path.findPieceBox(start, p_176069_1_, rand, p_176069_3_, p_176069_4_, p_176069_5_, facing);
			if (mutableboundingbox != null && mutableboundingbox.minY > 10)
			{
				StructurePiece structurepiece = new VillagePastStyledPiecesUA.Path(start, p_176069_7_, rand, mutableboundingbox, facing);
	...
	public static class Church extends VillagePastStyledPiecesUA.Village
	{
		...
		protected Church(VillagePastStyledPiecesUA.Start start, int type, Random rand, MutableBoundingBox boundingBoxIn, Direction facing)
		{
		...
		public static VillagePastStyledPiecesUA.Church createPiece(VillagePastStyledPiecesUA.Start start, List<StructurePiece> p_175854_1_, Random rand, int p_175854_3_, int p_175854_4_, int p_175854_5_, Direction facing, int p_175854_7_)
		{
			...
			return canVillageGoDeeper(mutableboundingbox) && StructurePiece.findIntersecting(p_175854_1_, mutableboundingbox) == null ? new VillagePastStyledPiecesUA.Church(start, p_175854_7_, rand, mutableboundingbox, facing) : null;
		}
		...
		public boolean generate(IWorld world, ChunkGenerator<?> p_225577_2_, Random random, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_)
		{
			...
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 1, 1, 3, 3, 7, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 5, 1, 3, 9, 3, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 0, 0, 3, 0, 8, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 1, 0, 3, 10, 0, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 1, 1, 0, 10, 3, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 4, 1, 1, 4, 10, 3, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 0, 4, 0, 4, 7, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 4, 0, 4, 4, 4, 7, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 1, 8, 3, 4, 8, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 5, 4, 3, 10, 4, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 5, 5, 3, 5, 7, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 9, 0, 4, 9, 4, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 4, 0, 4, 4, 4, iblockstate, iblockstate, false);
			this.setBlockState(world, iblockstate, 0, 11, 2, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate, 4, 11, 2, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate, 2, 11, 0, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate, 2, 11, 4, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate, 1, 1, 6, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate, 1, 1, 7, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate, 2, 1, 7, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate, 3, 1, 6, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate, 3, 1, 7, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate1, 1, 1, 5, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate1, 2, 1, 6, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate1, 3, 1, 5, structureBoundingBoxIn);
			...
			// stands)
			TileEntity tileentity = world.getTileEntity(new BlockPos(this.getXWithOffset(2, 5), this.getYWithOffset(1), this.getZWithOffset(2, 5)));
			...
			for (int i = 1; i <= 9; ++i)
			{
				this.setBlockState(world, iblockstate4, 3, i, 3, structureBoundingBoxIn);
			}
			...
			if (this.getBlockStateFromPos(world, 2, 0, -1, structureBoundingBoxIn).getMaterial() == Material.AIR && this.getBlockStateFromPos(world, 2, -1, -1, structureBoundingBoxIn).getMaterial() != Material.AIR)
			{
				this.setBlockState(world, iblockstate1, 2, 0, -1, structureBoundingBoxIn);
				if (this.getBlockStateFromPos(world, 2, -1, -1, structureBoundingBoxIn).getBlock() == Blocks.GRASS_PATH)
				{
					this.setBlockState(world, Blocks.GRASS_BLOCK.getDefaultState(), 2, -1, -1, structureBoundingBoxIn);
				}
			}
			...
			for (int k = 0; k < 9; ++k)
			{
				for (int j = 0; j < 5; ++j)
				{
					...
					this.replaceAirAndLiquidDownwards(world, iblockstate, j, -1, k, structureBoundingBoxIn);
				}
			}
	...
	public static class Field1 extends VillagePastStyledPiecesUA.Village
	{
		...
		protected Field1(VillagePastStyledPiecesUA.Start start, int type, Random rand, MutableBoundingBox boundingBoxIn, Direction facing)
		{
		...
		public static VillagePastStyledPiecesUA.Field1 createPiece(VillagePastStyledPiecesUA.Start start, List<StructurePiece> p_175851_1_, Random rand, int p_175851_3_, int p_175851_4_, int p_175851_5_, Direction facing, int p_175851_7_)
		{
			...
			return canVillageGoDeeper(mutableboundingbox) && StructurePiece.findIntersecting(p_175851_1_, mutableboundingbox) == null ? new VillagePastStyledPiecesUA.Field1(start, p_175851_7_, rand, mutableboundingbox, facing) : null;
		}
		...
		public boolean generate(IWorld world, ChunkGenerator<?> p_225577_2_, Random random, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_)
		{
			...
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 1, 0, 12, 4, 8, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 0, 1, 2, 0, 7, Blocks.FARMLAND.getDefaultState(), Blocks.FARMLAND.getDefaultState(), false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 4, 0, 1, 5, 0, 7, Blocks.FARMLAND.getDefaultState(), Blocks.FARMLAND.getDefaultState(), false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 7, 0, 1, 8, 0, 7, Blocks.FARMLAND.getDefaultState(), Blocks.FARMLAND.getDefaultState(), false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 10, 0, 1, 11, 0, 7, Blocks.FARMLAND.getDefaultState(), Blocks.FARMLAND.getDefaultState(), false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 0, 0, 0, 0, 8, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 6, 0, 0, 6, 0, 8, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 12, 0, 0, 12, 0, 8, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 0, 0, 11, 0, 0, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 0, 8, 11, 0, 8, iblockstate, iblockstate, false);
			this.setBlockState(world, Blocks.COMPOSTER.getDefaultState(), 6, 1, 0, structureBoundingBoxIn);
			this.fillWithBlocks(world, structureBoundingBoxIn, 3, 0, 1, 3, 0, 7, Blocks.WATER.getDefaultState(), Blocks.WATER.getDefaultState(), false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 9, 0, 1, 9, 0, 7, Blocks.WATER.getDefaultState(), Blocks.WATER.getDefaultState(), false);
			...
			for (int i = 1; i <= 7; ++i)
			{
				...
				int k = j / 3;
				this.setBlockState(world, this.cropTypeA.with(CropsBlock.getAgeProperty(), Integer.valueOf(MathHelper.nextInt(random, k, j))), 1, 1, i, structureBoundingBoxIn);
				this.setBlockState(world, this.cropTypeA.with(CropsBlock.getAgeProperty(), Integer.valueOf(MathHelper.nextInt(random, k, j))), 2, 1, i, structureBoundingBoxIn);
				CropsBlock = (CropsBlock) this.cropTypeB.getBlock();
				int l = CropsBlock.getMaxAge();
				int i1 = l / 3;
				this.setBlockState(world, this.cropTypeB.with(CropsBlock.getAgeProperty(), Integer.valueOf(MathHelper.nextInt(random, i1, l))), 4, 1, i, structureBoundingBoxIn);
				this.setBlockState(world, this.cropTypeB.with(CropsBlock.getAgeProperty(), Integer.valueOf(MathHelper.nextInt(random, i1, l))), 5, 1, i, structureBoundingBoxIn);
				CropsBlock = (CropsBlock) this.cropTypeC.getBlock();
				int j1 = CropsBlock.getMaxAge();
				int k1 = j1 / 3;
				this.setBlockState(world, this.cropTypeC.with(CropsBlock.getAgeProperty(), Integer.valueOf(MathHelper.nextInt(random, k1, j1))), 7, 1, i, structureBoundingBoxIn);
				this.setBlockState(world, this.cropTypeC.with(CropsBlock.getAgeProperty(), Integer.valueOf(MathHelper.nextInt(random, k1, j1))), 8, 1, i, structureBoundingBoxIn);
				CropsBlock = (CropsBlock) this.cropTypeD.getBlock();
				int l1 = CropsBlock.getMaxAge();
				int i2 = l1 / 3;
				this.setBlockState(world, this.cropTypeD.with(CropsBlock.getAgeProperty(), Integer.valueOf(MathHelper.nextInt(random, i2, l1))), 10, 1, i, structureBoundingBoxIn);
				this.setBlockState(world, this.cropTypeD.with(CropsBlock.getAgeProperty(), Integer.valueOf(MathHelper.nextInt(random, i2, l1))), 11, 1, i, structureBoundingBoxIn);
			}
			...
			for (int j2 = 0; j2 < 9; ++j2)
			{
				for (int k2 = 0; k2 < 13; ++k2)
				{
					...
					this.replaceAirAndLiquidDownwards(world, Blocks.DIRT.getDefaultState(), k2, -1, j2, structureBoundingBoxIn);
				}
			}
	...
	public static class Field2 extends VillagePastStyledPiecesUA.Village
	{
		...
		protected Field2(VillagePastStyledPiecesUA.Start start, int type, Random rand, MutableBoundingBox boundingBoxIn, Direction facing)
		{
		...
		public static VillagePastStyledPiecesUA.Field2 createPiece(VillagePastStyledPiecesUA.Start start, List<StructurePiece> p_175852_1_, Random rand, int p_175852_3_, int p_175852_4_, int p_175852_5_, Direction facing, int p_175852_7_)
		{
			...
			return canVillageGoDeeper(mutableboundingbox) && StructurePiece.findIntersecting(p_175852_1_, mutableboundingbox) == null ? new VillagePastStyledPiecesUA.Field2(start, p_175852_7_, rand, mutableboundingbox, facing) : null;
		}
		...
		public boolean generate(IWorld world, ChunkGenerator<?> p_225577_2_, Random random, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_)
		{
			...
			BlockState iblockstate = this.getBiomeSpecificBlockState(Blocks.OAK_LOG.getDefaultState());
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 1, 0, 6, 4, 8, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 0, 1, 2, 0, 7, Blocks.FARMLAND.getDefaultState(), Blocks.FARMLAND.getDefaultState(), false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 4, 0, 1, 5, 0, 7, Blocks.FARMLAND.getDefaultState(), Blocks.FARMLAND.getDefaultState(), false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 0, 0, 0, 0, 8, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 6, 0, 0, 6, 0, 8, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 0, 0, 5, 0, 0, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 0, 8, 5, 0, 8, iblockstate, iblockstate, false);
			this.setBlockState(world, Blocks.COMPOSTER.getDefaultState(), 0, 1, 8, structureBoundingBoxIn);
			this.fillWithBlocks(world, structureBoundingBoxIn, 3, 0, 1, 3, 0, 7, Blocks.WATER.getDefaultState(), Blocks.WATER.getDefaultState(), false);
			...
			for (int j1 = 0; j1 < 9; ++j1)
			{
				for (int k1 = 0; k1 < 7; ++k1)
				{
					...
					this.replaceAirAndLiquidDownwards(world, Blocks.DIRT.getDefaultState(), k1, -1, j1, structureBoundingBoxIn);
				}
			}
	...
	{
		protected WorkHouse(VillagePastStyledPiecesUA.Start start, int type, Random rand, MutableBoundingBox boundingBoxIn, Direction facing)
		{
		...
		public static VillagePastStyledPiecesUA.WorkHouse createPiece(VillagePastStyledPiecesUA.Start start, List<StructurePiece> p_175857_1_, Random rand, int p_175857_3_, int p_175857_4_, int p_175857_5_, Direction facing, int p_175857_7_)
		{
			...
			return canVillageGoDeeper(mutableboundingbox) && StructurePiece.findIntersecting(p_175857_1_, mutableboundingbox) == null ? new VillagePastStyledPiecesUA.WorkHouse(start, p_175857_7_, rand, mutableboundingbox, facing) : null;
		}
		...
		public boolean generate(IWorld world, ChunkGenerator<?> p_225577_2_, Random random, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_)
		{
			...
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 1, 1, 7, 4, 4, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 2, 1, 6, 8, 4, 10, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 2, 0, 6, 8, 0, 10, Blocks.DIRT.getDefaultState(), Blocks.DIRT.getDefaultState(), false);
			...
			{
				this.setBlockState(world, iblockstate6, 2, 1, 10, structureBoundingBoxIn);
				this.setBlockState(world, iblockstate6, 8, 1, 10, structureBoundingBoxIn);
			}
			this.fillWithBlocks(world, structureBoundingBoxIn, 2, 1, 6, 2, 1, 9, iblockstate7, iblockstate7, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 8, 1, 6, 8, 1, 9, iblockstate7, iblockstate7, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 3, 1, 10, 7, 1, 10, iblockstate8, iblockstate8, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 0, 1, 7, 0, 4, iblockstate4, iblockstate4, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 0, 0, 0, 3, 5, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 8, 0, 0, 8, 3, 5, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 0, 0, 7, 1, 0, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 0, 5, 7, 1, 5, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 2, 0, 7, 3, 0, iblockstate4, iblockstate4, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 2, 5, 7, 3, 5, iblockstate4, iblockstate4, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 4, 1, 8, 4, 1, iblockstate4, iblockstate4, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 4, 4, 8, 4, 4, iblockstate4, iblockstate4, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 5, 2, 8, 5, 3, iblockstate4, iblockstate4, false);
			this.setBlockState(world, iblockstate4, 0, 4, 2, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate4, 0, 4, 3, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate4, 8, 4, 2, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate4, 8, 4, 3, structureBoundingBoxIn);
			...
			for (int i = -1; i <= 2; ++i)
			{
				for (int j = 0; j <= 8; ++j)
				{
					this.setBlockState(world, iblockstate9, j, 4 + i, i, structureBoundingBoxIn);
					this.setBlockState(world, iblockstate10, j, 4 + i, 5 - i, structureBoundingBoxIn);
				}
			}

			this.setBlockState(world, iblockstate5, 0, 2, 1, structureBoundingBoxIn);
			...
			this.setBlockState(world, iblockstate4, 1, 1, 4, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate9, 2, 1, 4, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate3, 1, 1, 3, structureBoundingBoxIn);
			BlockState iblockstate11 = Blocks.STONE_SLAB.getDefaultState().with(SlabBlock.TYPE, SlabType.DOUBLE);
			this.fillWithBlocks(world, structureBoundingBoxIn, 5, 0, 1, 7, 0, 3, iblockstate11, iblockstate11, false);
			this.setBlockState(world, Blocks.SMOKER.getDefaultState(), 6, 1, 1, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.SMOKER.getDefaultState(), 6, 1, 2, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.CAULDRON.getDefaultState().with(CauldronBlock.LEVEL, 3), 6, 1, 3, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.AIR.getDefaultState(), 2, 1, 0, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.AIR.getDefaultState(), 2, 2, 0, structureBoundingBoxIn);
			...
			if (this.getBlockStateFromPos(world, 2, 0, -1, structureBoundingBoxIn).getMaterial() == Material.AIR && this.getBlockStateFromPos(world, 2, -1, -1, structureBoundingBoxIn).getMaterial() != Material.AIR)
			{
				this.setBlockState(world, iblockstate9, 2, 0, -1, structureBoundingBoxIn);
				if (this.getBlockStateFromPos(world, 2, -1, -1, structureBoundingBoxIn).getBlock() == Blocks.GRASS_PATH)
				{
					this.setBlockState(world, Blocks.GRASS_BLOCK.getDefaultState(), 2, -1, -1, structureBoundingBoxIn);
				}
			...
			for (int l = 0; l < 5; ++l)
			{
				for (int k = 0; k < 9; ++k)
				{
					...
					this.replaceAirAndLiquidDownwards(world, iblockstate, k, -1, l, structureBoundingBoxIn);
				}
			}
	...
	{
		protected LibraryHouse(VillagePastStyledPiecesUA.Start start, int type, Random rand, MutableBoundingBox boundingBoxIn, Direction facing)
		{
		...
		public static VillagePastStyledPiecesUA.LibraryHouse createPiece(VillagePastStyledPiecesUA.Start start, List<StructurePiece> p_175850_1_, Random rand, int p_175850_3_, int p_175850_4_, int p_175850_5_, Direction facing, int p_175850_7_)
		{
			...
			return canVillageGoDeeper(mutableboundingbox) && StructurePiece.findIntersecting(p_175850_1_, mutableboundingbox) == null ? new VillagePastStyledPiecesUA.LibraryHouse(start, p_175850_7_, rand, mutableboundingbox, facing) : null;
		}
		...
		public boolean generate(IWorld world, ChunkGenerator<?> p_225577_2_, Random random, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_)
		{
			...
			BlockState iblockstate6 = this.getBiomeSpecificBlockState(Blocks.OAK_FENCE.getDefaultState());
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 1, 1, 7, 5, 4, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 0, 0, 8, 0, 5, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 5, 0, 8, 5, 5, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 6, 1, 8, 6, 4, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 7, 2, 8, 7, 3, iblockstate, iblockstate, false);

			for (int i = -1; i <= 2; ++i)
			{
				for (int j = 0; j <= 8; ++j)
				{
					this.setBlockState(world, iblockstate1, j, 6 + i, i, structureBoundingBoxIn);
					this.setBlockState(world, iblockstate2, j, 6 + i, 5 - i, structureBoundingBoxIn);
				}
			}

			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 1, 0, 0, 1, 5, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 1, 5, 8, 1, 5, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 8, 1, 0, 8, 1, 4, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 2, 1, 0, 7, 1, 0, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 2, 0, 0, 4, 0, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 2, 5, 0, 4, 5, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 8, 2, 5, 8, 4, 5, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 8, 2, 0, 8, 4, 0, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 2, 1, 0, 4, 4, iblockstate4, iblockstate4, false);
			...
			this.setBlockState(world, iblockstate4, 7, 1, 4, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate3, 7, 1, 3, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate1, 6, 1, 4, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate1, 5, 1, 4, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate1, 4, 1, 4, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate1, 3, 1, 4, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate6, 6, 1, 3, structureBoundingBoxIn);
			this.setBlockState(world, getBiomeSpecificBlockState(Blocks.OAK_PRESSURE_PLATE.getDefaultState()), 6, 2, 3, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate6, 4, 1, 3, structureBoundingBoxIn);
			this.setBlockState(world, getBiomeSpecificBlockState(Blocks.OAK_PRESSURE_PLATE.getDefaultState()), 4, 2, 3, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.CARTOGRAPHY_TABLE.getDefaultState(), 7, 1, 1, structureBoundingBoxIn);
			this.setBlockState(world, getBiomeSpecificBlockState(Blocks.TORCH.getDefaultState()), 7, 2, 1, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.CARTOGRAPHY_TABLE.getDefaultState(), 1, 1, 4, structureBoundingBoxIn);
			this.setBlockState(world, getBiomeSpecificBlockState(Blocks.TORCH.getDefaultState()), 1, 2, 4, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.BOOKSHELF.getDefaultState(), 2, 1, 4, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.LECTERN.getDefaultState(), 5, 1, 3, structureBoundingBoxIn);
			...
			if (this.getBlockStateFromPos(world, 1, 0, -1, structureBoundingBoxIn).getMaterial() == Material.AIR && this.getBlockStateFromPos(world, 1, -1, -1, structureBoundingBoxIn).getMaterial() != Material.AIR)
			{
				this.setBlockState(world, iblockstate5, 1, 0, -1, structureBoundingBoxIn);
				if (this.getBlockStateFromPos(world, 1, -1, -1, structureBoundingBoxIn).getBlock() == Blocks.GRASS_PATH)
				{
					this.setBlockState(world, Blocks.GRASS_BLOCK.getDefaultState(), 1, -1, -1, structureBoundingBoxIn);
				}
			}
	...
	public static class Blacksmith extends VillagePastStyledPiecesUA.Village
	{
		...
		protected Blacksmith(VillagePastStyledPiecesUA.Start start, int type, Random rand, MutableBoundingBox boundingBoxIn, Direction facing)
		{
		...
		public static VillagePastStyledPiecesUA.Blacksmith createPiece(VillagePastStyledPiecesUA.Start start, List<StructurePiece> p_175855_1_, Random rand, int p_175855_3_, int p_175855_4_, int p_175855_5_, Direction facing, int p_175855_7_)
		{
			...
			return canVillageGoDeeper(mutableboundingbox) && StructurePiece.findIntersecting(p_175855_1_, mutableboundingbox) == null ? new VillagePastStyledPiecesUA.Blacksmith(start, p_175855_7_, rand, mutableboundingbox, facing) : null;
		}
		...
		public boolean generate(IWorld world, ChunkGenerator<?> p_225577_2_, Random random, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_)
		{
			...
			BlockState iblockstate5 = this.getBiomeSpecificBlockState(Blocks.OAK_LOG.getDefaultState());
			BlockState iblockstate6 = this.getBiomeSpecificBlockState(Blocks.OAK_FENCE.getDefaultState());
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 1, 0, 9, 4, 6, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 0, 0, 9, 0, 6, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 4, 0, 9, 4, 6, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 5, 0, 9, 5, 6, Blocks.STONE_SLAB.getDefaultState(), Blocks.STONE_SLAB.getDefaultState(), false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 5, 1, 8, 5, 5, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 1, 0, 2, 3, 0, iblockstate3, iblockstate3, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 1, 0, 0, 4, 0, iblockstate5, iblockstate5, false);
			...
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 1, 6, 5, 3, 6, iblockstate3, iblockstate3, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 5, 2, 0, 5, 3, 0, iblockstate6, iblockstate6, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 9, 1, 0, 9, 3, 0, iblockstate6, iblockstate6, false);
			...
			this.setBlockState(world, iblockstate3, 5, 1, 0, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate3, 1, 1, 5, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate1, 2, 1, 5, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate2, 1, 1, 4, structureBoundingBoxIn);
			if (!this.hasMadeChest && structureBoundingBoxIn.isVecInside(new BlockPos(this.getXWithOffset(5, 5), this.getYWithOffset(1), this.getZWithOffset(5, 5))))
			{
				...
				this.generateChest(world, structureBoundingBoxIn, random, 5, 1, 5, LootTables.CHESTS_VILLAGE_VILLAGE_WEAPONSMITH);
			}

			for (int i = 6; i <= 8; ++i)
			{
				if (this.getBlockStateFromPos(world, i, 0, -1, structureBoundingBoxIn).getMaterial() == Material.AIR && this.getBlockStateFromPos(world, i, -1, -1, structureBoundingBoxIn).getMaterial() != Material.AIR)
				{
					this.setBlockState(world, iblockstate4, i, 0, -1, structureBoundingBoxIn);
					if (this.getBlockStateFromPos(world, i, -1, -1, structureBoundingBoxIn).getBlock() == Blocks.GRASS_PATH)
					{
						this.setBlockState(world, Blocks.GRASS_BLOCK.getDefaultState(), i, -1, -1, structureBoundingBoxIn);
					}
				}
			}
	...
	public static class LargeHouse extends VillagePastStyledPiecesUA.Village
	{
		...
		protected LargeHouse(VillagePastStyledPiecesUA.Start start, int p_i45573_1_, Random p_i45573_2_, MutableBoundingBox boundingBoxIn, Direction facing)
		{
		...
		public static VillagePastStyledPiecesUA.LargeHouse createPiece(VillagePastStyledPiecesUA.Start start, List<StructurePiece> p_175849_1_, Random rand, int p_175849_3_, int p_175849_4_, int p_175849_5_, Direction facing, int p_175849_7_)
		{
			...
			return canVillageGoDeeper(mutableboundingbox) && StructurePiece.findIntersecting(p_175849_1_, mutableboundingbox) == null ? new VillagePastStyledPiecesUA.LargeHouse(start, p_175849_7_, rand, mutableboundingbox, facing) : null;
		}
		...
		public boolean generate(IWorld world, ChunkGenerator<?> p_225577_2_, Random random, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_)
		{
			...
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 1, 1, 7, 4, 4, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 2, 1, 6, 8, 4, 10, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 2, 0, 5, 8, 0, 10, iblockstate5, iblockstate5, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 0, 1, 7, 0, 4, iblockstate5, iblockstate5, false);
			this.setBlockState(world, Blocks.RED_BED.getDefaultState().with(BedBlock.PART, BedPart.HEAD).with(HorizontalBlock.HORIZONTAL_FACING, Direction.WEST), 3, 1, 3, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.RED_BED.getDefaultState().with(BedBlock.PART, BedPart.HEAD).with(HorizontalBlock.HORIZONTAL_FACING, Direction.WEST), 3, 1, 4, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.RED_BED.getDefaultState().with(BedBlock.PART, BedPart.HEAD).with(HorizontalBlock.HORIZONTAL_FACING, Direction.WEST), 3, 1, 7, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.RED_BED.getDefaultState().with(BedBlock.PART, BedPart.HEAD).with(HorizontalBlock.HORIZONTAL_FACING, Direction.WEST), 3, 1, 8, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.RED_BED.getDefaultState().with(BedBlock.PART, BedPart.FOOT).with(HorizontalBlock.HORIZONTAL_FACING, Direction.WEST), 4, 1, 3, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.RED_BED.getDefaultState().with(BedBlock.PART, BedPart.FOOT).with(HorizontalBlock.HORIZONTAL_FACING, Direction.WEST), 4, 1, 4, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.RED_BED.getDefaultState().with(BedBlock.PART, BedPart.FOOT).with(HorizontalBlock.HORIZONTAL_FACING, Direction.WEST), 4, 1, 7, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.RED_BED.getDefaultState().with(BedBlock.PART, BedPart.FOOT).with(HorizontalBlock.HORIZONTAL_FACING, Direction.WEST), 4, 1, 8, structureBoundingBoxIn);

			this.setBlockState(world, Blocks.RED_BED.getDefaultState().with(BedBlock.PART, BedPart.HEAD).with(HorizontalBlock.HORIZONTAL_FACING, Direction.EAST), 7, 1, 3, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.RED_BED.getDefaultState().with(BedBlock.PART, BedPart.HEAD).with(HorizontalBlock.HORIZONTAL_FACING, Direction.EAST), 7, 1, 4, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.RED_BED.getDefaultState().with(BedBlock.PART, BedPart.HEAD).with(HorizontalBlock.HORIZONTAL_FACING, Direction.EAST), 7, 1, 7, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.RED_BED.getDefaultState().with(BedBlock.PART, BedPart.HEAD).with(HorizontalBlock.HORIZONTAL_FACING, Direction.EAST), 7, 1, 8, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.RED_BED.getDefaultState().with(BedBlock.PART, BedPart.FOOT).with(HorizontalBlock.HORIZONTAL_FACING, Direction.EAST), 6, 1, 3, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.RED_BED.getDefaultState().with(BedBlock.PART, BedPart.FOOT).with(HorizontalBlock.HORIZONTAL_FACING, Direction.EAST), 6, 1, 4, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.RED_BED.getDefaultState().with(BedBlock.PART, BedPart.FOOT).with(HorizontalBlock.HORIZONTAL_FACING, Direction.EAST), 6, 1, 7, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.RED_BED.getDefaultState().with(BedBlock.PART, BedPart.FOOT).with(HorizontalBlock.HORIZONTAL_FACING, Direction.EAST), 6, 1, 8, structureBoundingBoxIn);

			this.setBlockState(world, Blocks.FLETCHING_TABLE.getDefaultState(), 5, 1, 9, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.LOOM.getDefaultState(), 6, 1, 9, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.CAULDRON.getDefaultState().with(CauldronBlock.LEVEL, 2), 4, 1, 9, structureBoundingBoxIn);
			...
			{
				this.hasMadeChest = true;
				this.generateChest(world, structureBoundingBoxIn, random, 3, 1, 6, LootTables.CHESTS_VILLAGE_VILLAGE_FLETCHER);
			}
			...
			{
				this.hasMadeChest = true;
				this.generateChest(world, structureBoundingBoxIn, random, 7, 1, 6, LootTables.CHESTS_VILLAGE_VILLAGE_PLAINS_HOUSE);
			}
			this.setBlockState(world, Blocks.CRAFTING_TABLE.getDefaultState(), 3, 1, 5, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.CRAFTING_TABLE.getDefaultState(), 7, 1, 5, structureBoundingBoxIn);
			this.setBlockState(world, getBiomeSpecificBlockState(Blocks.TORCH.getDefaultState()), 3, 2, 5, structureBoundingBoxIn);
			this.setBlockState(world, getBiomeSpecificBlockState(Blocks.TORCH.getDefaultState()), 7, 2, 5, structureBoundingBoxIn);
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 0, 0, 0, 3, 5, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 8, 0, 0, 8, 3, 10, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 0, 0, 7, 2, 0, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 0, 5, 2, 1, 5, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 2, 0, 6, 2, 3, 10, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 3, 0, 10, 7, 3, 10, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 2, 0, 7, 3, 0, iblockstate5, iblockstate5, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 2, 5, 2, 3, 5, iblockstate5, iblockstate5, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 4, 1, 8, 4, 1, iblockstate5, iblockstate5, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 4, 4, 3, 4, 4, iblockstate5, iblockstate5, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 5, 2, 8, 5, 3, iblockstate5, iblockstate5, false);
			this.setBlockState(world, iblockstate5, 0, 4, 2, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate5, 0, 4, 3, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate5, 8, 4, 2, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate5, 8, 4, 3, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate5, 8, 4, 4, structureBoundingBoxIn);
			...
			for (int i = -1; i <= 2; ++i)
			{
				for (int j = 0; j <= 8; ++j)
				{
					this.setBlockState(world, iblockstate7, j, 4 + i, i, structureBoundingBoxIn);
					if ((i > -1 || j <= 1) && (i > 0 || j <= 3) && (i > 1 || j <= 4 || j >= 6))
					{
						this.setBlockState(world, iblockstate8, j, 4 + i, 5 - i, structureBoundingBoxIn);
					}
				}
			}

			this.fillWithBlocks(world, structureBoundingBoxIn, 3, 4, 5, 3, 4, 10, iblockstate5, iblockstate5, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 7, 4, 2, 7, 4, 10, iblockstate5, iblockstate5, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 4, 5, 4, 4, 5, 10, iblockstate5, iblockstate5, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 6, 5, 4, 6, 5, 10, iblockstate5, iblockstate5, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 5, 6, 3, 5, 6, 10, iblockstate5, iblockstate5, false);

			for (int k = 4; k >= 1; --k)
			{
				this.setBlockState(world, iblockstate5, k, 2 + k, 7 - k, structureBoundingBoxIn);

				for (int k1 = 8 - k; k1 <= 10; ++k1)
				{
					this.setBlockState(world, iblockstate10, k, 2 + k, k1, structureBoundingBoxIn);
				}
			}

			this.setBlockState(world, iblockstate5, 6, 6, 3, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate5, 7, 5, 4, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate4, 6, 6, 4, structureBoundingBoxIn);

			for (int l = 6; l <= 8; ++l)
			{
				for (int l1 = 5; l1 <= 10; ++l1)
				{
					this.setBlockState(world, iblockstate9, l, 12 - l, l1, structureBoundingBoxIn);
				}
			}
			...
			this.placeTorch(world, Direction.NORTH, 2, 3, 1, structureBoundingBoxIn);
			this.createVillageDoor(world, structureBoundingBoxIn, random, 2, 1, 0, Direction.NORTH);
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 0, -1, 3, 2, -1, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			if (this.getBlockStateFromPos(world, 2, 0, -1, structureBoundingBoxIn).getMaterial() == Material.AIR && this.getBlockStateFromPos(world, 2, -1, -1, structureBoundingBoxIn).getMaterial() != Material.AIR)
			{
				this.setBlockState(world, iblockstate7, 2, 0, -1, structureBoundingBoxIn);
				if (this.getBlockStateFromPos(world, 2, -1, -1, structureBoundingBoxIn).getBlock() == Blocks.GRASS_PATH)
				{
					this.setBlockState(world, Blocks.GRASS_BLOCK.getDefaultState(), 2, -1, -1, structureBoundingBoxIn);
				}
			...
			for (int i1 = 0; i1 < 5; ++i1)
			{
				for (int i2 = 0; i2 < 9; ++i2)
				{
					...
					this.replaceAirAndLiquidDownwards(world, iblockstate, i2, -1, i1, structureBoundingBoxIn);
				}
			}
			...
			for (int j1 = 5; j1 < 11; ++j1)
			{
				for (int j2 = 2; j2 < 9; ++j2)
				{
					...
					this.replaceAirAndLiquidDownwards(world, iblockstate, j2, -1, j1, structureBoundingBoxIn);
				}
			}
	...
	public static class FlatTopTinyHouse extends VillagePastStyledPiecesUA.Village
	{
		...
		protected FlatTopTinyHouse(VillagePastStyledPiecesUA.Start start, int p_i45573_1_, Random rand, MutableBoundingBox boundingBoxIn, Direction facing)
		{
		...
		public static VillagePastStyledPiecesUA.FlatTopTinyHouse createPiece(VillagePastStyledPiecesUA.Start start, List<StructurePiece> p_175858_1_, Random rand, int p_175858_3_, int p_175858_4_, int p_175858_5_, Direction facing, int p_175858_7_)
		{
			...
			return StructurePiece.findIntersecting(p_175858_1_, mutableboundingbox) != null ? null : new VillagePastStyledPiecesUA.FlatTopTinyHouse(start, p_175858_7_, rand, mutableboundingbox, facing);
		}
		...
		public boolean generate(IWorld world, ChunkGenerator<?> p_225577_2_, Random random, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_)
		{
			...
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 0, 0, 4, 0, 4, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 4, 0, 4, 4, 4, iblockstate3, iblockstate3, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 4, 1, 3, 4, 3, iblockstate1, iblockstate1, false);
			this.setBlockState(world, Blocks.RED_BED.getDefaultState().with(BedBlock.PART, BedPart.HEAD), 1, 1, 1, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.RED_BED.getDefaultState().with(BedBlock.PART, BedPart.FOOT), 1, 1, 2, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.FLETCHING_TABLE.getDefaultState(), 1, 1, 3, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate, 0, 1, 0, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate, 0, 2, 0, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate, 0, 3, 0, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate, 4, 1, 0, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate, 4, 2, 0, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate, 4, 3, 0, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate, 0, 1, 4, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate, 0, 2, 4, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate, 0, 3, 4, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate, 4, 1, 4, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate, 4, 2, 4, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate, 4, 3, 4, structureBoundingBoxIn);
			...
			if (this.getBlockStateFromPos(world, 2, 0, -1, structureBoundingBoxIn).getMaterial() == Material.AIR && this.getBlockStateFromPos(world, 2, -1, -1, structureBoundingBoxIn).getMaterial() != Material.AIR)
			{
				this.setBlockState(world, iblockstate2, 2, 0, -1, structureBoundingBoxIn);
				if (this.getBlockStateFromPos(world, 2, -1, -1, structureBoundingBoxIn).getBlock() == Blocks.GRASS_PATH)
				{
					this.setBlockState(world, Blocks.GRASS_BLOCK.getDefaultState(), 2, -1, -1, structureBoundingBoxIn);
				}
			...
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 1, 1, 3, 3, 3, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
				...
				for (int k = 0; k <= 4; ++k)
				{
					for (int l = 0; l <= 4; ++l)
					{
						...
						if (flag || flag1)
						{
							...
							{
								this.setBlockState(world, iblockstate4, k, 5, l, structureBoundingBoxIn);
							}
						}
					}
				}
			...
			if (this.isRoofAccessible)
			{
				...
				this.setBlockState(world, iblockstate6, 3, 1, 3, structureBoundingBoxIn);
				this.setBlockState(world, iblockstate6, 3, 2, 3, structureBoundingBoxIn);
				this.setBlockState(world, iblockstate6, 3, 3, 3, structureBoundingBoxIn);
				this.setBlockState(world, iblockstate6, 3, 4, 3, structureBoundingBoxIn);
			}
			...
			for (int i1 = 0; i1 < 5; ++i1)
			{
				for (int j1 = 0; j1 < 5; ++j1)
				{
					...
					this.replaceAirAndLiquidDownwards(world, iblockstate, j1, -1, i1, structureBoundingBoxIn);
				}
			}
	...
	public static class Path extends VillagePastStyledPiecesUA.Village
	{
		...
		protected Path(VillagePastStyledPiecesUA.Start start, int p_i45573_1_, Random p_i45573_2_, MutableBoundingBox boundingBoxIn, Direction facing)
		{
		...
		public void buildComponent(StructurePiece componentIn, List<StructurePiece> listIn, Random rand)
		{
			...
			{
				StructurePiece structurepiece = this.getNextComponentNN((VillagePastStyledPiecesUA.Start) componentIn, listIn, rand, 0, i);
				if (structurepiece != null)
				{
			...
			{
				StructurePiece structurepiece1 = this.getNextComponentPP((VillagePastStyledPiecesUA.Start) componentIn, listIn, rand, 0, j);
			...
			if (flag && rand.nextInt(3) > 0 && enumfacing != null)
			{
				switch (enumfacing)
				{
					case NORTH:
					default:
						VillagePastStyledPiecesUA.generateAndAddRoadPiece((VillagePastStyledPiecesUA.Start) componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ, Direction.WEST, this.getComponentType());
						break;
					case SOUTH:
						VillagePastStyledPiecesUA.generateAndAddRoadPiece((VillagePastStyledPiecesUA.Start) componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.maxZ - 2, Direction.WEST, this.getComponentType());
						break;
					case WEST:
						VillagePastStyledPiecesUA.generateAndAddRoadPiece((VillagePastStyledPiecesUA.Start) componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ - 1, Direction.NORTH, this.getComponentType());
						break;
					case EAST:
						VillagePastStyledPiecesUA.generateAndAddRoadPiece((VillagePastStyledPiecesUA.Start) componentIn, listIn, rand, this.boundingBox.maxX - 2, this.boundingBox.minY, this.boundingBox.minZ - 1, Direction.NORTH, this.getComponentType());
				}
			}
			...
			if (flag && rand.nextInt(3) > 0 && enumfacing != null)
			{
				switch (enumfacing)
				{
					case NORTH:
					default:
						VillagePastStyledPiecesUA.generateAndAddRoadPiece((VillagePastStyledPiecesUA.Start) componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ, Direction.EAST, this.getComponentType());
						break;
					case SOUTH:
						VillagePastStyledPiecesUA.generateAndAddRoadPiece((VillagePastStyledPiecesUA.Start) componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.maxZ - 2, Direction.EAST, this.getComponentType());
						break;
					case WEST:
						VillagePastStyledPiecesUA.generateAndAddRoadPiece((VillagePastStyledPiecesUA.Start) componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.maxZ + 1, Direction.SOUTH, this.getComponentType());
						break;
					case EAST:
						VillagePastStyledPiecesUA.generateAndAddRoadPiece((VillagePastStyledPiecesUA.Start) componentIn, listIn, rand, this.boundingBox.maxX - 2, this.boundingBox.minY, this.boundingBox.maxZ + 1, Direction.SOUTH, this.getComponentType());
				}
			}
		...
		public static MutableBoundingBox findPieceBox(VillagePastStyledPiecesUA.Start start, List<StructurePiece> p_175848_1_, Random rand, int p_175848_3_, int p_175848_4_, int p_175848_5_, Direction facing)
		{
		...
		public boolean generate(IWorld world, ChunkGenerator<?> p_225577_2_, Random random, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_)
		{
			...
			for (int i = this.boundingBox.minX; i <= this.boundingBox.maxX; ++i)
			{
				for (int j = this.boundingBox.minZ; j <= this.boundingBox.maxZ; ++j)
				{
					...
					{
						int k = world.getHeight(Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, blockpos$Mutable.getX(), blockpos$Mutable.getZ());
						...
						{
							blockpos$Mutable.setY(world.getSeaLevel() - 1);
						}

						while (blockpos$Mutable.getY() >= world.getSeaLevel() - 1)
						{
							BlockState iblockstate4 = world.getBlockState(blockpos$Mutable);
							Block block = iblockstate4.getBlock();
							if (block == Blocks.GRASS_BLOCK && world.isAirBlock(blockpos$Mutable.up()))
							{
							...
							{
								world.setBlockState(new BlockPos(blockpos$Mutable), iblockstate1, 2);
								break;
							}
							...
							{
								world.setBlockState(blockpos$Mutable, iblockstate2, 2);
								world.setBlockState(blockpos$Mutable.down(), iblockstate3, 2);
								break;
							}
	...
	public static class Start extends VillagePastStyledPiecesUA.Well
	{
		...
		public Start(int p_i48769_1_, Random p_i48769_2_, int p_i48769_3_, int p_i48769_4_, List<VillagePastStyledPiecesUA.PieceWeightUA> p_i48769_5_, VillageConfigUA p_i48769_6_, net.minecraft.world.biome.Biome biome)
		{
	...
	{
		protected Torch(VillagePastStyledPiecesUA.Start start, int type, Random rand, MutableBoundingBox boundingBoxIn, Direction facing)
		{
		...
		public static MutableBoundingBox findPieceBox(VillagePastStyledPiecesUA.Start start, List<StructurePiece> p_175856_1_, Random rand, int p_175856_3_, int p_175856_4_, int p_175856_5_, Direction facing)
		{
		...
		public boolean generate(IWorld world, ChunkGenerator<?> p_225577_2_, Random random, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_)
		{
			...
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 0, 0, 2, 3, 1, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.setBlockState(world, iblockstate, 1, 0, 0, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate, 1, 1, 0, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate, 1, 2, 0, structureBoundingBoxIn);
			this.setBlockState(world, getBiomeSpecificBlockState(Blocks.BLACK_WOOL.getDefaultState()), 1, 3, 0, structureBoundingBoxIn);
	...
	public static enum Type
	{
		...
		// vanilla types
		OAK(1), SANDSTONE(2), ACACIA(3), SPRUCE(4), SNOWYSPRUCE(5),

		// UA types
		DARK(5), JUNGLE(6), STONE(7), END(8), HELL(9), BADLANDS(10), ICY(11);
	...
	public abstract static class Village extends StructurePiece
	{
		 ...
		 */
		@Nullable
		protected StructurePiece getNextComponentNN(VillagePastStyledPiecesUA.Start start, List<StructurePiece> structureComponents, Random rand, int p_74891_4_, int p_74891_5_)
		{
			Direction enumfacing = this.getCoordBaseMode();
			if (enumfacing != null)
			{
				switch (enumfacing)
				{
					case NORTH:
					default:
						return VillagePastStyledPiecesUA.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ + p_74891_5_, Direction.WEST, this.getComponentType());
					case SOUTH:
						return VillagePastStyledPiecesUA.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ + p_74891_5_, Direction.WEST, this.getComponentType());
					case WEST:
						return VillagePastStyledPiecesUA.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74891_5_, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ - 1, Direction.NORTH, this.getComponentType());
					case EAST:
						return VillagePastStyledPiecesUA.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74891_5_, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ - 1, Direction.NORTH, this.getComponentType());
				}
			}
		 ...
		 */
		@Nullable
		protected StructurePiece getNextComponentPP(VillagePastStyledPiecesUA.Start start, List<StructurePiece> structureComponents, Random rand, int p_74894_4_, int p_74894_5_)
		{
			Direction enumfacing = this.getCoordBaseMode();
			if (enumfacing != null)
			{
				switch (enumfacing)
				{
					case NORTH:
					default:
						return VillagePastStyledPiecesUA.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_, this.boundingBox.minZ + p_74894_5_, Direction.EAST, this.getComponentType());
					case SOUTH:
						return VillagePastStyledPiecesUA.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_, this.boundingBox.minZ + p_74894_5_, Direction.EAST, this.getComponentType());
					case WEST:
						return VillagePastStyledPiecesUA.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74894_5_, this.boundingBox.minY + p_74894_4_, this.boundingBox.maxZ + 1, Direction.SOUTH, this.getComponentType());
					case EAST:
						return VillagePastStyledPiecesUA.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74894_5_, this.boundingBox.minY + p_74894_4_, this.boundingBox.maxZ + 1, Direction.SOUTH, this.getComponentType());
				}
			}
		...
		protected int getBestGroundLevel(IWorld world, MutableBoundingBox structurebb)
		{
			...
			for (int j = 0; j < this.boundingBox.getXSize(); j++)
			{
				for (int k = 0; k < this.boundingBox.getZSize(); k++)
				{
					...
					{
						heightArray[k + j * this.boundingBox.getZSize()] = world.getHeight(Heightmap.Type.WORLD_SURFACE_WG, blockpos$Mutable).getY();
					}
				}
			}
		...
		{
			this.setBlockState(world, door.getDefaultState().with(DoorBlock.FACING, facing), x, y, z, sbb);
			this.setBlockState(world, door.getDefaultState().with(DoorBlock.FACING, facing).with(DoorBlock.HALF, DoubleBlockHalf.UPPER), x, y + 1, z, sbb);
		}
	...
	public static class Well extends VillagePastStyledPiecesUA.Village
	{
		...
		public void buildComponent(StructurePiece componentIn, List<StructurePiece> listIn, Random rand)
		{
			...
			VillagePastStyledPiecesUA.generateAndAddRoadPiece((VillagePastStyledPiecesUA.Start) componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, Direction.EAST, this.getComponentType());
			VillagePastStyledPiecesUA.generateAndAddRoadPiece((VillagePastStyledPiecesUA.Start) componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ - 1, Direction.NORTH, this.getComponentType());
			VillagePastStyledPiecesUA.generateAndAddRoadPiece((VillagePastStyledPiecesUA.Start) componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1, Direction.SOUTH, this.getComponentType());
		}
		...
		public boolean generate(IWorld world, ChunkGenerator<?> p_225577_2_, Random random, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_)
		{
			...
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 0, 1, 4, 12, 4, iblockstate, Blocks.WATER.getDefaultState(), false);
			this.setBlockState(world, Blocks.AIR.getDefaultState(), 2, 12, 2, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.AIR.getDefaultState(), 3, 12, 2, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.AIR.getDefaultState(), 2, 12, 3, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.AIR.getDefaultState(), 3, 12, 3, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate1, 1, 13, 1, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate1, 1, 14, 1, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate1, 4, 13, 1, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate1, 4, 14, 1, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate1, 1, 13, 4, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate1, 1, 14, 4, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate1, 4, 13, 4, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate1, 4, 14, 4, structureBoundingBoxIn);
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 15, 1, 4, 15, 4, iblockstate, iblockstate, false);
			this.setBlockState(world, Blocks.BELL.getDefaultState(), 2, 13, 1, structureBoundingBoxIn);
			this.setBlockState(world, Blocks.BARREL.getDefaultState(), 4, 13, 3, structureBoundingBoxIn);
			...
			for (int i = 0; i <= 5; ++i)
			{
				for (int j = 0; j <= 5; ++j)
				{
					if (j == 0 || j == 5 || i == 0 || i == 5)
					{
						this.setBlockState(world, iblockstate, j, 11, i, structureBoundingBoxIn);
	...
	public static class TinyHouse extends VillagePastStyledPiecesUA.Village
	{
		...
		protected TinyHouse(VillagePastStyledPiecesUA.Start start, int type, Random rand, MutableBoundingBox boundingBoxIn, Direction facing)
		{
		...
		public static VillagePastStyledPiecesUA.TinyHouse createPiece(VillagePastStyledPiecesUA.Start start, List<StructurePiece> p_175853_1_, Random rand, int p_175853_3_, int p_175853_4_, int p_175853_5_, Direction facing, int p_175853_7_)
		{
			...
			return canVillageGoDeeper(mutableboundingbox) && StructurePiece.findIntersecting(p_175853_1_, mutableboundingbox) == null ? new VillagePastStyledPiecesUA.TinyHouse(start, p_175853_7_, rand, mutableboundingbox, facing) : null;
		}
		...
		public boolean generate(IWorld world, ChunkGenerator<?> p_225577_2_, Random random, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_)
		{
			...
			BlockState iblockstate3 = this.getBiomeSpecificBlockState(Blocks.OAK_LOG.getDefaultState());
			BlockState iblockstate4 = this.getBiomeSpecificBlockState(Blocks.OAK_FENCE.getDefaultState());
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 1, 1, 3, 5, 4, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 0, 0, 3, 0, 4, iblockstate, iblockstate, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 1, 0, 1, 2, 0, 3, Blocks.DIRT.getDefaultState(), Blocks.DIRT.getDefaultState(), false);
			if (this.isTallHouse)
			{
				this.fillWithBlocks(world, structureBoundingBoxIn, 1, 4, 1, 2, 4, 3, iblockstate3, iblockstate3, false);
			}
			else
			{
				this.fillWithBlocks(world, structureBoundingBoxIn, 1, 5, 1, 2, 5, 3, iblockstate3, iblockstate3, false);
			}

			this.setBlockState(world, iblockstate3, 1, 4, 0, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate3, 2, 4, 0, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate3, 1, 4, 4, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate3, 2, 4, 4, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate3, 0, 4, 1, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate3, 0, 4, 2, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate3, 0, 4, 3, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate3, 3, 4, 1, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate3, 3, 4, 2, structureBoundingBoxIn);
			this.setBlockState(world, iblockstate3, 3, 4, 3, structureBoundingBoxIn);
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 1, 0, 0, 3, 0, iblockstate3, iblockstate3, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 3, 1, 0, 3, 3, 0, iblockstate3, iblockstate3, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 1, 4, 0, 3, 4, iblockstate3, iblockstate3, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 3, 1, 4, 3, 3, 4, iblockstate3, iblockstate3, false);
			this.fillWithBlocks(world, structureBoundingBoxIn, 0, 1, 1, 0, 3, 3, iblockstate1, iblockstate1, false);
			...
			if (this.tablePosition > 0)
			{
				...
				{
					this.setBlockState(world, iblockstate4, this.tablePosition, 1, 3, structureBoundingBoxIn);
				}
				this.setBlockState(world, Blocks.OAK_PRESSURE_PLATE.getDefaultState(), this.tablePosition, 2, 3, structureBoundingBoxIn);

				if (this.tablePosition == 1)
				{
					this.setBlockState(world, Blocks.RED_BED.getDefaultState().with(BedBlock.PART, BedPart.HEAD), 2, 1, 3, structureBoundingBoxIn);
					this.setBlockState(world, Blocks.RED_BED.getDefaultState().with(BedBlock.PART, BedPart.FOOT), 2, 1, 2, structureBoundingBoxIn);
				}
				else
				{
					this.setBlockState(world, Blocks.RED_BED.getDefaultState().with(BedBlock.PART, BedPart.HEAD), 1, 1, 3, structureBoundingBoxIn);
					this.setBlockState(world, Blocks.RED_BED.getDefaultState().with(BedBlock.PART, BedPart.FOOT), 1, 1, 2, structureBoundingBoxIn);
				}
			}
			else
			...
			if (this.getBlockStateFromPos(world, 1, 0, -1, structureBoundingBoxIn).getMaterial() == Material.AIR && this.getBlockStateFromPos(world, 1, -1, -1, structureBoundingBoxIn).getMaterial() != Material.AIR)
			{
				this.setBlockState(world, iblockstate2, 1, 0, -1, structureBoundingBoxIn);
				if (this.getBlockStateFromPos(world, 1, -1, -1, structureBoundingBoxIn).getBlock() == Blocks.GRASS_PATH)
				{
					this.setBlockState(world, Blocks.GRASS_BLOCK.getDefaultState(), 1, -1, -1, structureBoundingBoxIn);
				}
			...
			for (int i = 0; i < 5; ++i)
			{
				for (int j = 0; j < 4; ++j)
				{
					...
					this.replaceAirAndLiquidDownwards(world, iblockstate, j, -1, i, structureBoundingBoxIn);
				}
			}
