...
public class EndCityPiecesUA
{
	...
	private static final EndCityPiecesUA.IGenerator HOUSE_TOWER_GENERATOR = new EndCityPiecesUA.IGenerator()
	{
		...
		public boolean generate(TemplateManager p_191086_1_, int p_191086_2_, EndCityPiecesUA.CityTemplate p_191086_3_, BlockPos p_191086_4_, List<StructurePiece> p_191086_5_, Random p_191086_6_)
		{
			...
			else
			{
				...
				EndCityPiecesUA.CityTemplate StructureEndCityPiecesUA$citytemplate = EndCityPiecesUA.addHelper(p_191086_5_, EndCityPiecesUA.addPiece(p_191086_1_, p_191086_3_, p_191086_4_, "base_floor", rotation, true));
				...
				EndCityPiecesUA.recursiveChildren(p_191086_1_, EndCityPiecesUA.TOWER_GENERATOR, p_191086_2_ + 1, StructureEndCityPiecesUA$citytemplate, (BlockPos) null, p_191086_5_, p_191086_6_);
	...
	private static final EndCityPiecesUA.IGenerator TOWER_GENERATOR = new EndCityPiecesUA.IGenerator()
	{
		...
		{
			Rotation rotation = p_191086_3_.placeSettings.getRotation();
			EndCityPiecesUA.CityTemplate lvt_8_1_ = EndCityPiecesUA.addHelper(p_191086_5_, EndCityPiecesUA.addPiece(p_191086_1_, p_191086_3_, new BlockPos(3 + p_191086_6_.nextInt(2), -3, 3 + p_191086_6_.nextInt(2)), "tower_base", rotation, true));
			...
			EndCityPiecesUA.CityTemplate StructureEndCityPiecesUA$citytemplate1 = p_191086_6_.nextInt(3) == 0 ? lvt_8_1_ : null;
			int i = 3;
			...
			if (StructureEndCityPiecesUA$citytemplate1 != null)
			{
				...
				{
					EndCityPiecesUA.CityTemplate StructureEndCityPiecesUA$citytemplate2 = EndCityPiecesUA.addHelper(p_191086_5_, EndCityPiecesUA.addPiece(p_191086_1_, StructureEndCityPiecesUA$citytemplate1, tuple.getB(), "bridge_end", rotation.add(tuple.getA()), true));
					EndCityPiecesUA.recursiveChildren(p_191086_1_, EndCityPiecesUA.TOWER_BRIDGE_GENERATOR, p_191086_2_ + 1, StructureEndCityPiecesUA$citytemplate2, (BlockPos) null, p_191086_5_, p_191086_6_);
			...
			else
			{
				if (p_191086_2_ != 7)
				{
					return EndCityPiecesUA.recursiveChildren(p_191086_1_, EndCityPiecesUA.FAT_TOWER_GENERATOR, p_191086_2_ + 1, lvt_8_1_, (BlockPos) null, p_191086_5_, p_191086_6_);
				}
	...
	private static final EndCityPiecesUA.IGenerator TOWER_BRIDGE_GENERATOR = new EndCityPiecesUA.IGenerator()
	{
		...
		public boolean generate(TemplateManager p_191086_1_, int p_191086_2_, EndCityPiecesUA.CityTemplate p_191086_3_, BlockPos p_191086_4_, List<StructurePiece> p_191086_5_, Random p_191086_6_)
		{
			Rotation rotation = p_191086_3_.placeSettings.getRotation();
			int i = 4;
			EndCityPiecesUA.CityTemplate StructureEndCityPiecesUA$citytemplate = EndCityPiecesUA.addHelper(p_191086_5_, EndCityPiecesUA.addPiece(p_191086_1_, p_191086_3_, new BlockPos(0, 0, -4), "bridge_piece", rotation, true));
			...
			for (int k = 0; k < i; ++k)
			{
				...
				else
				{
					if (p_191086_6_.nextBoolean())
					{
						StructureEndCityPiecesUA$citytemplate = EndCityPiecesUA.addHelper(p_191086_5_, EndCityPiecesUA.addPiece(p_191086_1_, StructureEndCityPiecesUA$citytemplate, new BlockPos(0, j, -4), "bridge_steep_stairs", rotation, true));
					}
					else
					{
						StructureEndCityPiecesUA$citytemplate = EndCityPiecesUA.addHelper(p_191086_5_, EndCityPiecesUA.addPiece(p_191086_1_, StructureEndCityPiecesUA$citytemplate, new BlockPos(0, j, -8), "bridge_gentle_stairs", rotation, true));
					}
			...
			else if (!EndCityPiecesUA.recursiveChildren(p_191086_1_, EndCityPiecesUA.HOUSE_TOWER_GENERATOR, p_191086_2_ + 1, StructureEndCityPiecesUA$citytemplate, new BlockPos(-3, j + 1, -11), p_191086_5_, p_191086_6_))
			{
				return false;
			}

			StructureEndCityPiecesUA$citytemplate = EndCityPiecesUA.addHelper(p_191086_5_, EndCityPiecesUA.addPiece(p_191086_1_, StructureEndCityPiecesUA$citytemplate, new BlockPos(4, j, 0), "bridge_end", rotation.add(Rotation.CLOCKWISE_180), true));
			StructureEndCityPiecesUA$citytemplate.componentType = -1;
			return true;
		}
	};
	...
	private static final EndCityPiecesUA.IGenerator FAT_TOWER_GENERATOR = new EndCityPiecesUA.IGenerator()
	{
		...
		{
			Rotation rotation = p_191086_3_.placeSettings.getRotation();
			EndCityPiecesUA.CityTemplate StructureEndCityPiecesUA$citytemplate = EndCityPiecesUA.addHelper(p_191086_5_, EndCityPiecesUA.addPiece(p_191086_1_, p_191086_3_, new BlockPos(-3, 4, -3), "fat_tower_base", rotation, true));
			...
			for (int i = 0; i < 2; ++i)
			{
				...
				for (Tuple<Rotation, BlockPos> tuple : EndCityPiecesUA.FAT_TOWER_BRIDGES)
				{
					...
					EndCityPiecesUA.CityTemplate StructureEndCityPiecesUA$citytemplate1 = EndCityPiecesUA.addHelper(p_191086_5_, EndCityPiecesUA.addPiece(p_191086_1_, StructureEndCityPiecesUA$citytemplate, tuple.getB(), "bridge_end", rotation.add(tuple.getA()), true));
					EndCityPiecesUA.recursiveChildren(p_191086_1_, EndCityPiecesUA.TOWER_BRIDGE_GENERATOR, p_191086_2_ + 1, StructureEndCityPiecesUA$citytemplate1, (BlockPos) null, p_191086_5_, p_191086_6_);
	...
	public static void startHouseTower(TemplateManager p_191087_0_, BlockPos p_191087_1_, Rotation p_191087_2_, List<StructurePiece> p_191087_3_, Random p_191087_4_)
	{
		...
		EndCityPiecesUA.CityTemplate StructureEndCityPiecesUA$citytemplate = addHelper(p_191087_3_, new EndCityPiecesUA.CityTemplate(p_191087_0_, "base_floor", p_191087_1_, p_191087_2_, true));
	...
	private static EndCityPiecesUA.CityTemplate addHelper(List<StructurePiece> p_189935_0_, EndCityPiecesUA.CityTemplate p_189935_1_)
	{
	...
	private static boolean recursiveChildren(TemplateManager p_191088_0_, EndCityPiecesUA.IGenerator p_191088_1_, int p_191088_2_, EndCityPiecesUA.CityTemplate p_191088_3_, BlockPos p_191088_4_, List<StructurePiece> p_191088_5_, Random p_191088_6_)
	{
		if (p_191088_2_ > 10)
		{
			return false;
	...
	interface IGenerator
	{
		...
		boolean generate(TemplateManager p_191086_1_, int p_191086_2_, EndCityPiecesUA.CityTemplate p_191086_3_, BlockPos p_191086_4_, List<StructurePiece> p_191086_5_, Random p_191086_6_);
	}
}