...
public class UAPlacements
{
    ...
    public static final Placement<CountRangeConfig> RAMP_PLACEMENT = new CountRangeRamps(CountRangeConfig::deserialize);
    public static final Placement<CountRangeConfig> COLUMN_PLACEMENT = new CountRangeColumn(CountRangeConfig::deserialize);
	...
	RegUtil.register(registry, RAMP_PLACEMENT, "ramp_placement");
	RegUtil.register(registry, COLUMN_PLACEMENT, "column_placement");
