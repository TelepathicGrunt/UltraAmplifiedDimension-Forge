...
public class HayBaleTinyPile extends Feature<NoFeatureConfig>
{
	...
	public boolean place(IWorld world, ChunkGenerator<? extends GenerationSettings> changedBlock, Random rand, BlockPos position, NoFeatureConfig p_212245_5_)
	{
		...
		if (this.isBlockNormalCube(world, position.down().north(), false) && this.isBlockNormalCube(world, position.down().south(), false) && this.isBlockNormalCube(world, position.down().east(), false) && this.isBlockNormalCube(world, position.down().west(), false))
		{
			//north/south
			if (rand.nextBoolean())
			{
