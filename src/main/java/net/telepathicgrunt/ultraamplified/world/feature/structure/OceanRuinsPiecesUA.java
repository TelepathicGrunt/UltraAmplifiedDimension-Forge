...
public class OceanRuinsPiecesUA {
	private static final ResourceLocation[] WARM_RUINS = new ResourceLocation[] {
			new ResourceLocation("underwater_ruin/warm_1"), new ResourceLocation("underwater_ruin/warm_2"),
			new ResourceLocation("underwater_ruin/warm_3"), new ResourceLocation("underwater_ruin/warm_4"),
			new ResourceLocation("underwater_ruin/warm_5"), new ResourceLocation("underwater_ruin/warm_6"),
			new ResourceLocation("underwater_ruin/warm_7"), new ResourceLocation("underwater_ruin/warm_8") };
	private static final ResourceLocation[] BRICK_RUINS = new ResourceLocation[] {
			new ResourceLocation("underwater_ruin/brick_1"), new ResourceLocation("underwater_ruin/brick_2"),
			new ResourceLocation("underwater_ruin/brick_3"), new ResourceLocation("underwater_ruin/brick_4"),
			new ResourceLocation("underwater_ruin/brick_5"), new ResourceLocation("underwater_ruin/brick_6"),
			new ResourceLocation("underwater_ruin/brick_7"), new ResourceLocation("underwater_ruin/brick_8") };
	private static final ResourceLocation[] CRACKED_RUINS = new ResourceLocation[] {
			new ResourceLocation("underwater_ruin/cracked_1"), new ResourceLocation("underwater_ruin/cracked_2"),
			new ResourceLocation("underwater_ruin/cracked_3"), new ResourceLocation("underwater_ruin/cracked_4"),
			new ResourceLocation("underwater_ruin/cracked_5"), new ResourceLocation("underwater_ruin/cracked_6"),
			new ResourceLocation("underwater_ruin/cracked_7"), new ResourceLocation("underwater_ruin/cracked_8") };
	private static final ResourceLocation[] MOSSY_RUINS = new ResourceLocation[] {
			new ResourceLocation("underwater_ruin/mossy_1"), new ResourceLocation("underwater_ruin/mossy_2"),
			new ResourceLocation("underwater_ruin/mossy_3"), new ResourceLocation("underwater_ruin/mossy_4"),
			new ResourceLocation("underwater_ruin/mossy_5"), new ResourceLocation("underwater_ruin/mossy_6"),
			new ResourceLocation("underwater_ruin/mossy_7"), new ResourceLocation("underwater_ruin/mossy_8") };
	private static final ResourceLocation[] BIG_BRICK_RUINS = new ResourceLocation[] {
			new ResourceLocation("underwater_ruin/big_brick_1"), new ResourceLocation("underwater_ruin/big_brick_2"),
			new ResourceLocation("underwater_ruin/big_brick_3"), new ResourceLocation("underwater_ruin/big_brick_8") };
	private static final ResourceLocation[] BIG_MOSSY_RUINS = new ResourceLocation[] {
			new ResourceLocation("underwater_ruin/big_mossy_1"), new ResourceLocation("underwater_ruin/big_mossy_2"),
			new ResourceLocation("underwater_ruin/big_mossy_3"), new ResourceLocation("underwater_ruin/big_mossy_8") };
	...
	private static final ResourceLocation[] BIG_WARM_RUINS = new ResourceLocation[] {
			new ResourceLocation("underwater_ruin/big_warm_4"), new ResourceLocation("underwater_ruin/big_warm_5"),
			new ResourceLocation("underwater_ruin/big_warm_6"), new ResourceLocation("underwater_ruin/big_warm_7") };
	...
	public static void start(TemplateManager templateManager, BlockPos pos, Rotation rotation,
			List<StructurePiece> pieceList, Random random, OceanRuinConfig ruinsConfig) {
	...
	private static void addChildRuins(TemplateManager templateManager, Random random, Rotation rotationIn, BlockPos pos,
			OceanRuinConfig ruinsConfig, List<StructurePiece> pieceList) {
		int x = pos.getX();
		int z = pos.getZ();
		BlockPos blockpos = Template
				.getTransformedPos(new BlockPos(15, 0, 15), Mirror.NONE, rotationIn, new BlockPos(0, 0, 0))
				.add(x, 0, z);
		MutableBoundingBox mutableboundingbox = MutableBoundingBox.createProper(x, 0, z, blockpos.getX(), 0,
				blockpos.getZ());
		...
		for (int l = 0; l < k; ++l) {
			if (!list.isEmpty()) {
				...
				BlockPos blockpos3 = Template
						.getTransformedPos(new BlockPos(5, 0, 6), Mirror.NONE, rotation, new BlockPos(0, 0, 0))
						.add(j1, 0, k1);
				MutableBoundingBox mutableboundingbox1 = MutableBoundingBox.createProper(j1, 0, k1, blockpos3.getX(), 0,
						blockpos3.getZ());
	...
	private static List<BlockPos> getPlacements(Random random, int x, int z) {
		...
		list.add(
				new BlockPos(x - 16 + MathHelper.nextInt(random, 1, 8), 90, z + 16 + MathHelper.nextInt(random, 1, 7)));
		list.add(new BlockPos(x - 16 + MathHelper.nextInt(random, 1, 8), 90, z + MathHelper.nextInt(random, 1, 7)));
		list.add(
				new BlockPos(x - 16 + MathHelper.nextInt(random, 1, 8), 90, z - 16 + MathHelper.nextInt(random, 4, 8)));
		...
		list.add(
				new BlockPos(x + 16 + MathHelper.nextInt(random, 1, 7), 90, z + 16 + MathHelper.nextInt(random, 3, 8)));
		list.add(new BlockPos(x + 16 + MathHelper.nextInt(random, 1, 7), 90, z + MathHelper.nextInt(random, 1, 7)));
		list.add(
				new BlockPos(x + 16 + MathHelper.nextInt(random, 1, 7), 90, z - 16 + MathHelper.nextInt(random, 4, 8)));
		return list;
	}

	private static void addRuinsToList(TemplateManager templateManager, BlockPos pos, Rotation rotation,
			List<StructurePiece> pieceList, Random random, OceanRuinConfig ruinsConfig, boolean isLarge,
			float integrity) {
		if (ruinsConfig.field_204031_a == OceanRuinStructure.Type.WARM) {
			...
			pieceList.add(new OceanRuinsPiecesUA.Piece(templateManager, resourcelocation, pos, rotation, integrity,
					ruinsConfig.field_204031_a, isLarge));
			...
			pieceList.add(new OceanRuinsPiecesUA.Piece(templateManager, aresourcelocation2[i], pos, rotation, integrity,
					ruinsConfig.field_204031_a, isLarge));
			pieceList.add(new OceanRuinsPiecesUA.Piece(templateManager, aresourcelocation[i], pos, rotation, 0.7F,
					ruinsConfig.field_204031_a, isLarge));
			pieceList.add(new OceanRuinsPiecesUA.Piece(templateManager, aresourcelocation1[i], pos, rotation, 0.5F,
					ruinsConfig.field_204031_a, isLarge));
		}
	...
	public static class Piece extends TemplateStructurePiece {
		...
		public Piece(TemplateManager p_i48868_1_, ResourceLocation p_i48868_2_, BlockPos p_i48868_3_,
				Rotation p_i48868_4_, float p_i48868_5_, OceanRuinStructure.Type p_i48868_6_, boolean p_i48868_7_) {
		...
		public boolean func_225577_a_(IWorld world, ChunkGenerator<?> p_225577_2_, Random randomIn,
			...
			if (randomIn.nextInt(3) == 0) {
				...
				// The following code will check a chunk for the height that has the most land
				// surface exposed to the sky and generate the ruins at that height
			...
			this.templatePosition = new BlockPos(this.templatePosition.getX(), finalHeight - 1,
					this.templatePosition.getZ());
			BlockPos blockpos = Template.getTransformedPos(
		...
		private int setWaterloggedBlocks(BlockPos pos1, IBlockReader blockReader, BlockPos pos2) {
			...
			for (BlockPos blockpos : BlockPos.getAllInBoxMutable(pos1, pos2)) {
				...
				// waterlogged block
				for (IFluidState ifluidstate = blockReader
						.getFluidState(blockpos$Mutable); (iblockstate.getMaterial() == Material.AIR
								|| ifluidstate.isTagged(FluidTags.WATER) || iblockstate.getBlock().isIn(BlockTags.ICE))
								&& y > 1; ifluidstate = blockReader.getFluidState(blockpos$Mutable)) {
					--y;
