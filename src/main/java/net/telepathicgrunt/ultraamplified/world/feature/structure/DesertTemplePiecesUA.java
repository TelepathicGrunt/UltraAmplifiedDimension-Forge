	...
	public boolean func_225577_a_(IWorld worldIn, ChunkGenerator<?> p_225577_2_, Random randomIn,
		...
		for (int i = 1; i <= 9; ++i) {
			this.fillWithBlocks(worldIn, structureBoundingBoxIn, i, i, i, this.width - 1 - i, i, this.depth - 1 - i,
					Blocks.SANDSTONE.getDefaultState(), Blocks.SANDSTONE.getDefaultState(), false);
			this.fillWithBlocks(worldIn, structureBoundingBoxIn, i + 1, i, i + 1, this.width - 2 - i, i,
					this.depth - 2 - i, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
		}

		for (int k1 = 0; k1 < this.width; ++k1) {
			for (int j = 0; j < this.depth; ++j) {
				this.replaceAirAndLiquidDownwards(worldIn, Blocks.SANDSTONE.getDefaultState(), k1, -5, j,
		...
		this.fillWithBlocks(worldIn, structureBoundingBoxIn, this.width - 5, 0, 0, this.width - 1, 9, 4,
		...
		this.fillWithBlocks(worldIn, structureBoundingBoxIn, 12, 1, 2, 16, 2, 2, Blocks.AIR.getDefaultState(),
				Blocks.AIR.getDefaultState(), false);
		this.fillWithBlocks(worldIn, structureBoundingBoxIn, 5, 4, 5, this.width - 6, 4, this.depth - 6,
				Blocks.SANDSTONE.getDefaultState(), Blocks.SANDSTONE.getDefaultState(), false);
		this.fillWithBlocks(worldIn, structureBoundingBoxIn, 9, 4, 9, 11, 4, 11, Blocks.AIR.getDefaultState(),
				Blocks.AIR.getDefaultState(), false);
		this.fillWithBlocks(worldIn, structureBoundingBoxIn, 8, 1, 8, 8, 3, 8, Blocks.CUT_SANDSTONE.getDefaultState(),
				Blocks.CUT_SANDSTONE.getDefaultState(), false);
		this.fillWithBlocks(worldIn, structureBoundingBoxIn, 12, 1, 8, 12, 3, 8, Blocks.CUT_SANDSTONE.getDefaultState(),
				Blocks.CUT_SANDSTONE.getDefaultState(), false);
		this.fillWithBlocks(worldIn, structureBoundingBoxIn, 8, 1, 12, 8, 3, 12, Blocks.CUT_SANDSTONE.getDefaultState(),
				Blocks.CUT_SANDSTONE.getDefaultState(), false);
		...
		this.fillWithBlocks(worldIn, structureBoundingBoxIn, this.width - 7, 7, 9, this.width - 7, 7, 11,
				Blocks.SANDSTONE.getDefaultState(), Blocks.SANDSTONE.getDefaultState(), false);
		this.fillWithBlocks(worldIn, structureBoundingBoxIn, 5, 5, 9, 5, 7, 11, Blocks.CUT_SANDSTONE.getDefaultState(),
				Blocks.CUT_SANDSTONE.getDefaultState(), false);
		...
		this.fillWithBlocks(worldIn, structureBoundingBoxIn, 2, 4, 4, 2, 6, 4, Blocks.AIR.getDefaultState(),
				Blocks.AIR.getDefaultState(), false);
		this.fillWithBlocks(worldIn, structureBoundingBoxIn, this.width - 3, 4, 4, this.width - 3, 6, 4,
		...
		this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 1, 3, 2, 2, 3, Blocks.SANDSTONE.getDefaultState(),
				Blocks.SANDSTONE.getDefaultState(), false);
		this.fillWithBlocks(worldIn, structureBoundingBoxIn, this.width - 3, 1, 3, this.width - 2, 2, 3,
				Blocks.SANDSTONE.getDefaultState(), Blocks.SANDSTONE.getDefaultState(), false);
		...
		this.setBlockState(worldIn, Blocks.SANDSTONE_SLAB.getDefaultState(), this.width - 2, 2, 2,
				structureBoundingBoxIn);
		...
		this.fillWithBlocks(worldIn, structureBoundingBoxIn, 4, 3, 5, 4, 3, 17, Blocks.SANDSTONE.getDefaultState(),
				Blocks.SANDSTONE.getDefaultState(), false);
		...
		this.fillWithBlocks(worldIn, structureBoundingBoxIn, 3, 1, 5, 4, 2, 16, Blocks.AIR.getDefaultState(),
				Blocks.AIR.getDefaultState(), false);
		this.fillWithBlocks(worldIn, structureBoundingBoxIn, this.width - 6, 1, 5, this.width - 5, 2, 16,
				Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
		...
		for (int l = 5; l <= 17; l += 2) {
			...
			this.setBlockState(worldIn, Blocks.CUT_SANDSTONE.getDefaultState(), this.width - 5, 1, l,
					structureBoundingBoxIn);
			this.setBlockState(worldIn, Blocks.CHISELED_SANDSTONE.getDefaultState(), this.width - 5, 2, l,
					structureBoundingBoxIn);
		}
		...
		for (int i2 = 2; i2 <= this.width - 3; i2 += this.width - 3 - 2) {
			...
			this.setBlockState(worldIn, Blocks.CUT_SANDSTONE.getDefaultState(), i2 + 1, 3, 0, structureBoundingBoxIn);
			this.setBlockState(worldIn, Blocks.ORANGE_TERRACOTTA.getDefaultState(), i2 - 1, 4, 0,
					structureBoundingBoxIn);
			...
			this.setBlockState(worldIn, Blocks.CUT_SANDSTONE.getDefaultState(), i2 + 1, 5, 0, structureBoundingBoxIn);
			this.setBlockState(worldIn, Blocks.ORANGE_TERRACOTTA.getDefaultState(), i2 - 1, 6, 0,
					structureBoundingBoxIn);
			this.setBlockState(worldIn, Blocks.CHISELED_SANDSTONE.getDefaultState(), i2, 6, 0, structureBoundingBoxIn);
			this.setBlockState(worldIn, Blocks.ORANGE_TERRACOTTA.getDefaultState(), i2 + 1, 6, 0,
					structureBoundingBoxIn);
			this.setBlockState(worldIn, Blocks.ORANGE_TERRACOTTA.getDefaultState(), i2 - 1, 7, 0,
					structureBoundingBoxIn);
		...
		// pit
		this.fillWithBlocks(worldIn, structureBoundingBoxIn, 8, 4, 0, 12, 6, 0, Blocks.CUT_SANDSTONE.getDefaultState(),
				Blocks.CUT_SANDSTONE.getDefaultState(), false);
		...
		this.fillWithBlocks(worldIn, structureBoundingBoxIn, 8, -15, 8, 12, -11, 12,
				Blocks.CUT_SANDSTONE.getDefaultState(), Blocks.CUT_SANDSTONE.getDefaultState(), false);
		...
		this.fillWithBlocks(worldIn, structureBoundingBoxIn, 9, -14, 9, 11, -13, 11, Blocks.TNT.getDefaultState(),
				Blocks.AIR.getDefaultState(), false);
		this.setBlockState(worldIn, Blocks.OBSERVER.getDefaultState().with(DirectionalBlock.FACING, Direction.UP), 10,
