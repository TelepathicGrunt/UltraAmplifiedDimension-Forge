...
public class ColumnBlocksConfig implements IFeatureConfig
{
	...
	{
		return new Dynamic<>(ops, ops.createMap(ImmutableMap.of(ops.createString("top_block"), ops.createInt(BlockRegistry.getID(topBlock.getBlock())), ops.createString("middle_block"), ops.createInt(BlockRegistry.getID(middleBlock.getBlock())), ops.createString("inside_block"), ops.createInt(BlockRegistry.getID(insideBlock.getBlock())))));
	}
