...
{
    public DungeonNether(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn) {
            ...
            for (int k3 = k; k3 <= l; ++k3)
            {
                for (int i4 = 3; i4 >= -1; --i4)
                {
                    for (int k4 = l1; k4 <= i2; ++k4)
                    {
                        ...
                        else if (k3 != k && k4 != l1 && k3 != l && i4 != 4 && world.getBlockState(blockpos1).getMaterial().isSolid() && world.getBlockState(blockpos1).getBlock() != Blocks.CHEST && world.getBlockState(blockpos1).getBlock() != Blocks.SPAWNER)
                        {
                            if (i4 == -1 && rand.nextInt(4) != 0)
                            {
                                world.setBlockState(blockpos1, Blocks.NETHER_BRICK_SLAB.getDefaultState(), 2);
                            }
                            else
                            {
                                world.setBlockState(blockpos1, Blocks.NETHER_BRICKS.getDefaultState(), 2);
                            }
                        }
                    }
                }
                ...
                for (int j4 = 0; j4 < 3; ++j4)
                {
                    ...
                    if (world.isAirBlock(blockpos2))
                    {
                        ...
                        if (j3 == 1)
                        {
                        	...
                        	LockableLootTileEntity.setLootTable(world, rand, blockpos2, LootTables.CHESTS_END_CITY_TREASURE);
                            world.setBlockState(blockpos2.down(), Blocks.NETHER_BRICKS.getDefaultState(), 2);
