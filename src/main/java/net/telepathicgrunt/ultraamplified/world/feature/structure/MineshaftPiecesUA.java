...
public class MineshaftPiecesUA
{
     ...
     */
	private static MineshaftPiecesUA.Piece createRandomShaftPiece(List<StructurePiece> p_189940_0_, Random p_189940_1_, int p_189940_2_, int p_189940_3_, int p_189940_4_, @Nullable Direction p_189940_5_, int p_189940_6_, MineshaftStructureUA.Type p_189940_7_)
	{
	...
	public static class Corridor extends MineshaftPiecesUA.Piece
	{
		...
		public Corridor(int p_i47140_1_, Random p_i47140_2_, MutableBoundingBox p_i47140_3_, Direction p_i47140_4_, MineshaftStructureUA.Type p_i47140_5_)
		{
	...
	public static class Cross extends MineshaftPiecesUA.Piece
	{
		...
		public Cross(int p_i50455_1_, MutableBoundingBox p_i50455_2_, @Nullable Direction p_i50455_3_, MineshaftStructureUA.Type p_i50455_4_)
		{
	...
	{
		public Stairs(int p_i50449_1_, MutableBoundingBox p_i50449_2_, Direction p_i50449_3_, MineshaftStructureUA.Type p_i50449_4_)
		{
