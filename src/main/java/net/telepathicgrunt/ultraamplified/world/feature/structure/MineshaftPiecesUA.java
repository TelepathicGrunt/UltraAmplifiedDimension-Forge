...
public class MineshaftPiecesUA {
	...
	private static MineshaftPiecesUA.Piece createRandomShaftPiece(List<StructurePiece> p_189940_0_, Random p_189940_1_,
		...
		if (i >= 80) {
			MutableBoundingBox MutableBoundingBox = MineshaftPiecesUA.Cross.findCrossing(p_189940_0_, p_189940_1_,
					p_189940_2_, p_189940_3_, p_189940_4_, p_189940_5_);

			if (MutableBoundingBox != null) {
				return new MineshaftPiecesUA.Cross(p_189940_6_, MutableBoundingBox, p_189940_5_, p_189940_7_);
			}
		} else if (i >= 70) {
			MutableBoundingBox MutableBoundingBox1 = MineshaftPiecesUA.Stairs.findStairs(p_189940_0_, p_189940_1_,
					p_189940_2_, p_189940_3_, p_189940_4_, p_189940_5_);
			...
			MutableBoundingBox MutableBoundingBox2 = MineshaftPiecesUA.Corridor.findCorridorSize(p_189940_0_,
					p_189940_1_, p_189940_2_, p_189940_3_, p_189940_4_, p_189940_5_);

			if (MutableBoundingBox2 != null) {
				return new MineshaftPiecesUA.Corridor(p_189940_6_, p_189940_1_, MutableBoundingBox2, p_189940_5_,
						p_189940_7_);
			}
		}
	...
	private static MineshaftPiecesUA.Piece generateAndAddPiece(StructurePiece p_189938_0_,
			List<StructurePiece> p_189938_1_, Random p_189938_2_, int p_189938_3_, int p_189938_4_, int p_189938_5_,
			Direction p_189938_6_, int p_189938_7_) {
		if (p_189938_7_ > 8) {
			return null;
	...
	public static class Corridor extends MineshaftPiecesUA.Piece {
		...
		public static MutableBoundingBox findCorridorSize(List<StructurePiece> p_175814_0_, Random rand, int x, int y,
		...
		public void buildComponent(StructurePiece componentIn, List<StructurePiece> listIn, Random rand) {
			...
			if (enumfacing != null) {
				...
				default:
					if (j <= 1) {
						MineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX,
								this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ - 1, enumfacing, i);
					} else if (j == 2) {
						MineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1,
								this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ, Direction.WEST, i);
					} else {
						MineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1,
								this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ, Direction.EAST, i);
					}
				...
				case SOUTH:
					if (j <= 1) {
						...
						MineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1,
								this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ - 3, Direction.WEST,
								i);
					} else {
						MineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1,
								this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ - 3, Direction.EAST,
								i);
					}
				...
				case WEST:
					if (j <= 1) {
						...
						MineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX,
								this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ - 1, Direction.NORTH,
								i);
					} else {
						MineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX,
								this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ + 1, Direction.SOUTH,
								i);
					}
				...
				case EAST:
					if (j <= 1) {
						...
						MineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX - 3,
								this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ - 1, Direction.NORTH,
								i);
					} else {
						MineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX - 3,
			...
			if (i < 8) {
				if (enumfacing != Direction.NORTH && enumfacing != Direction.SOUTH) {
					for (int i1 = this.boundingBox.minX + 3; i1 + 3 <= this.boundingBox.maxX; i1 += 5) {
						...
						if (j1 == 0) {
							MineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, i1, this.boundingBox.minY,
									this.boundingBox.minZ - 1, Direction.NORTH, i + 1);
						} else if (j1 == 1) {
							MineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, i1, this.boundingBox.minY,
									this.boundingBox.maxZ + 1, Direction.SOUTH, i + 1);
						}
					}
				} else {
					for (int k = this.boundingBox.minZ + 3; k + 3 <= this.boundingBox.maxZ; k += 5) {
						...
						if (l == 0) {
							MineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1,
									this.boundingBox.minY, k, Direction.WEST, i + 1);
						} else if (l == 1) {
							MineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1,
									this.boundingBox.minY, k, Direction.EAST, i + 1);
						}
					}
				}
			}
		...
		public boolean func_225577_a_(IWorld world, ChunkGenerator<?> p_225577_2_, Random random,
			...
			if (this.isLiquidInStructureBoundingBox(world, MutableBoundingBoxIn)) {
				...
				if (this.hasRails) {
					BlockState iblockstate1 = Blocks.RAIL.getDefaultState().with(RailBlock.SHAPE,
		...
		private void placeCobWeb(IWorld p_189922_1_, MutableBoundingBox p_189922_2_, Random p_189922_3_,
			...
			if (this.getSkyBrightness(p_189922_1_, p_189922_5_, p_189922_6_, p_189922_7_, p_189922_2_)) {
				this.randomlyPlaceBlock(p_189922_1_, p_189922_2_, p_189922_3_, p_189922_4_, p_189922_5_, p_189922_6_,
						p_189922_7_, Blocks.COBWEB.getDefaultState());
			}
		}
	...
	public static class Cross extends MineshaftPiecesUA.Piece {
		...
		public static MutableBoundingBox findCrossing(List<StructurePiece> listIn, Random rand, int x, int y, int z,
				Direction facing) {
			MutableBoundingBox MutableBoundingBox = new MutableBoundingBox(x, y, z, x, y + 2, z);
		...
		public void buildComponent(StructurePiece componentIn, List<StructurePiece> listIn, Random rand) {
			...
			default:
				MineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX + 1,
						this.boundingBox.minY, this.boundingBox.minZ - 1, Direction.NORTH, i);
				MineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1,
						this.boundingBox.minY, this.boundingBox.minZ + 1, Direction.WEST, i);
				MineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1,
						this.boundingBox.minY, this.boundingBox.minZ + 1, Direction.EAST, i);
				break;

			case SOUTH:
				MineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX + 1,
						this.boundingBox.minY, this.boundingBox.maxZ + 1, Direction.SOUTH, i);
				MineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1,
						this.boundingBox.minY, this.boundingBox.minZ + 1, Direction.WEST, i);
				MineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1,
						this.boundingBox.minY, this.boundingBox.minZ + 1, Direction.EAST, i);
			...
			if (this.isMultipleFloors) {
				if (rand.nextBoolean()) {
					MineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX + 1,
							this.boundingBox.minY + 3 + 1, this.boundingBox.minZ - 1, Direction.NORTH, i);
				}

				if (rand.nextBoolean()) {
					MineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1,
							this.boundingBox.minY + 3 + 1, this.boundingBox.minZ + 1, Direction.WEST, i);
				}

				if (rand.nextBoolean()) {
					MineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1,
							this.boundingBox.minY + 3 + 1, this.boundingBox.minZ + 1, Direction.EAST, i);
				}

				if (rand.nextBoolean()) {
					MineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX + 1,
							this.boundingBox.minY + 3 + 1, this.boundingBox.maxZ + 1, Direction.SOUTH, i);
				}
			}
		}
		...
		private void placeSupportPillar(IWorld p_189923_1_, MutableBoundingBox p_189923_2_, int p_189923_3_,
			...
			if (this.getBlockStateFromPos(p_189923_1_, p_189923_3_, p_189923_6_ + 1, p_189923_5_, p_189923_2_)
				...
				this.fillWithBlocks(p_189923_1_, p_189923_2_, p_189923_3_, p_189923_4_, p_189923_5_, p_189923_3_,
						p_189923_6_, p_189923_5_, this.getPlanksBlock(), CAVE_AIR, false);
			}
		}
	}
	...
	public static class Room extends MineshaftPiecesUA.Piece {
		...
		public Room(int p_i47137_1_, Random p_i47137_2_, int p_i47137_3_, int p_i47137_4_,
			...
			if (normalRoom) {
				...
				this.boundingBox = new MutableBoundingBox(p_i47137_3_, 20, p_i47137_4_,
						p_i47137_3_ + 7 + p_i47137_2_.nextInt(6), 30, p_i47137_4_ + 7 + p_i47137_2_.nextInt(6));
			} else {
				// giant pit-like dirt room mineshafts
				int height = p_i47137_2_.nextInt(90);
				this.boundingBox = new MutableBoundingBox(p_i47137_3_, 20, p_i47137_4_,
						p_i47137_3_ + 7 + p_i47137_2_.nextInt(6), 150 + height,
		...
		public void buildComponent(StructurePiece componentIn, List<StructurePiece> listIn, Random rand) {
			...
			for (int j = 0; j < this.boundingBox.getXSize(); j = l + 4) {
				...
				MineshaftPiecesUA.Piece structuremineshaftpieces$peice = MineshaftPiecesUA.generateAndAddPiece(
						componentIn, listIn, rand, this.boundingBox.minX + l,
						this.boundingBox.minY + rand.nextInt(y) + 1, this.boundingBox.minZ - 1, Direction.NORTH, i);

				if (structuremineshaftpieces$peice != null) {
					MutableBoundingBox MutableBoundingBox = structuremineshaftpieces$peice.getBoundingBox();
					this.roomsLinkedToTheRoom.add(new MutableBoundingBox(MutableBoundingBox.minX,
							MutableBoundingBox.minY, this.boundingBox.minZ, MutableBoundingBox.maxX,
							MutableBoundingBox.maxY, this.boundingBox.minZ + 1));
				}
			}
			...
			for (int i1 = 0; i1 < this.boundingBox.getXSize(); i1 = l + 4) {
				...
				MineshaftPiecesUA.Piece structuremineshaftpieces$peice1 = MineshaftPiecesUA.generateAndAddPiece(
						componentIn, listIn, rand, this.boundingBox.minX + l,
						this.boundingBox.minY + rand.nextInt(y) + 1, this.boundingBox.maxZ + 1, Direction.SOUTH, i);
				...
				if (structuremineshaftpieces$peice1 != null) {
					...
					this.roomsLinkedToTheRoom.add(new MutableBoundingBox(MutableBoundingBox1.minX,
							MutableBoundingBox1.minY, this.boundingBox.maxZ - 1, MutableBoundingBox1.maxX,
							MutableBoundingBox1.maxY, this.boundingBox.maxZ));
				}
			}
			...
			for (int j1 = 0; j1 < this.boundingBox.getZSize(); j1 = l + 4) {
				...
				MineshaftPiecesUA.Piece structuremineshaftpieces$peice2 = MineshaftPiecesUA.generateAndAddPiece(
						componentIn, listIn, rand, this.boundingBox.minX - 1,
						this.boundingBox.minY + rand.nextInt(y) + 1, this.boundingBox.minZ + l, Direction.WEST, i);
				...
				if (structuremineshaftpieces$peice2 != null) {
					...
					this.roomsLinkedToTheRoom.add(new MutableBoundingBox(this.boundingBox.minX,
							MutableBoundingBox2.minY, MutableBoundingBox2.minZ, this.boundingBox.minX + 1,
							MutableBoundingBox2.maxY, MutableBoundingBox2.maxZ));
				}
			}
			...
			for (int k1 = 0; k1 < this.boundingBox.getZSize(); k1 = l + 4) {
				...
				StructurePiece StructurePiece = MineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand,
						this.boundingBox.maxX + 1, this.boundingBox.minY + rand.nextInt(y) + 1,
						this.boundingBox.minZ + l, Direction.EAST, i);

				if (StructurePiece != null) {
					MutableBoundingBox MutableBoundingBox3 = StructurePiece.getBoundingBox();
					this.roomsLinkedToTheRoom.add(new MutableBoundingBox(this.boundingBox.maxX - 1,
							MutableBoundingBox3.minY, MutableBoundingBox3.minZ, this.boundingBox.maxX,
							MutableBoundingBox3.maxY, MutableBoundingBox3.maxZ));
				}
			}
		}
	...
	public static class Stairs extends MineshaftPiecesUA.Piece {
		...
		public static MutableBoundingBox findStairs(List<StructurePiece> listIn, Random rand, int x, int y, int z,
				Direction facing) {
		...
		public void buildComponent(StructurePiece componentIn, List<StructurePiece> listIn, Random rand) {
			...
			if (enumfacing != null) {
				...
				case WEST:
					MineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1,
							this.boundingBox.minY, this.boundingBox.minZ, Direction.WEST, i);
					break;

				case EAST:
					MineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1,
							this.boundingBox.minY, this.boundingBox.minZ, Direction.EAST, i);
				}
			}
		}
