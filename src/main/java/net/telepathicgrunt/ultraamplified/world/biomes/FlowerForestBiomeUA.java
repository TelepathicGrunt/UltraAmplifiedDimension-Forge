...
public class FlowerForestBiomeUA extends UABiome
{
	public FlowerForestBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, FeatureUA.ROOTS.configure(new BlockConfig(Blocks.OAK_WOOD)).createDecoratedFeature(UAPlacement.RANDOM_BOTTOM_LAYER.configure(new CountRangeConfig(5, 70, 0, 250))));
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
				Feature.RANDOM_RANDOM_SELECTOR
						...
						.createDecoratedFeature(UAPlacement.CHANCE_ON_ALL_SURFACES.configure(new PercentageAndFrequencyConfig(0.2F, 1))));
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
				Feature.RANDOM_SELECTOR
						.configure(new MultipleRandomFeatureConfig(ImmutableList.of(Feature.NORMAL_TREE.configure(FeatureUA.getConfiguredForUndergroundTreeConfig(FeatureUA.BIRCH_TREE_WITH_BEEHIVES_CONFIG)).withChance(0.2F), Feature.FANCY_TREE.configure(FeatureUA.getConfiguredForUndergroundTreeConfig(FeatureUA.FANCY_TREE_WITH_MORE_BEEHIVES_CONFIG)).withChance(0.1F)), Feature.NORMAL_TREE.configure(FeatureUA.getConfiguredForUndergroundTreeConfig(FeatureUA.OAK_TREE_WITH_MORE_BEEHIVES_CONFIG))))
						.createDecoratedFeature(UAPlacement.AT_SURFACE_WITH_EXTRA.configure(new AtSurfaceWithExtraConfig(4, 0.5F, 1))));
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
				Feature.RANDOM_SELECTOR
						.configure(new MultipleRandomFeatureConfig(ImmutableList.of(Feature.NORMAL_TREE.configure(FeatureUA.getConfiguredForUndergroundTreeConfig(FeatureUA.BIRCH_TREE_WITH_BEEHIVES_CONFIG)).withChance(0.2F), Feature.FANCY_TREE.configure(FeatureUA.getConfiguredForUndergroundTreeConfig(FeatureUA.FANCY_TREE_WITH_MORE_BEEHIVES_CONFIG)).withChance(0.1F)), Feature.NORMAL_TREE.configure(FeatureUA.getConfiguredForUndergroundTreeConfig(FeatureUA.OAK_TREE_WITH_MORE_BEEHIVES_CONFIG))))
						.createDecoratedFeature(UAPlacement.AT_SURFACE_BELOW_TOP_LAYER_WITH_EXTRA.configure(new AtSurfaceWithExtraConfig(3, 0.5F, 1))));
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.FLOWER.configure(FeatureUA.getConfiguredClusterConfig(DefaultBiomeFeatures.FOREST_FLOWER_CONFIG)).createDecoratedFeature(UAPlacement.CHANCE_ON_ALL_SURFACES.configure(new PercentageAndFrequencyConfig(0.8F, 4))));
