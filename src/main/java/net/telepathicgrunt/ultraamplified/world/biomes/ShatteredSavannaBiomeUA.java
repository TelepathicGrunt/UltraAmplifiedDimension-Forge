...
public class ShatteredSavannaBiomeUA extends UABiome
{
	public ShatteredSavannaBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, UAFeatures.ROOTS.withConfiguration(new BlockConfig(Blocks.ACACIA_WOOD)).withPlacement(UAPlacements.RANDOM_BOTTOM_LAYER.configure(new CountRangeConfig(2, 70, 0, 250))));
