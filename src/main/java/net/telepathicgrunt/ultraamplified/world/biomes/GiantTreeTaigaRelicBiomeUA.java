...
public class GiantTreeTaigaRelicBiomeUA extends UABiome
{
	public GiantTreeTaigaRelicBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.RANDOM_SELECTOR.configure(new MultipleRandomFeatureConfig(ImmutableList.of(UAFeatures.GIANT_PINE_TREE_2.configure(UAFeatures.GIANT_SPRUCE_CONFIG).withChance(0.040641026F), UAFeatures.GIANT_PINE_TREE_1.configure(UAFeatures.GIANT_PINE_CONFIG).withChance(0.50769232F), Feature.NORMAL_TREE.configure(UAFeatures.getConfiguredForUndergroundTreeConfig(DefaultBiomeFeatures.PINE_TREE_CONFIG)).withChance(0.23333334F)),
