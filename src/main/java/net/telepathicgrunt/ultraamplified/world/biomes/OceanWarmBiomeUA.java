...
public class OceanWarmBiomeUA extends UABiome
{
	public OceanWarmBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.SIMPLE_RANDOM_SELECTOR.configure(new SingleRandomFeature(ImmutableList.of(UAFeatures.CORAL_TREE.configure(IFeatureConfig.NO_FEATURE_CONFIG), UAFeatures.CORAL_CLAW.configure(IFeatureConfig.NO_FEATURE_CONFIG), UAFeatures.CORAL_MUSHROOM.configure(IFeatureConfig.NO_FEATURE_CONFIG)))).createDecoratedFeature(UAPlacements.CHANCE_ON_ALL_WATER_BOTTOMS.configure(new PercentageAndFrequencyConfig(0.4F, 2))));
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, UAFeatures.SEA_PICKLE.configure(new CountConfig(20)).createDecoratedFeature(UAPlacements.CHANCE_ON_ALL_WATER_BOTTOMS.configure(new PercentageAndFrequencyConfig(0.08F, 1))));
