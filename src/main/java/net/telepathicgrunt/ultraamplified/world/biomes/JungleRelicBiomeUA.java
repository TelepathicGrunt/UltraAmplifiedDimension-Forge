...
public class JungleRelicBiomeUA extends UABiome
{
	public JungleRelicBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, FeatureUA.ROOTS.configure(new BlockConfig(Blocks.JUNGLE_WOOD)).createDecoratedFeature(UAPlacement.RANDOM_BOTTOM_LAYER.configure(new CountRangeConfig(20, 70, 0, 250))));
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
				Feature.RANDOM_SELECTOR.configure(new MultipleRandomFeatureConfig(
						...
						Feature.NORMAL_TREE.configure(FeatureUA.getConfiguredForUndergroundTreeConfig(DefaultBiomeFeatures.JUNGLE_TREE_CONFIG)))).createDecoratedFeature(UAPlacement.AT_SURFACE_BELOW_TOP_LAYER_WITH_EXTRA_UA.configure(new AtSurfaceWithExtraConfig(33, 0.1F, 1))));
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.field_227248_z_.configure(FeatureUA.getConfiguredClusterConfig(DefaultBiomeFeatures.LUSH_GRASS_CONFIG)).createDecoratedFeature(UAPlacement.CHANCE_ON_ALL_SURFACES_UA.configure(new PercentageAndFrequencyConfig(0.95F, 13))));
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.field_227248_z_.configure(DefaultBiomeFeatures.TALL_GRASS_CONFIG).createDecoratedFeature(UAPlacement.CHANCE_ON_ALL_SURFACES_UA.configure(new PercentageAndFrequencyConfig(0.95F, 2))));
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.field_227248_z_.configure(DefaultBiomeFeatures.LARGE_FERN_CONFIG).createDecoratedFeature(UAPlacement.CHANCE_ON_ALL_SURFACES_UA.configure(new PercentageAndFrequencyConfig(0.95F, 2))));
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.field_227248_z_.configure(FeatureUA.getConfiguredClusterConfig(DefaultBiomeFeatures.MELON_PATCH_CONFIG)).createDecoratedFeature(UAPlacement.CHANCE_ON_ALL_SURFACES_UA.configure(new PercentageAndFrequencyConfig(0.07F, 1))));
