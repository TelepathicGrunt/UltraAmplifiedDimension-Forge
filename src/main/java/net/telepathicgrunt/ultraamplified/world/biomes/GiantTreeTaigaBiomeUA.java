...
public class GiantTreeTaigaBiomeUA extends BiomeUA
{
	public GiantTreeTaigaBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, FeatureUA.ROOTS.configure(new BlockConfig(Blocks.SPRUCE_WOOD)).createDecoratedFeature(RANDOM_BOTTOM_LAYER.configure(new CountRangeConfig(12, 70, 0, 250))));
