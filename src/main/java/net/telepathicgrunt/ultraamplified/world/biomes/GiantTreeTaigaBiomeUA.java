...
public class GiantTreeTaigaBiomeUA extends UABiome
{
	public GiantTreeTaigaBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, UAFeatures.ROOTS.configure(new BlockConfig(Blocks.SPRUCE_WOOD)).createDecoratedFeature(UAPlacements.RANDOM_BOTTOM_LAYER.configure(new CountRangeConfig(12, 70, 0, 250))));
