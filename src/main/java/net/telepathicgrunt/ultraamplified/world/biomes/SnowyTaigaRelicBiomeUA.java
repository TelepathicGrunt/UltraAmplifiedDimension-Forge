...
public class SnowyTaigaRelicBiomeUA extends UABiome
{
	public SnowyTaigaRelicBiomeUA()
	{
		...
		this.addStructureFeature(UAFeatures.VILLAGE.configure(new VillageConfigUA(0, VillagePastStyledPiecesUA.Type.SPRUCE)));
		...
		this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, UAFeatures.ROOTS.configure(new BlockConfig(Blocks.STRIPPED_SPRUCE_WOOD)).createDecoratedFeature(UAPlacements.RANDOM_BOTTOM_LAYER.configure(new CountRangeConfig(20, 70, 0, 250))));
