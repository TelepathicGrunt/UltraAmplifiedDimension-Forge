...
public class BadlandsSandlessBiomeUA extends UABiome
{
	public BadlandsSandlessBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, FeatureUA.BETTER_CACTUS.configure(IFeatureConfig.NO_FEATURE_CONFIG).createDecoratedFeature(UAPlacement.TWICE_SURFACE_WITH_CHANCE.configure(new ChanceConfig(5))));
