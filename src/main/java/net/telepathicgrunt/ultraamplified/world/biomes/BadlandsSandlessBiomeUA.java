...
public class BadlandsSandlessBiomeUA extends UABiome
{
	public BadlandsSandlessBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, UAFeatures.COLUMN.withConfiguration(new ColumnBlocksConfig(Blocks.ORANGE_TERRACOTTA.getDefaultState(), Blocks.ORANGE_TERRACOTTA.getDefaultState(), Blocks.TERRACOTTA.getDefaultState())).withPlacement(UAPlacements.COLUMN_PLACEMENT.configure(new CountRangeConfig(2, 70, 0, 220))));
		this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, UAFeatures.RAMP.withConfiguration(new ColumnBlocksConfig(Blocks.ORANGE_TERRACOTTA.getDefaultState(), Blocks.ORANGE_TERRACOTTA.getDefaultState(), Blocks.TERRACOTTA.getDefaultState())).withPlacement(UAPlacements.RAMP_PLACEMENT.configure(new CountRangeConfig(2, 70, 0, 220))));
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, UAFeatures.BETTER_CACTUS.withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG).withPlacement(UAPlacements.TWICE_SURFACE_WITH_CHANCE.configure(new ChanceConfig(5))));
