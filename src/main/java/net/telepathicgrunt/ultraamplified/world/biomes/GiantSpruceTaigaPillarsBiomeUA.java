...
public class GiantSpruceTaigaPillarsBiomeUA extends BiomeUA
{
	public GiantSpruceTaigaPillarsBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
				Feature.RANDOM_SELECTOR.func_225566_b_(new MultipleRandomFeatureConfig(ImmutableList.of(FeatureUA.MEGA_PINE_TREE_2_UA.func_225566_b_(FeatureUA.GIANT_SPRUCE_CONFIG).func_227227_a_(0.53333334F), Feature.NORMAL_TREE.func_225566_b_(FeatureUA.getConfiguredForUndergroundTreeConfig(DefaultBiomeFeatures.field_226809_d_)).func_227227_a_(0.23333334F)), Feature.NORMAL_TREE.func_225566_b_(FeatureUA.getConfiguredForUndergroundTreeConfig(DefaultBiomeFeatures.field_226810_e_))))
