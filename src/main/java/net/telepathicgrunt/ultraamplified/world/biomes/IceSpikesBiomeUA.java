...
public class IceSpikesBiomeUA extends BiomeUA
{
	public IceSpikesBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, FeatureUA.GIANT_ICE_SPIKE.configure(IFeatureConfig.NO_FEATURE_CONFIG).createDecoratedFeature(AT_SURFACE_THROUGH_WATER_WITH_EXTRA_UA.configure(new AtSurfaceWithExtraConfig(3, 0.2F, 1))));
