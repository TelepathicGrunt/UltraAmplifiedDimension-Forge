...
public class IceSpikesBiomeUA extends UABiome
{
	public IceSpikesBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, FeatureUA.GIANT_ICE_SPIKE.configure(IFeatureConfig.NO_FEATURE_CONFIG).createDecoratedFeature(UAPlacement.AT_SURFACE_THROUGH_WATER_WITH_EXTRA.configure(new AtSurfaceWithExtraConfig(3, 0.2F, 1))));
