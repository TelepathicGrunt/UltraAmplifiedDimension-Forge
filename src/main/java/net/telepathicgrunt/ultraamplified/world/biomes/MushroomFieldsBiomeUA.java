...
public class MushroomFieldsBiomeUA extends BiomeUA
{
	public MushroomFieldsBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.RANDOM_BOOLEAN_SELECTOR.configure(new TwoFeatureChoiceConfig(FeatureUA.HUGE_RED_MUSHROOM_FIX.configure(DefaultBiomeFeatures.HUGE_RED_MUSHROOM_CONFIG), FeatureUA.HUGE_BROWN_MUSHROOM_FIX.configure(DefaultBiomeFeatures.HUGE_BROWN_MUSHROOM_CONFIG))).createDecoratedFeature(AT_SURFACE_WITH_EXTRA_UA.configure(new AtSurfaceWithExtraConfig(1, 0.0f, 0))));
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.RANDOM_BOOLEAN_SELECTOR.configure(new TwoFeatureChoiceConfig(FeatureUA.HUGE_RED_MUSHROOM_FIX.configure(DefaultBiomeFeatures.HUGE_RED_MUSHROOM_CONFIG), FeatureUA.HUGE_BROWN_MUSHROOM_FIX.configure(DefaultBiomeFeatures.HUGE_BROWN_MUSHROOM_CONFIG))).createDecoratedFeature(AT_SURFACE_BELOW_TOP_LAYER_WITH_EXTRA_UA.configure(new AtSurfaceWithExtraConfig(1, 0.7f, 1))));
