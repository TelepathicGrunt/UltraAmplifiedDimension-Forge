...
public class OceanDeepLukewarmBiomeUA extends UABiome
{
	public OceanDeepLukewarmBiomeUA()
	{
		super((new Builder()).surfaceBuilder(new ConfiguredSurfaceBuilder<>(UASurfaceBuilders.DEEP_OCEAN_SURFACE_BUILDER_UA, UASurfaceBuilders.GRASS_SAND_SANDSTONE_SURFACE)).precipitation(Biome.RainType.RAIN).category(Biome.Category.OCEAN).depth(-1.8F).scale(0.1F).temperature(0.7F).downfall(0.5F).waterColor(4566514).waterFogColor(267827).parent((String) null));
		...
		this.addStructureFeature(UAFeatures.SHIPWRECK.configure(new ShipwreckConfig(false)));
