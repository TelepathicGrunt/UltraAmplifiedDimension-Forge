...
public class IcedTerrainBiomeUA extends UABiome
{
	public IcedTerrainBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, FeatureUA.BLUE_ICE_WATERFALL.configure(IFeatureConfig.NO_FEATURE_CONFIG).createDecoratedFeature(UAPlacement.HEIGHT_BIASED_RANGE.configure(new CountRangeConfig(36, 75, 8, 225))));
