...
public class OceanDeepFrozenBiomeUA extends UABiome
{
	...
	public OceanDeepFrozenBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, UAFeatures.ICEBERG.withConfiguration(new BlockStateFeatureConfig(Blocks.PACKED_ICE.getDefaultState())).withPlacement(UAPlacements.CHANCE_ON_ALL_WATER_SURFACES.configure(new PercentageAndFrequencyConfig(0.35F, 6))));
		this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, UAFeatures.ICEBERG.withConfiguration(new BlockStateFeatureConfig(Blocks.BLUE_ICE.getDefaultState())).withPlacement(UAPlacements.CHANCE_ON_ALL_WATER_SURFACES.configure(new PercentageAndFrequencyConfig(0.09F, 2))));
