...
public class OceanDeepFrozenBiomeUA extends UABiome
{
	...
	public OceanDeepFrozenBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, FeatureUA.ICEBERG_UA.configure(new BlockStateFeatureConfig(Blocks.PACKED_ICE.getDefaultState())).createDecoratedFeature(UAPlacement.CHANCE_ON_ALL_WATER_SURFACES.configure(new PercentageAndFrequencyConfig(0.35F, 6))));
		this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, FeatureUA.ICEBERG_UA.configure(new BlockStateFeatureConfig(Blocks.BLUE_ICE.getDefaultState())).createDecoratedFeature(UAPlacement.CHANCE_ON_ALL_WATER_SURFACES.configure(new PercentageAndFrequencyConfig(0.09F, 2))));
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.FLOWER.configure(FeatureUA.getConfiguredClusterConfig(DefaultBiomeFeatures.DEFAULT_FLOWER_CONFIG)).createDecoratedFeature(UAPlacement.CHANCE_ON_ALL_SURFACES.configure(new PercentageAndFrequencyConfig(0.2F, 2))));
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.field_227248_z_.configure(FeatureUA.getConfiguredClusterConfig(DefaultBiomeFeatures.GRASS_CONFIG)).createDecoratedFeature(UAPlacement.CHANCE_ON_ALL_SURFACES.configure(new PercentageAndFrequencyConfig(0.3F, 2))));
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, FeatureUA.KELP_UA.configure(IFeatureConfig.NO_FEATURE_CONFIG).createDecoratedFeature(UAPlacement.CHANCE_ON_ALL_WATER_BOTTOMS.configure(new PercentageAndFrequencyConfig(0.1F, 2))));
