...
public class OceanDeepFrozenBiomeUA extends BiomeUA
{
	...
	public OceanDeepFrozenBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, FeatureUA.ICEBERG_UA.configure(new BlockStateFeatureConfig(Blocks.PACKED_ICE.getDefaultState())).createDecoratedFeature(CHANCE_ON_ALL_WATER_SURFACES_UA.configure(new PercentageAndFrequencyConfig(0.35F, 6))));
		this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, FeatureUA.ICEBERG_UA.configure(new BlockStateFeatureConfig(Blocks.BLUE_ICE.getDefaultState())).createDecoratedFeature(CHANCE_ON_ALL_WATER_SURFACES_UA.configure(new PercentageAndFrequencyConfig(0.09F, 2))));
		...
		this.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Feature.ORE.configure(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, Blocks.ICE.getDefaultState(), 60)).createDecoratedFeature(Placement.COUNT_RANGE.configure(new CountRangeConfig(13, 0, 0, 100))));
