...
public class OceanDeepFrozenBiomeUA extends BiomeUA
{
	...
	public OceanDeepFrozenBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, FeatureUA.ICEBERG_UA.func_225566_b_(new BlockStateFeatureConfig(Blocks.PACKED_ICE.getDefaultState())).func_227228_a_(CHANCE_ON_ALL_WATER_SURFACES_UA.func_227446_a_(new PercentageAndFrequencyConfig(0.35F, 6))));
		this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, FeatureUA.ICEBERG_UA.func_225566_b_(new BlockStateFeatureConfig(Blocks.BLUE_ICE.getDefaultState())).func_227228_a_(CHANCE_ON_ALL_WATER_SURFACES_UA.func_227446_a_(new PercentageAndFrequencyConfig(0.09F, 2))));
