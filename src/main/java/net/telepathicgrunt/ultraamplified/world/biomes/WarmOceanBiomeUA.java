...
public class WarmOceanBiomeUA extends BiomeUA {
	public WarmOceanBiomeUA() {
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.GRASS.func_225566_b_(new GrassFeatureConfig(Blocks.GRASS.getDefaultState())).func_227228_a_(CHANCE_ON_ALL_SURFACES_UA.func_227446_a_(new PercentageAndFrequencyConfig(0.5F, 4))));
