...
public class FrozenDesertBiomeUA extends UABiome
{
	public FrozenDesertBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, FeatureUA.ICE_PATCH_SANDY.configure(IFeatureConfig.NO_FEATURE_CONFIG).createDecoratedFeature(UAPlacement.CHANCE_ON_ALL_SURFACES.configure(new PercentageAndFrequencyConfig(0.40F, 4))));
