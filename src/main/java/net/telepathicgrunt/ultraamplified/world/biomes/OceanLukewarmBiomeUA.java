...
public class OceanLukewarmBiomeUA extends UABiome
{
	public OceanLukewarmBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, UAFeatures.SEA_GRASS_UA.configure(new SeaGrassConfig(32, 0.3D)).createDecoratedFeature(UAPlacements.CHANCE_ON_ALL_WATER_BOTTOMS.configure(new PercentageAndFrequencyConfig(0.7F, 5))));
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, UAFeatures.KELP_UA.configure(IFeatureConfig.NO_FEATURE_CONFIG).createDecoratedFeature(UAPlacements.CHANCE_ON_ALL_WATER_BOTTOMS.configure(new PercentageAndFrequencyConfig(0.3F, 2))));
