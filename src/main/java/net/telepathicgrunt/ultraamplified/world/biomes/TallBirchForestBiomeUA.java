...
public class TallBirchForestBiomeUA extends BiomeUA {
	public TallBirchForestBiomeUA() {
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.RANDOM_SELECTOR.func_225566_b_(new MultipleRandomFeatureConfig(ImmutableList.of(FeatureUA.MEGA_BIRCH_TREE.func_225566_b_(DefaultBiomeFeatures.field_226823_r_).func_227227_a_(0.43333334F), Feature.NORMAL_TREE.func_225566_b_(DefaultBiomeFeatures.field_226813_h_).func_227227_a_(0.33333334F)), Feature.NORMAL_TREE.func_225566_b_(DefaultBiomeFeatures.field_226812_g_))).func_227228_a_(AT_SURFACE_WITH_EXTRA_UA.func_227446_a_(new AtSurfaceWithExtraConfig(22, 0.5F, 1))));
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.RANDOM_SELECTOR.func_225566_b_(new MultipleRandomFeatureConfig(ImmutableList.of(FeatureUA.MEGA_BIRCH_TREE.func_225566_b_(DefaultBiomeFeatures.field_226823_r_).func_227227_a_(0.43333334F), Feature.NORMAL_TREE.func_225566_b_(DefaultBiomeFeatures.field_226813_h_).func_227227_a_(0.33333334F)), Feature.NORMAL_TREE.func_225566_b_(DefaultBiomeFeatures.field_226812_g_))).func_227228_a_(AT_SURFACE_BELOW_TOP_LAYER_WITH_EXTRA_UA.func_227446_a_(new AtSurfaceWithExtraConfig(18, 0.5F, 1))));
