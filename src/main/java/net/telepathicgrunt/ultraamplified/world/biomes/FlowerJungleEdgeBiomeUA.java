...
public class FlowerJungleEdgeBiomeUA extends BiomeUA
{
	public FlowerJungleEdgeBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, FeatureUA.ROOTS.configure(new BlockConfig(Blocks.JUNGLE_WOOD)).createDecoratedFeature(RANDOM_BOTTOM_LAYER.configure(new CountRangeConfig(4, 70, 0, 250))));
		...
		this.addFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, FeatureUA.HAY_BALE.configure(IFeatureConfig.NO_FEATURE_CONFIG).createDecoratedFeature(Placement.CHANCE_HEIGHTMAP.configure(new ChanceConfig(10))));
		this.addFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, FeatureUA.TINY_HAY_BALE.configure(IFeatureConfig.NO_FEATURE_CONFIG).createDecoratedFeature(Placement.CHANCE_HEIGHTMAP.configure(new ChanceConfig(10))));
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
				Feature.RANDOM_SELECTOR
						.configure(new MultipleRandomFeatureConfig(ImmutableList.of(Feature.FANCY_TREE.configure(FeatureUA.getConfiguredForUndergroundTreeConfig(FeatureUA.FANCY_TREE_WITH_MORE_BEEHIVES_CONFIG)).withChance(0.1F), FeatureUA.JUNGLE_BUSH_UA.configure(FeatureUA.getConfiguredForUndergroundTreeConfig(DefaultBiomeFeatures.JUNGLE_GROUND_BUSH_CONFIG)).withChance(0.5F)), Feature.NORMAL_TREE.configure(FeatureUA.getConfiguredForUndergroundTreeConfig(DefaultBiomeFeatures.JUNGLE_TREE_CONFIG))))
						.createDecoratedFeature(AT_SURFACE_BELOW_TOP_LAYER_WITH_EXTRA_UA.configure(new AtSurfaceWithExtraConfig(2, 0, 0))));
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.field_227248_z_.configure(FeatureUA.getConfiguredClusterConfig(DefaultBiomeFeatures.LUSH_GRASS_CONFIG)).createDecoratedFeature(CHANCE_ON_ALL_SURFACES_UA.configure(new PercentageAndFrequencyConfig(0.95F, 15))));
