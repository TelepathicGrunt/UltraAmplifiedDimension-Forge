...
public class FlowerJungleEdgeBiomeUA extends UABiome
{
	public FlowerJungleEdgeBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, UAFeatures.HAY_BALE.withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG).withPlacement(Placement.CHANCE_HEIGHTMAP.configure(new ChanceConfig(10))));
		this.addFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, UAFeatures.TINY_HAY_BALE.withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG).withPlacement(Placement.CHANCE_HEIGHTMAP.configure(new ChanceConfig(10))));
