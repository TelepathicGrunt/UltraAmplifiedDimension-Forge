	...
	public TallBirchForestRelicBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
				Feature.RANDOM_SELECTOR.configure(new MultipleRandomFeatureConfig(ImmutableList.of(FeatureUA.GIANT_BIRCH_TREE.configure(FeatureUA.GIANT_BIRCH_CONFIG).withChance(0.85F), Feature.NORMAL_TREE.configure(FeatureUA.getConfiguredForUndergroundTreeConfig(DefaultBiomeFeatures.LARGE_BIRCH_TREE_CONFIG)).withChance(0.2F)), Feature.NORMAL_TREE.configure(FeatureUA.getConfiguredForUndergroundTreeConfig(DefaultBiomeFeatures.BIRCH_TREE_CONFIG))))
						.createDecoratedFeature(UAPlacement.AT_SURFACE_WITH_EXTRA_UA.configure(new AtSurfaceWithExtraConfig(17, 0.75F, 1))));
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
				Feature.RANDOM_SELECTOR.configure(new MultipleRandomFeatureConfig(ImmutableList.of(FeatureUA.GIANT_BIRCH_TREE.configure(FeatureUA.GIANT_BIRCH_CONFIG).withChance(0.85F), Feature.NORMAL_TREE.configure(FeatureUA.getConfiguredForUndergroundTreeConfig(DefaultBiomeFeatures.LARGE_BIRCH_TREE_CONFIG)).withChance(0.2F)), Feature.NORMAL_TREE.configure(FeatureUA.getConfiguredForUndergroundTreeConfig(DefaultBiomeFeatures.BIRCH_TREE_CONFIG))))
						.createDecoratedFeature(UAPlacement.AT_SURFACE_BELOW_TOP_LAYER_WITH_EXTRA_UA.configure(new AtSurfaceWithExtraConfig(15, 0.75F, 1))));
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.field_227248_z_.configure(FeatureUA.getConfiguredClusterConfig(DefaultBiomeFeatures.GRASS_CONFIG)).createDecoratedFeature(UAPlacement.CHANCE_ON_ALL_SURFACES_UA.configure(new PercentageAndFrequencyConfig(0.3F, 3))));
