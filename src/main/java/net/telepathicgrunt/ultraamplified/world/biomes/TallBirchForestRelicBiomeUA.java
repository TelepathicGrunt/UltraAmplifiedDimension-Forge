...
public class TallBirchForestRelicBiomeUA extends UABiome
{
	public TallBirchForestRelicBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, UAFeatures.ROOTS.configure(new BlockConfig(Blocks.STRIPPED_BIRCH_WOOD)).createDecoratedFeature(UAPlacements.RANDOM_BOTTOM_LAYER.configure(new CountRangeConfig(20, 70, 0, 250))));
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
				Feature.RANDOM_SELECTOR.configure(new MultipleRandomFeatureConfig(ImmutableList.of(UAFeatures.GIANT_BIRCH_TREE.configure(UAFeatures.GIANT_BIRCH_CONFIG).withChance(0.85F), Feature.NORMAL_TREE.configure(UAFeatures.getConfiguredForUndergroundTreeConfig(DefaultBiomeFeatures.LARGE_BIRCH_TREE_CONFIG)).withChance(0.2F)), Feature.NORMAL_TREE.configure(UAFeatures.getConfiguredForUndergroundTreeConfig(DefaultBiomeFeatures.BIRCH_TREE_CONFIG))))
						.createDecoratedFeature(UAPlacements.AT_SURFACE_WITH_EXTRA.configure(new AtSurfaceWithExtraConfig(17, 0.75F, 1))));
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
				Feature.RANDOM_SELECTOR.configure(new MultipleRandomFeatureConfig(ImmutableList.of(UAFeatures.GIANT_BIRCH_TREE.configure(UAFeatures.GIANT_BIRCH_CONFIG).withChance(0.85F), Feature.NORMAL_TREE.configure(UAFeatures.getConfiguredForUndergroundTreeConfig(DefaultBiomeFeatures.LARGE_BIRCH_TREE_CONFIG)).withChance(0.2F)), Feature.NORMAL_TREE.configure(UAFeatures.getConfiguredForUndergroundTreeConfig(DefaultBiomeFeatures.BIRCH_TREE_CONFIG))))
						.createDecoratedFeature(UAPlacements.AT_SURFACE_BELOW_TOP_LAYER_WITH_EXTRA.configure(new AtSurfaceWithExtraConfig(15, 0.75F, 1))));
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
