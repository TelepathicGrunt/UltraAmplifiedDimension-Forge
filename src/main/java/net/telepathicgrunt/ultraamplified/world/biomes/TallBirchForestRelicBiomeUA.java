...
public class TallBirchForestRelicBiomeUA extends UABiome
{
	public TallBirchForestRelicBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
				Feature.RANDOM_SELECTOR.withConfiguration(new MultipleRandomFeatureConfig(ImmutableList.of(UAFeatures.GIANT_BIRCH_TREE.withConfiguration(UAFeatures.GIANT_BIRCH_CONFIG).withChance(0.85F), Feature.NORMAL_TREE.withConfiguration(UAFeatures.getConfiguredForUndergroundTreeConfig(DefaultBiomeFeatures.field_230130_i_)).withChance(0.2F)), Feature.NORMAL_TREE.withConfiguration(UAFeatures.getConfiguredForUndergroundTreeConfig(DefaultBiomeFeatures.BIRCH_TREE_CONFIG))))
						.withPlacement(UAPlacements.AT_SURFACE_WITH_EXTRA.configure(new AtSurfaceWithExtraConfig(17, 0.75F, 1))));
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
				Feature.RANDOM_SELECTOR.withConfiguration(new MultipleRandomFeatureConfig(ImmutableList.of(UAFeatures.GIANT_BIRCH_TREE.withConfiguration(UAFeatures.GIANT_BIRCH_CONFIG).withChance(0.85F), Feature.NORMAL_TREE.withConfiguration(UAFeatures.getConfiguredForUndergroundTreeConfig(DefaultBiomeFeatures.field_230130_i_)).withChance(0.2F)), Feature.NORMAL_TREE.withConfiguration(UAFeatures.getConfiguredForUndergroundTreeConfig(DefaultBiomeFeatures.BIRCH_TREE_CONFIG))))
						.withPlacement(UAPlacements.AT_SURFACE_BELOW_TOP_LAYER_WITH_EXTRA.configure(new AtSurfaceWithExtraConfig(15, 0.75F, 1))));
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
