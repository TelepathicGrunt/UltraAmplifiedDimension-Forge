...
public class ForestRelicBiomeUA extends UABiome
{
	public ForestRelicBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, UAFeatures.ROOTS.configure(new BlockConfig(Blocks.OAK_WOOD)).createDecoratedFeature(UAPlacements.RANDOM_BOTTOM_LAYER.configure(new CountRangeConfig(20, 70, 0, 250))));
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
				Feature.RANDOM_SELECTOR.configure(new MultipleRandomFeatureConfig(ImmutableList.of(Feature.NORMAL_TREE.configure(UAFeatures.getConfiguredForUndergroundTreeConfig(UAFeatures.BIRCH_TREE_WITH_BEEHIVES_CONFIG)).withChance(0.2F), Feature.FANCY_TREE.configure(UAFeatures.getConfiguredForUndergroundTreeConfig(UAFeatures.FANCY_TREE_WITH_BEEHIVES_CONFIG)).withChance(0.1F)), Feature.NORMAL_TREE.configure(UAFeatures.getConfiguredForUndergroundTreeConfig(UAFeatures.OAK_TREE_WITH_BEEHIVES_CONFIG))))
						.createDecoratedFeature(UAPlacements.AT_SURFACE_WITH_EXTRA.configure(new AtSurfaceWithExtraConfig(11, 0.2F, 1))));
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
				Feature.RANDOM_SELECTOR.configure(new MultipleRandomFeatureConfig(ImmutableList.of(Feature.NORMAL_TREE.configure(UAFeatures.getConfiguredForUndergroundTreeConfig(UAFeatures.BIRCH_TREE_WITH_BEEHIVES_CONFIG)).withChance(0.2F), Feature.FANCY_TREE.configure(UAFeatures.getConfiguredForUndergroundTreeConfig(UAFeatures.FANCY_TREE_WITH_BEEHIVES_CONFIG)).withChance(0.1F)), Feature.NORMAL_TREE.configure(UAFeatures.getConfiguredForUndergroundTreeConfig(UAFeatures.OAK_TREE_WITH_BEEHIVES_CONFIG))))
						.createDecoratedFeature(UAPlacements.AT_SURFACE_BELOW_TOP_LAYER_WITH_EXTRA.configure(new AtSurfaceWithExtraConfig(9, 0.2F, 1))));
