...
public class ForestRelicBiomeUA extends BiomeUA
{
	public ForestRelicBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.RANDOM_SELECTOR.configure(
				new MultipleRandomFeatureConfig(ImmutableList.of(Feature.NORMAL_TREE.configure(FeatureUA.getConfiguredForUndergroundTreeConfig(FeatureUA.BIRCH_TREE_WITH_BEEHIVES_CONFIG)).withChance(0.2F), Feature.FANCY_TREE.configure(FeatureUA.getConfiguredForUndergroundTreeConfig(FeatureUA.FANCY_TREE_WITH_BEEHIVES_CONFIG)).withChance(0.1F)), Feature.NORMAL_TREE.configure(FeatureUA.getConfiguredForUndergroundTreeConfig(FeatureUA.OAK_TREE_WITH_BEEHIVES_CONFIG))))
