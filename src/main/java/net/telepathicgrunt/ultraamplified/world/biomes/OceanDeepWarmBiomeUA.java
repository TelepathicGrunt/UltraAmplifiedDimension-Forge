...
public class OceanDeepWarmBiomeUA extends BiomeUA
{
	public OceanDeepWarmBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.field_227248_z_.func_225566_b_(FeatureUA.getConfiguredClusterConfig(DefaultBiomeFeatures.field_226826_u_)).func_227228_a_(CHANCE_ON_ALL_SURFACES_UA.func_227446_a_(new PercentageAndFrequencyConfig(0.2F, 10))));
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.SIMPLE_RANDOM_SELECTOR.func_225566_b_(new SingleRandomFeature(ImmutableList.of(FeatureUA.CORAL_TREE_UA.func_225566_b_(IFeatureConfig.NO_FEATURE_CONFIG), FeatureUA.CORAL_CLAW_UA.func_225566_b_(IFeatureConfig.NO_FEATURE_CONFIG), FeatureUA.CORAL_MUSHROOM_UA.func_225566_b_(IFeatureConfig.NO_FEATURE_CONFIG))))
				.func_227228_a_(CHANCE_ON_ALL_WATER_BOTTOMS_UA.func_227446_a_(new PercentageAndFrequencyConfig(0.9F, 15))));
