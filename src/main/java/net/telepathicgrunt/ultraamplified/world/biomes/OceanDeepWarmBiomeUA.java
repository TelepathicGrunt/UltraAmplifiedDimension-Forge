...
public class OceanDeepWarmBiomeUA extends UABiome
{
	public OceanDeepWarmBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.field_227248_z_.configure(FeatureUA.getConfiguredClusterConfig(DefaultBiomeFeatures.GRASS_CONFIG)).createDecoratedFeature(UAPlacement.CHANCE_ON_ALL_SURFACES.configure(new PercentageAndFrequencyConfig(0.2F, 10))));
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.SIMPLE_RANDOM_SELECTOR.configure(new SingleRandomFeature(ImmutableList.of(FeatureUA.CORAL_TREE_UA.configure(IFeatureConfig.NO_FEATURE_CONFIG), FeatureUA.CORAL_CLAW_UA.configure(IFeatureConfig.NO_FEATURE_CONFIG), FeatureUA.CORAL_MUSHROOM_UA.configure(IFeatureConfig.NO_FEATURE_CONFIG)))).createDecoratedFeature(UAPlacement.CHANCE_ON_ALL_WATER_BOTTOMS.configure(new PercentageAndFrequencyConfig(0.9F, 15))));
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, FeatureUA.SEA_PICKLE_UA.configure(new CountConfig(20)).createDecoratedFeature(UAPlacement.CHANCE_ON_ALL_WATER_BOTTOMS.configure(new PercentageAndFrequencyConfig(0.15F, 2))));
