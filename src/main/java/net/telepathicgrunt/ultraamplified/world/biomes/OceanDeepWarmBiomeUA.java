...
public class OceanDeepWarmBiomeUA extends UABiome
{
	public OceanDeepWarmBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.SIMPLE_RANDOM_SELECTOR.configure(new SingleRandomFeature(ImmutableList.of(UAFeatures.CORAL_TREE_UA.configure(IFeatureConfig.NO_FEATURE_CONFIG), UAFeatures.CORAL_CLAW_UA.configure(IFeatureConfig.NO_FEATURE_CONFIG), UAFeatures.CORAL_MUSHROOM_UA.configure(IFeatureConfig.NO_FEATURE_CONFIG)))).createDecoratedFeature(UAPlacements.CHANCE_ON_ALL_WATER_BOTTOMS.configure(new PercentageAndFrequencyConfig(0.9F, 15))));
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, UAFeatures.SEA_PICKLE_UA.configure(new CountConfig(20)).createDecoratedFeature(UAPlacements.CHANCE_ON_ALL_WATER_BOTTOMS.configure(new PercentageAndFrequencyConfig(0.15F, 2))));
