...
public class GiantSpruceTaigaRelicPillarsBiomeUA extends UABiome
{
	public GiantSpruceTaigaRelicPillarsBiomeUA()
	{
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
				Feature.RANDOM_SELECTOR.withConfiguration(new MultipleRandomFeatureConfig(ImmutableList.of(UAFeatures.GIANT_PINE_TREE_1.withConfiguration(UAFeatures.GIANT_SPRUCE_CONFIG).withChance(0.53333334F), Feature.NORMAL_TREE.withConfiguration(UAFeatures.getConfiguredForUndergroundTreeConfig(DefaultBiomeFeatures.PINE_TREE_CONFIG)).withChance(0.23333334F)), Feature.NORMAL_TREE.withConfiguration(UAFeatures.getConfiguredForUndergroundTreeConfig(DefaultBiomeFeatures.SPRUCE_TREE_CONFIG))))
