...
public class MissingMappingHandler
{
	...
	@SubscribeEvent
	public static void missingMappingBiomes(RegistryEvent.MissingMappings<Biome> event)
	{
		for (MissingMappings.Mapping<Biome> entry : event.getAllMappings())
		{
			if (entry.key.getNamespace().equals("ultra_amplified_mod"))
			{
				...
				{
					newRL = new ResourceLocation(UltraAmplified.MODID + ":" + "spooky_swampland");
				}
				...
				else if (entry.key.getPath().equals("giant_tree_taiga_hills"))
				{
					newRL = new ResourceLocation(UltraAmplified.MODID + ":" + "relic_giant_tree_taiga");
				}
				...
				else if (entry.key.getPath().equals("badlands_plateau"))
				{
					newRL = new ResourceLocation(UltraAmplified.MODID + ":" + "sandless_badlands");
				}
	...
	// dimension
	@SubscribeEvent
	public static void missingMappingDimension(RegistryEvent.MissingMappings<ModDimension> event)
	{
	...
	// features
	@SubscribeEvent
	public static void missingMappingFeature(RegistryEvent.MissingMappings<Feature<?>> event)
	{
	...
	// chunk generator?
	@SubscribeEvent
	public static void missingMappingChunkgenerator(RegistryEvent.MissingMappings<ChunkGeneratorType<?, ?>> event)
	{
	...
	// biome provider?
	@SubscribeEvent
	public static void missingMappingBiomeProvider(RegistryEvent.MissingMappings<BiomeProviderType<?, ?>> event)
	{
