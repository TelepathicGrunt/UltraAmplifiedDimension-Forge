...
public class LukewarmOceanBiomeUA extends BiomeUA {
	   public LukewarmOceanBiomeUA() {
		      ...
		      this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, createCompositeFeature(FeatureUA.CONTAIN_WATER, new ContainWaterConfig(Blocks.GRASS_BLOCK, Blocks.SAND, Blocks.SANDSTONE), PASSTHROUGH, IPlacementConfig.NO_PLACEMENT_CONFIG));
		      ...
		      this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, createCompositeFeature(FeatureUA.KELP_UA, IFeatureConfig.NO_FEATURE_CONFIG, CHANCE_ON_ALL_WATER_BOTTOMS_UA, new PercentageAndFrequencyConfig(0.3F, 2)));
