...
public class NetherBiomeUA extends BiomeUA {
   public NetherBiomeUA() {
	      ...
	      this.addFeature(GenerationStage.Decoration.UNDERGROUND_STRUCTURES, createCompositeFeature(FeatureUA.NETHER_DUNGEONS, IFeatureConfig.NO_FEATURE_CONFIG, DUNGEON_PLACEMENT, new DungeonRoomConfig(ConfigUA.dungeonSpawnrate)));
	      ...
	      this.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, createCompositeFeature(Feature.GLOWSTONE, IFeatureConfig.NO_FEATURE_CONFIG, GLOWSTONE_PLACEMENT, new FrequencyConfig(ConfigUA.glowstoneSpawnrate)));
	      this.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, createCompositeFeature(Feature.GLOWSTONE, IFeatureConfig.NO_FEATURE_CONFIG, COUNT_RANGE, new CountRangeConfig(ConfigUA.glowstoneSpawnrate, 0, 0, 256)));
	      ...
	      this.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, createCompositeFeature(Feature.MINABLE, new MinableConfig(BlockMatcher.forBlock(Blocks.NETHERRACK), Blocks.NETHER_QUARTZ_ORE.getDefaultState(), 25), COUNT_RANGE, new CountRangeConfig(ConfigUA.quartzOreSpawnrate, ConfigUA.seaLevel-18, 0, 15))); 
	      this.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, createCompositeFeature(Feature.MINABLE, new MinableConfig(BlockMatcher.forBlock(Blocks.NETHERRACK), Blocks.NETHER_QUARTZ_ORE.getDefaultState(), 25), COUNT_RANGE, new CountRangeConfig(ConfigUA.quartzOreSpawnrate/2, 10, 20, 120)));
	      this.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, createCompositeFeature(Feature.MINABLE, new MinableConfig(BlockMatcher.forBlock(Blocks.NETHERRACK), Blocks.NETHER_QUARTZ_ORE.getDefaultState(), 25), COUNT_RANGE, new CountRangeConfig(ConfigUA.quartzOreSpawnrate/10, 10, 120, 240)));
	      this.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, createCompositeFeature(Feature.MINABLE, new MinableConfig(BlockMatcher.forBlock(Blocks.NETHERRACK), Blocks.MAGMA_BLOCK.getDefaultState(), 55), COUNT_RANGE, new CountRangeConfig(ConfigUA.magmaSpawnrate, 10, 20, 100)));
	      this.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, createCompositeFeature(Feature.HELL_LAVA, new HellLavaConfig(true), COUNT_RANGE, new CountRangeConfig(ConfigUA.lavaSpawnrate, 10, 20, 240)));
