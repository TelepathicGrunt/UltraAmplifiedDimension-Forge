...
public class DeepLukewarmOceanBiomeUA extends BiomeUA {
	   public DeepLukewarmOceanBiomeUA() {
		      ...
		      this.addSpawn(EnumCreatureType.WATER_CREATURE, new Biome.SpawnListEntry(EntityType.SQUID, 16, 1, 4));
		      this.addSpawn(EnumCreatureType.WATER_CREATURE, new Biome.SpawnListEntry(EntityType.COD, 16, 3, 6));
