...
public class GiantSpruceTaigaHillsBiomeUA extends BiomeUA {
	   public GiantSpruceTaigaHillsBiomeUA() {
		      super((new Biome.BiomeBuilder()).surfaceBuilder(new CompositeSurfaceBuilder<>(TAIGA_MEGA_SURFACE_BUILDER, GRASS_DIRT_GRAVEL_SURFACE)).precipitation(Biome.RainType.RAIN).category(Biome.Category.TAIGA).depth(0.2F).scale(0.2F).temperature(0.5F).downfall(0.8F).waterColor(4159204).waterFogColor(329011).parent("giant_tree_taiga_hills"));
		      ...
		      this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, createCompositeFeature(FeatureUA.LARGE_STACKABLE_BOULDER, new BlockBlobConfig(Blocks.MOSSY_COBBLESTONE, 0), AT_SURFACE_WITH_CHANCE, new ChanceConfig(10)));
		      this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, createCompositeFeature(FeatureUA.MEDIUM_BOULDER, new BlockBlobConfig(Blocks.MOSSY_COBBLESTONE, 0),  AT_SURFACE_WITH_CHANCE, new ChanceConfig(3)));
		      this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, createCompositeFeature(FeatureUA.SMALL_BOULDER, new BlockBlobConfig(Blocks.MOSSY_COBBLESTONE, 0),  AT_SURFACE_WITH_CHANCE, new ChanceConfig(1)));
		      ...
		      this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, createCompositeFeature(Feature.RANDOM_FEATURE_LIST, new RandomDefaultFeatureListConfig(new Feature[]{FeatureUA.MEGA_PINE_TREE_1_UA, Feature.POINTY_TAIGA_TREE}, new IFeatureConfig[]{IFeatureConfig.NO_FEATURE_CONFIG, IFeatureConfig.NO_FEATURE_CONFIG}, new float[]{0.53333334F, 0.23333334F}, Feature.TALL_TAIGA_TREE, IFeatureConfig.NO_FEATURE_CONFIG), AT_SURFACE_WITH_EXTRA_UA, new AtSurfaceWithExtraConfig(25, 0.5F, 1)));
