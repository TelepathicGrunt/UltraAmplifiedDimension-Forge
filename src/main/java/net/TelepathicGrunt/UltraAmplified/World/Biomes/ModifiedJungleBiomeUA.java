...
public class ModifiedJungleBiomeUA extends BiomeUA {
	public ModifiedJungleBiomeUA() {
		...
		this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, Biome.createDecoratedFeature(FeatureUA.GLOWPATCH, new CountConfig(100), GENERAL_PLACEMENT, new CountRangeAndTypeConfig(0.4f, 45, 45, 70, false, CountRangeAndTypeConfig.Type.GLOWSTONE_PATCH)));
