...
public class SnowyBeachBiomeUA extends BiomeUA {
	   public SnowyBeachBiomeUA() {
		      ...
		      this.addFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, createCompositeFeature(FeatureUA.ICE_PATCH_SANDY, IFeatureConfig.NO_FEATURE_CONFIG, CHANCE_ON_ALL_SURFACES_UA, new PercentageAndFrequencyConfig(0.40F, 4)));
