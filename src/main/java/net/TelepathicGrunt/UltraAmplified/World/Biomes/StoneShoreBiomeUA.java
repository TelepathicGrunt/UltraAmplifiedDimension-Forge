...
public final class StoneShoreBiomeUA extends BiomeUA {
	   public StoneShoreBiomeUA() {
	      ...
	      this.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, createCompositeFeature(Feature.MINABLE, new MinableConfig(MinableConfig.IS_ROCK, Blocks.COAL_ORE.getDefaultState(), 12), COUNT_RANGE, new CountRangeConfig(ConfigUA.coalOreSpawnrate/10, ConfigUA.seaLevel-18, 0, 15))); 
	      this.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, createCompositeFeature(Feature.MINABLE, new MinableConfig(MinableConfig.IS_ROCK, Blocks.IRON_ORE.getDefaultState(), 7), COUNT_RANGE, new CountRangeConfig(ConfigUA.ironOreSpawnrate/15, ConfigUA.seaLevel-15, 0, 10))); 
	      ...
	      this.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, createCompositeFeature(Feature.MINABLE, new MinableConfig(MinableConfig.IS_ROCK, Blocks.GRANITE.getDefaultState(), 12), COUNT_RANGE, new CountRangeConfig(2, ConfigUA.seaLevel-15, 0, 12))); 
	      this.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, createCompositeFeature(Feature.MINABLE, new MinableConfig(MinableConfig.IS_ROCK, Blocks.ANDESITE.getDefaultState(), 12), COUNT_RANGE, new CountRangeConfig(3, ConfigUA.seaLevel-18, 0, 15))); 
	      this.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, createCompositeFeature(Feature.MINABLE, new MinableConfig(MinableConfig.IS_ROCK, Blocks.DIORITE.getDefaultState(), 10), COUNT_RANGE, new CountRangeConfig(1, ConfigUA.seaLevel-21, 0, 18))); 
