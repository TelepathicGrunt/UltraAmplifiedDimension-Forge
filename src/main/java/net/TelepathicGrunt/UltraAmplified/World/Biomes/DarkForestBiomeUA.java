...
public class DarkForestBiomeUA extends BiomeUA {
	public DarkForestBiomeUA() {
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Biome.createDecoratedFeature(Feature.RANDOM_SELECTOR, new MultipleRandomFeatureConfig(new Feature[]{Feature.HUGE_BROWN_MUSHROOM, Feature.HUGE_RED_MUSHROOM, Feature.DARK_OAK_TREE, Feature.FANCY_TREE}, new IFeatureConfig[] { IFeatureConfig.NO_FEATURE_CONFIG, IFeatureConfig.NO_FEATURE_CONFIG, IFeatureConfig.NO_FEATURE_CONFIG, IFeatureConfig.NO_FEATURE_CONFIG }, new float[] { 0.025F, 0.05F, 0.6666667F, 0.1F }, Feature.NORMAL_TREE, IFeatureConfig.NO_FEATURE_CONFIG), ROOFED_TREE_UA, new AtSurfaceWithExtraConfig(13, 0.5F, 1)));
