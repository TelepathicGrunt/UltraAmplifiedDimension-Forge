...
public class OceanBiomeUA extends BiomeUA {
	public OceanBiomeUA() {
		...
		this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, Biome.createDecoratedFeature(FeatureUA.CONTAIN_WATER, new ContainWaterConfig(Blocks.DEAD_HORN_CORAL_BLOCK.getDefaultState(), Blocks.GRAVEL.getDefaultState(), Blocks.GRAVEL.getDefaultState()), Placement.NOPE, IPlacementConfig.NO_PLACEMENT_CONFIG));
