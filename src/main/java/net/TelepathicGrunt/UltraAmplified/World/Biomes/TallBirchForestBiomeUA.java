...
public class TallBirchForestBiomeUA extends BiomeUA {
	public TallBirchForestBiomeUA() {
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Biome.createDecoratedFeature(Feature.RANDOM_SELECTOR, new MultipleRandomFeatureConfig(new Feature[] { FeatureUA.MEGA_BIRCH_TREE, Feature.SUPER_BIRCH_TREE }, new IFeatureConfig[] { IFeatureConfig.NO_FEATURE_CONFIG, IFeatureConfig.NO_FEATURE_CONFIG }, new float[] { 0.43333334F, 0.33333334F }, Feature.BIRCH_TREE, IFeatureConfig.NO_FEATURE_CONFIG), AT_SURFACE_WITH_EXTRA_UA, new AtSurfaceWithExtraConfig(22, 0.5F, 1)));
