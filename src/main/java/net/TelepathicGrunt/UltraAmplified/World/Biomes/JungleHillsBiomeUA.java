...
public class JungleHillsBiomeUA extends BiomeUA {
	   public JungleHillsBiomeUA() {
		      ...
		      this.addStructure(Feature.JUNGLE_PYRAMID, new JunglePyramidConfig());
		    	  ...
		    	  this.addStructure(FeatureUA.JUNGLE_TEMPLE_UA, new JunglePyramidConfig());this.addCarver(GenerationStage.Carving.AIR, createWorldCarverWrapper(CAVE_CAVITY_CARVER, new ProbabilityConfig((float)(ConfigUA.caveCavitySpawnrate)/1000)));
