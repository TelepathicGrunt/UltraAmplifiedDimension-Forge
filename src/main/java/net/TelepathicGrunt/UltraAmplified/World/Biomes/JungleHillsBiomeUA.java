...
public class JungleHillsBiomeUA extends BiomeUA {
	public JungleHillsBiomeUA() {
		...
		this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, Biome.createDecoratedFeature(FeatureUA.ROOTS, new BlockConfig(Blocks.JUNGLE_WOOD), RANDOM_BOTTOM_LAYER, new CountRangeConfig(20, 70, 0, 250)));
