...
public class DarkForestHillsBiomeUA extends BiomeUA {
	public DarkForestHillsBiomeUA() {
		...
		this.addFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, Biome.createDecoratedFeature(FeatureUA.STONEHENGE, IFeatureConfig.NO_FEATURE_CONFIG, Placement.CHANCE_HEIGHTMAP, new ChanceConfig((int)(ConfigUA.stonehengeSpawnrate*6.67f))));
