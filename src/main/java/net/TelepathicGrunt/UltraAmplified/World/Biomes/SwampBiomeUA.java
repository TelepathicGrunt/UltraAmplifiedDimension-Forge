...
public class SwampBiomeUA extends BiomeUA {
	   public SwampBiomeUA() {
		      ...
		      this.addSpawn(EnumCreatureType.MONSTER, new Biome.SpawnListEntry(EntityType.SLIME, 2, 1, 2));
		   }
