...
public class ShatteredSavannaBiomeUA extends BiomeUA {
	public ShatteredSavannaBiomeUA() {
		...
		this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, Biome.createDecoratedFeature(FeatureUA.ROOTS, new BlockConfig(Blocks.ACACIA_WOOD), RANDOM_BOTTOM_LAYER, new CountRangeConfig(2, 70, 0, 250)));
