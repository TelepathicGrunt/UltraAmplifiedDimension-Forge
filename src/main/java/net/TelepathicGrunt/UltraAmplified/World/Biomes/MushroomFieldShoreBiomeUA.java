...
public class MushroomFieldShoreBiomeUA extends BiomeUA {
	   public MushroomFieldShoreBiomeUA() {
		      super((new Biome.BiomeBuilder()).surfaceBuilder(new CompositeSurfaceBuilder<>(DEFAULT_SURFACE_BUILDER, MYCELIUM_DIRT_GRAVEL_SURFACE)).precipitation(Biome.RainType.RAIN).category(Biome.Category.MUSHROOM).depth(0.0F).scale(0.025F).temperature(0.9F).downfall(1.0F).waterColor(7106688).waterFogColor(2961469).parent((String)null));
