...
public class MushroomFieldShoreBiomeUA extends BiomeUA {
	   public MushroomFieldShoreBiomeUA() {
		      ...
		      this.addFeature(GenerationStage.Decoration.UNDERGROUND_STRUCTURES, createCompositeFeature(FeatureUA.MUSHROOM_DUNGEONS, IFeatureConfig.NO_FEATURE_CONFIG, DUNGEON_PLACEMENT, new DungeonRoomConfig(Config.dungeonSpawnrate)));
