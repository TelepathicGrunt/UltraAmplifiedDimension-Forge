...
public class WoodedBadlandsPlateauBiomeUA extends BiomeUA {
	public WoodedBadlandsPlateauBiomeUA() {
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Biome.createDecoratedFeature(Feature.NORMAL_TREE, IFeatureConfig.NO_FEATURE_CONFIG, AT_SURFACE_WITH_EXTRA_UA, new AtSurfaceWithExtraConfig(5, 0.1F, 1)));
