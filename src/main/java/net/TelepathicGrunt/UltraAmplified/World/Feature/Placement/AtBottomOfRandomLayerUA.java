...
public class AtBottomOfRandomLayerUA extends Placement<CountRangeConfig> {
	public AtBottomOfRandomLayerUA(Function<Dynamic<?>, ? extends CountRangeConfig> configFactoryIn) {
