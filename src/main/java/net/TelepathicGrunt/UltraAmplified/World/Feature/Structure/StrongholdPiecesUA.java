...
public class StrongholdPiecesUA
{
    ...
    public static class Crossing extends StrongholdPiecesUA.Stronghold
    {
        ...
        public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_)
        {
            ...
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 5, 5, 7, 7, 5, 9, Blocks.STONE_SLAB.getDefaultState().with(SlabBlock.TYPE, SlabType.DOUBLE), Blocks.STONE_SLAB.getDefaultState().with(SlabBlock.TYPE, SlabType.DOUBLE), false);
        ...
        public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_)
        {
            ...
            for(int l = 1; l <= 13; ++l) {
             ...
             if (this.isLargeRoom) {
                ...
                this.setBlockState(worldIn, iblockstate1.with(FenceBlock.NORTH, Boolean.valueOf(true)), 6, 7, 6, structureBoundingBoxIn);
                this.setBlockState(worldIn, iblockstate1.with(FenceBlock.SOUTH, Boolean.valueOf(true)), 6, 7, 8, structureBoundingBoxIn);
                this.setBlockState(worldIn, iblockstate2.with(FenceBlock.NORTH, Boolean.valueOf(true)), 7, 7, 6, structureBoundingBoxIn);
                this.setBlockState(worldIn, iblockstate2.with(FenceBlock.SOUTH, Boolean.valueOf(true)), 7, 7, 8, structureBoundingBoxIn);
    ...
    public static class PortalRoom extends StrongholdPiecesUA.Stronghold
    {
        ...
        public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_)
        {
            ...
            this.setBlockState(worldIn, iblockstate4.with(EndPortalFrameBlock.EYE, Boolean.valueOf(aboolean[0])), 4, 3, 8, structureBoundingBoxIn);
            this.setBlockState(worldIn, iblockstate4.with(EndPortalFrameBlock.EYE, Boolean.valueOf(aboolean[1])), 5, 3, 8, structureBoundingBoxIn);
            this.setBlockState(worldIn, iblockstate4.with(EndPortalFrameBlock.EYE, Boolean.valueOf(aboolean[2])), 6, 3, 8, structureBoundingBoxIn);
            this.setBlockState(worldIn, iblockstate.with(EndPortalFrameBlock.EYE, Boolean.valueOf(aboolean[3])), 4, 3, 12, structureBoundingBoxIn);
            this.setBlockState(worldIn, iblockstate.with(EndPortalFrameBlock.EYE, Boolean.valueOf(aboolean[4])), 5, 3, 12, structureBoundingBoxIn);
            this.setBlockState(worldIn, iblockstate.with(EndPortalFrameBlock.EYE, Boolean.valueOf(aboolean[5])), 6, 3, 12, structureBoundingBoxIn);
            this.setBlockState(worldIn, iblockstate1.with(EndPortalFrameBlock.EYE, Boolean.valueOf(aboolean[6])), 3, 3, 9, structureBoundingBoxIn);
            this.setBlockState(worldIn, iblockstate1.with(EndPortalFrameBlock.EYE, Boolean.valueOf(aboolean[7])), 3, 3, 10, structureBoundingBoxIn);
            this.setBlockState(worldIn, iblockstate1.with(EndPortalFrameBlock.EYE, Boolean.valueOf(aboolean[8])), 3, 3, 11, structureBoundingBoxIn);
            this.setBlockState(worldIn, iblockstate2.with(EndPortalFrameBlock.EYE, Boolean.valueOf(aboolean[9])), 7, 3, 9, structureBoundingBoxIn);
            this.setBlockState(worldIn, iblockstate2.with(EndPortalFrameBlock.EYE, Boolean.valueOf(aboolean[10])), 7, 3, 10, structureBoundingBoxIn);
            this.setBlockState(worldIn, iblockstate2.with(EndPortalFrameBlock.EYE, Boolean.valueOf(aboolean[11])), 7, 3, 11, structureBoundingBoxIn);
            ...
            switch (this.roomType)
            {
                ...
                case 2: case 3:
                    ...
                    if(ConfigUA.chestGeneration) {
                        ...
                        this.generateChest(worldIn, structureBoundingBoxIn, randomIn, 5, 4, 2, LootTables.CHESTS_STRONGHOLD_CROSSING);
                        this.generateChest(worldIn, structureBoundingBoxIn, randomIn, 6, 4, 8, LootTables.CHESTS_STRONGHOLD_CROSSING);
                        this.generateChest(worldIn, structureBoundingBoxIn, randomIn, 8, 4, 4, LootTables.CHESTS_STRONGHOLD_CROSSING);
                    }
            }
        ...
        protected void placeDoor(IWorld worldIn, Random p_74990_2_, MutableBoundingBox p_74990_3_, StrongholdPiecesUA.Stronghold.Door p_74990_4_, int p_74990_5_, int p_74990_6_, int p_74990_7_)
        {
            switch (p_74990_4_)
            {
                ...
                case IRON_DOOR:
                    ...
                    this.setBlockState(worldIn, Blocks.STONE_BUTTON.getDefaultState().with(StoneButtonBlock.HORIZONTAL_FACING, Direction.NORTH), p_74990_5_ + 2, p_74990_6_ + 1, p_74990_7_ + 1, p_74990_3_);
                    this.setBlockState(worldIn, Blocks.STONE_BUTTON.getDefaultState().with(StoneButtonBlock.HORIZONTAL_FACING, Direction.SOUTH), p_74990_5_ + 2, p_74990_6_ + 1, p_74990_7_ - 1, p_74990_3_);
            }
        }
