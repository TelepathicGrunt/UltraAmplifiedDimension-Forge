...
public class FortressPiecesUA
{
    ...
    private static FortressPiecesUA.Piece findAndCreateBridgePieceFactory(FortressPiecesUA.PieceWeight p_175887_0_, List<StructurePiece> p_175887_1_, Random p_175887_2_, int p_175887_3_, int p_175887_4_, int p_175887_5_, Direction p_175887_6_, int p_175887_7_, boolean isStone)
    {
        ...
        {
            structurenetherbridgepieces$piece = FortressPiecesUA.Straight.createPiece(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_, isStone);
        }
        else if (oclass == FortressPiecesUA.Crossing3.class)
        {
            structurenetherbridgepieces$piece = FortressPiecesUA.Crossing3.createPiece(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_, isStone);
        }
        else if (oclass == FortressPiecesUA.Crossing.class)
        {
            structurenetherbridgepieces$piece = FortressPiecesUA.Crossing.createPiece(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_, isStone);
        }
        else if (oclass == FortressPiecesUA.Stairs.class)
        {
            structurenetherbridgepieces$piece = FortressPiecesUA.Stairs.createPiece(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_7_, p_175887_6_, isStone);
        }
        else if (oclass == FortressPiecesUA.Throne.class)
        {
            structurenetherbridgepieces$piece = FortressPiecesUA.Throne.createPiece(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_7_, p_175887_6_, isStone);
        }
        else if (oclass == FortressPiecesUA.Entrance.class)
        {
            structurenetherbridgepieces$piece = FortressPiecesUA.Entrance.createPiece(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_, isStone);
        }
        else if (oclass == FortressPiecesUA.Corridor5.class)
        {
            structurenetherbridgepieces$piece = FortressPiecesUA.Corridor5.createPiece(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_, isStone);
        }
        else if (oclass == FortressPiecesUA.Corridor2.class)
        {
            structurenetherbridgepieces$piece = FortressPiecesUA.Corridor2.createPiece(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_, isStone);
        }
        else if (oclass == FortressPiecesUA.Corridor.class)
        {
            structurenetherbridgepieces$piece = FortressPiecesUA.Corridor.createPiece(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_, isStone);
        }
        else if (oclass == FortressPiecesUA.Corridor3.class)
        {
            structurenetherbridgepieces$piece = FortressPiecesUA.Corridor3.createPiece(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_, isStone);
        }
        else if (oclass == FortressPiecesUA.Corridor4.class)
        {
            structurenetherbridgepieces$piece = FortressPiecesUA.Corridor4.createPiece(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_, isStone);
        }
        else if (oclass == FortressPiecesUA.Crossing2.class)
        {
            structurenetherbridgepieces$piece = FortressPiecesUA.Crossing2.createPiece(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_, isStone);
        }
        else if (oclass == FortressPiecesUA.NetherStalkRoom.class)
        {
            structurenetherbridgepieces$piece = FortressPiecesUA.NetherStalkRoom.createPiece(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_, isStone);
        }
    ...
    public static class Corridor extends FortressPiecesUA.Piece
    {
        ...
        public static FortressPiecesUA.Corridor createPiece(List<StructurePiece> p_175879_0_, Random p_175879_1_, int p_175879_2_, int p_175879_3_, int p_175879_4_, Direction p_175879_5_, int p_175879_6_, boolean isStone)
        {
            ...
            return isAboveGround(mutableBoundingBox) && StructurePiece.findIntersecting(p_175879_0_, mutableBoundingBox) == null ? new FortressPiecesUA.Corridor(p_175879_6_, p_175879_1_, mutableBoundingBox, p_175879_5_, isStone) : null;
        }
        ...
        public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) 
        {
            ...
            this.fillWithRandomBlocks(worldIn, structureBoundingBoxIn, 0, 2, 0, 4, 5, 4, Blocks.CAVE_AIR.getDefaultState(), Blocks.CAVE_AIR.getDefaultState(), false, randomIn);
    ...
    public static class Corridor2 extends FortressPiecesUA.Piece
    {
        ...
        public static FortressPiecesUA.Corridor2 createPiece(List<StructurePiece> p_175876_0_, Random p_175876_1_, int p_175876_2_, int p_175876_3_, int p_175876_4_, Direction p_175876_5_, int p_175876_6_, boolean isStone)
        {
            ...
            return isAboveGround(mutableBoundingBox) && StructurePiece.findIntersecting(p_175876_0_, mutableBoundingBox) == null ? new FortressPiecesUA.Corridor2(p_175876_6_, p_175876_1_, mutableBoundingBox, p_175876_5_, isStone) : null;
        }
    ...
    public static class Corridor3 extends FortressPiecesUA.Piece
    {
        ...
        public static FortressPiecesUA.Corridor3 createPiece(List<StructurePiece> p_175883_0_, Random p_175883_1_, int p_175883_2_, int p_175883_3_, int p_175883_4_, Direction p_175883_5_, int p_175883_6_, boolean isStone)
        {
            ...
            return isAboveGround(mutableBoundingBox) && StructurePiece.findIntersecting(p_175883_0_, mutableBoundingBox) == null ? new FortressPiecesUA.Corridor3(p_175883_6_, mutableBoundingBox, p_175883_5_, isStone) : null;
        }
        ...
        public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_)
        {
            ...
            for (int i = 0; i <= 9; ++i)
            {
                ...
                this.fillWithRandomBlocks(worldIn, structureBoundingBoxIn, 1, j + 1, i, 3, k - 1, i, Blocks.CAVE_AIR.getDefaultState(), Blocks.CAVE_AIR.getDefaultState(), false, randomIn);
    ...
    public static class Corridor4 extends FortressPiecesUA.Piece
    {
        ...
        public static FortressPiecesUA.Corridor4 createPiece(List<StructurePiece> p_175880_0_, Random p_175880_1_, int p_175880_2_, int p_175880_3_, int p_175880_4_, Direction p_175880_5_, int p_175880_6_, boolean isStone)
        {
            ...
            return isAboveGround(mutableBoundingBox) && StructurePiece.findIntersecting(p_175880_0_, mutableBoundingBox) == null ? new FortressPiecesUA.Corridor4(p_175880_6_, mutableBoundingBox, p_175880_5_, isStone) : null;
        }
        ...
        public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_)
        {
            ...
            this.fillWithRandomBlocks(worldIn, structureBoundingBoxIn, 0, 2, 0, 8, 5, 8, Blocks.CAVE_AIR.getDefaultState(), Blocks.CAVE_AIR.getDefaultState(), false, randomIn);
            ...
            this.fillWithRandomBlocks(worldIn, structureBoundingBoxIn, 1, 1, 4, 2, 2, 4, Blocks.CAVE_AIR.getDefaultState(), Blocks.CAVE_AIR.getDefaultState(), false, randomIn);
            this.fillWithRandomBlocks(worldIn, structureBoundingBoxIn, 6, 1, 4, 7, 2, 4, Blocks.CAVE_AIR.getDefaultState(), Blocks.CAVE_AIR.getDefaultState(), false, randomIn);
    ...
    public static class Corridor5 extends FortressPiecesUA.Piece
    {
        ...
        public static FortressPiecesUA.Corridor5 createPiece(List<StructurePiece> p_175877_0_, Random p_175877_1_, int p_175877_2_, int p_175877_3_, int p_175877_4_, Direction p_175877_5_, int p_175877_6_, boolean isStone)
        {
            ...
            return isAboveGround(mutableBoundingBox) && StructurePiece.findIntersecting(p_175877_0_, mutableBoundingBox) == null ? new FortressPiecesUA.Corridor5(p_175877_6_, mutableBoundingBox, p_175877_5_, isStone) : null;
        }
    ...
    public static class Crossing extends FortressPiecesUA.Piece
    {
        ...
        public static FortressPiecesUA.Crossing createPiece(List<StructurePiece> p_175873_0_, Random p_175873_1_, int p_175873_2_, int p_175873_3_, int p_175873_4_, Direction p_175873_5_, int p_175873_6_, boolean isStone)
        {
            ...
            return isAboveGround(mutableBoundingBox) && StructurePiece.findIntersecting(p_175873_0_, mutableBoundingBox) == null ? new FortressPiecesUA.Crossing(p_175873_6_, mutableBoundingBox, p_175873_5_, isStone) : null;
        }
        ...
        public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_)
        {
            ...
            this.fillWithRandomBlocks(worldIn, structureBoundingBoxIn, 0, 2, 0, 6, 7, 6, Blocks.CAVE_AIR.getDefaultState(), Blocks.CAVE_AIR.getDefaultState(), false, randomIn);
    ...
    public static class Crossing2 extends FortressPiecesUA.Piece
    {
        ...
        public static FortressPiecesUA.Crossing2 createPiece(List<StructurePiece> p_175878_0_, Random p_175878_1_, int p_175878_2_, int p_175878_3_, int p_175878_4_, Direction p_175878_5_, int p_175878_6_, boolean isStone)
        {
            ...
            return isAboveGround(mutableBoundingBox) && StructurePiece.findIntersecting(p_175878_0_, mutableBoundingBox) == null ? new FortressPiecesUA.Crossing2(p_175878_6_, mutableBoundingBox, p_175878_5_, isStone) : null;
        }
    ...
    public static class Crossing3 extends FortressPiecesUA.Piece
    {
        ...
        public static FortressPiecesUA.Crossing3 createPiece(List<StructurePiece> p_175885_0_, Random p_175885_1_, int p_175885_2_, int p_175885_3_, int p_175885_4_, Direction p_175885_5_, int p_175885_6_, boolean isStone)
        {
            ...
            return isAboveGround(mutableBoundingBox) && StructurePiece.findIntersecting(p_175885_0_, mutableBoundingBox) == null ? new FortressPiecesUA.Crossing3(p_175885_6_, mutableBoundingBox, p_175885_5_, isStone) : null;
        }
        ...
        public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPos)
        {
            ...
            this.fillWithRandomBlocks(worldIn, structureBoundingBoxIn, 8, 5, 0, 10, 7, 18, Blocks.CAVE_AIR.getDefaultState(), Blocks.CAVE_AIR.getDefaultState(), false, randomIn);
            this.fillWithRandomBlocks(worldIn, structureBoundingBoxIn, 0, 5, 8, 18, 7, 10, Blocks.CAVE_AIR.getDefaultState(), Blocks.CAVE_AIR.getDefaultState(), false, randomIn);
    ...
    public static class End extends FortressPiecesUA.Piece
    {
        ...
        public static FortressPiecesUA.End createPiece(List<StructurePiece> p_175884_0_, Random p_175884_1_, int p_175884_2_, int p_175884_3_, int p_175884_4_, Direction p_175884_5_, int p_175884_6_, boolean isStone)
        {
            ...
            return isAboveGround(mutableBoundingBox) && StructurePiece.findIntersecting(p_175884_0_, mutableBoundingBox) == null ? new FortressPiecesUA.End(p_175884_6_, p_175884_1_, mutableBoundingBox, p_175884_5_, isStone) : null;
        }
    ...
    public static class Entrance extends FortressPiecesUA.Piece
    {
        ...
        public static FortressPiecesUA.Entrance createPiece(List<StructurePiece> p_175881_0_, Random p_175881_1_, int p_175881_2_, int p_175881_3_, int p_175881_4_, Direction p_175881_5_, int p_175881_6_, boolean isStone)
        {
            ...
            return isAboveGround(mutableBoundingBox) && StructurePiece.findIntersecting(p_175881_0_, mutableBoundingBox) == null ? new FortressPiecesUA.Entrance(p_175881_6_, p_175881_1_, mutableBoundingBox, p_175881_5_, isStone) : null;
        }
        ...
        public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPos)
        {
            ...
            this.fillWithRandomBlocks(worldIn, structureBoundingBoxIn, 0, 5, 0, 12, 13, 12, Blocks.CAVE_AIR.getDefaultState(), Blocks.CAVE_AIR.getDefaultState(), false, randomIn);
            ...
            this.fillWithRandomBlocks(worldIn, structureBoundingBoxIn, 6, 1, 6, 6, 4, 6, Blocks.CAVE_AIR.getDefaultState(), Blocks.CAVE_AIR.getDefaultState(), false, randomIn);
    ...
    public static class NetherStalkRoom extends FortressPiecesUA.Piece
    {
        ...
        public static FortressPiecesUA.NetherStalkRoom createPiece(List<StructurePiece> p_175875_0_, Random p_175875_1_, int p_175875_2_, int p_175875_3_, int p_175875_4_, Direction p_175875_5_, int p_175875_6_, boolean isStone)
        {
            ...
            return isAboveGround(mutableBoundingBox) && StructurePiece.findIntersecting(p_175875_0_, mutableBoundingBox) == null ? new FortressPiecesUA.NetherStalkRoom(p_175875_6_, mutableBoundingBox, p_175875_5_, isStone) : null;
        }
        ...
        public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPos)
        {
            ...
            for (int j = 0; j <= 6; ++j)
            {
                ...
                if (j >= 1)
                {
                    this.fillWithRandomBlocks(worldIn, structureBoundingBoxIn, 5, 6 + j, k, 7, 9 + j, k, Blocks.CAVE_AIR.getDefaultState(), Blocks.CAVE_AIR.getDefaultState(), false, randomIn);
                }
            }
            ...
            this.fillWithRandomBlocks(worldIn, structureBoundingBoxIn, 5, 13, 12, 7, 13, 12, Blocks.CAVE_AIR.getDefaultState(), Blocks.CAVE_AIR.getDefaultState(), false, randomIn);
    ...
    { 
        ...
        private FortressPiecesUA.Piece generatePiece(FortressPiecesUA.Start startPiece, List<FortressPiecesUA.PieceWeight> p_175871_2_, List<StructurePiece> p_175871_3_, Random p_175871_4_, int p_175871_5_, int p_175871_6_, int p_175871_7_, Direction p_175871_8_, int p_175871_9_)
        {
            ...
            while (j < 5 && flag)
            {
                ...
                for (FortressPiecesUA.PieceWeight structurenetherbridgepieces$pieceweight : p_175871_2_)
                {
                    ...
                    if (k < 0)
                    {
                        ...
                        FortressPiecesUA.Piece structurenetherbridgepieces$piece = FortressPiecesUA.findAndCreateBridgePieceFactory(structurenetherbridgepieces$pieceweight, p_175871_3_, p_175871_4_, p_175871_5_, p_175871_6_, p_175871_7_, p_175871_8_, p_175871_9_, startPiece.stoneVariant);
            ...
            return FortressPiecesUA.End.createPiece(p_175871_3_, p_175871_4_, p_175871_5_, p_175871_6_, p_175871_7_, p_175871_8_, p_175871_9_, startPiece.stoneVariant);
        }

        private StructurePiece generateAndAddPiece(FortressPiecesUA.Start startPiece, List<StructurePiece> p_175870_2_, Random p_175870_3_, int p_175870_4_, int p_175870_5_, int p_175870_6_, @Nullable Direction p_175870_7_, int p_175870_8_, boolean p_175870_9_)
        {
            ...
            {
                return FortressPiecesUA.End.createPiece(p_175870_2_, p_175870_3_, p_175870_4_, p_175870_5_, p_175870_6_, p_175870_7_, p_175870_8_, startPiece.stoneVariant);
            }
        }

        @Nullable
        protected StructurePiece getNextComponentNormal(FortressPiecesUA.Start p_74963_1_, List<StructurePiece> p_74963_2_, Random p_74963_3_, int p_74963_4_, int p_74963_5_, boolean p_74963_6_)
        {
            Direction enumfacing = this.getCoordBaseMode();
        ...
        @Nullable
        protected StructurePiece getNextComponentX(FortressPiecesUA.Start p_74961_1_, List<StructurePiece> p_74961_2_, Random p_74961_3_, int p_74961_4_, int p_74961_5_, boolean p_74961_6_)
        {
            Direction enumfacing = this.getCoordBaseMode();
        ...
        @Nullable
        protected StructurePiece getNextComponentZ(FortressPiecesUA.Start p_74965_1_, List<StructurePiece> p_74965_2_, Random p_74965_3_, int p_74965_4_, int p_74965_5_, boolean p_74965_6_)
        {
            Direction enumfacing = this.getCoordBaseMode();
    ...
    static class PieceWeight
    {
        ...
        public PieceWeight(Class <? extends FortressPiecesUA.Piece > weightClass, int weight, int maximumCount, boolean allowMultipleInRow)
        {
    ...
    public static class Stairs extends FortressPiecesUA.Piece
    {
        ...
        public static FortressPiecesUA.Stairs createPiece(List<StructurePiece> p_175872_0_, Random p_175872_1_, int p_175872_2_, int p_175872_3_, int p_175872_4_, int p_175872_5_, Direction p_175872_6_, boolean isStone)
        {
            ...
            return isAboveGround(mutableBoundingBox) && StructurePiece.findIntersecting(p_175872_0_, mutableBoundingBox) == null ? new FortressPiecesUA.Stairs(p_175872_5_, mutableBoundingBox, p_175872_6_, isStone) : null;
        }

        public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPos)
        {
            this.fillWithRandomBlocks(worldIn, structureBoundingBoxIn, 0, 0, 0, 6, 1, 6, Blocks.NETHER_BRICKS.getDefaultState(), Blocks.NETHER_BRICKS.getDefaultState(), false, randomIn);
            this.fillWithRandomBlocks(worldIn, structureBoundingBoxIn, 0, 2, 0, 6, 10, 6, Blocks.CAVE_AIR.getDefaultState(), Blocks.CAVE_AIR.getDefaultState(), false, randomIn);
            ...
            this.fillWithRandomBlocks(worldIn, structureBoundingBoxIn, 6, 8, 2, 6, 8, 4, Blocks.CAVE_AIR.getDefaultState(), Blocks.CAVE_AIR.getDefaultState(), false, randomIn);
    ...
    public static class Straight extends FortressPiecesUA.Piece
    {
        ...
        public static FortressPiecesUA.Straight createPiece(List<StructurePiece> p_175882_0_, Random p_175882_1_, int p_175882_2_, int p_175882_3_, int p_175882_4_, Direction p_175882_5_, int p_175882_6_, boolean isStone)
        {
            ...
            return isAboveGround(mutableBoundingBox) && StructurePiece.findIntersecting(p_175882_0_, mutableBoundingBox) == null ? new FortressPiecesUA.Straight(p_175882_6_, p_175882_1_, mutableBoundingBox, p_175882_5_, isStone) : null;
        }
        ...
        public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPos)
        {
            ...
            this.fillWithRandomBlocks(worldIn, structureBoundingBoxIn, 1, 5, 0, 3, 7, 18, Blocks.CAVE_AIR.getDefaultState(), Blocks.CAVE_AIR.getDefaultState(), false, randomIn);
    ...
    public static class Throne extends FortressPiecesUA.Piece
    {
        ...
        public static FortressPiecesUA.Throne createPiece(List<StructurePiece> p_175874_0_, Random p_175874_1_, int p_175874_2_, int p_175874_3_, int p_175874_4_, int p_175874_5_, Direction p_175874_6_, boolean isStone)
        {
            ...
            return isAboveGround(mutableBoundingBox) && StructurePiece.findIntersecting(p_175874_0_, mutableBoundingBox) == null ? new FortressPiecesUA.Throne(p_175874_5_, p_175874_1_, mutableBoundingBox, p_175874_6_, isStone) : null;
        }

        public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPos)
        {
            this.fillWithRandomBlocks(worldIn, structureBoundingBoxIn, 0, 2, 0, 6, 7, 7, Blocks.CAVE_AIR.getDefaultState(), Blocks.CAVE_AIR.getDefaultState(), false, randomIn);
