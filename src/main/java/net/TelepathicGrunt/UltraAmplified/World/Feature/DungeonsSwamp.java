...
public class DungeonsSwamp extends Feature<NoFeatureConfig> 
{
    public DungeonsSwamp(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn) {
                ...
                for (int i4 = 3; i4 >= -1; --i4)
                {
                    for (int k4 = l1; k4 <= i2; ++k4)
                    {
                        ...
                        else if (worldIn.getBlockState(blockpos1).getMaterial().isSolid() && worldIn.getBlockState(blockpos1).getBlock() != Blocks.CHEST && worldIn.getBlockState(blockpos1).getBlock() != Blocks.SPAWNER)
                        {
                            ...
                            {
                                worldIn.setBlockState(blockpos1, Blocks.MOSSY_STONE_BRICKS.getDefaultState(), 2);
                            }
                            else
                            {
