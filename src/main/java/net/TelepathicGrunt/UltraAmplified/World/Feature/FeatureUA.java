...
import net.TelepathicGrunt.UltraAmplified.World.Feature.StructureUA.DesertTempleUA;
import net.TelepathicGrunt.UltraAmplified.World.Feature.StructureUA.EndCityUA;
import net.TelepathicGrunt.UltraAmplified.World.Feature.StructureUA.FortressConfigUA;
import net.TelepathicGrunt.UltraAmplified.World.Feature.StructureUA.FortressUA;
import net.TelepathicGrunt.UltraAmplified.World.Feature.StructureUA.IglooUA;
import net.TelepathicGrunt.UltraAmplified.World.Feature.StructureUA.JungleTempleUA;
...
import net.TelepathicGrunt.UltraAmplified.World.Feature.StructureUA.OceanMonumentUA;
import net.TelepathicGrunt.UltraAmplified.World.Feature.StructureUA.OceanRuinsUA;
import net.TelepathicGrunt.UltraAmplified.World.Feature.StructureUA.PillagerOutpostUA;
import net.TelepathicGrunt.UltraAmplified.World.Feature.StructureUA.ShipwreckUA;
import net.TelepathicGrunt.UltraAmplified.World.Feature.StructureUA.StrongholdUA;
import net.TelepathicGrunt.UltraAmplified.World.Feature.StructureUA.StructureInit;
import net.TelepathicGrunt.UltraAmplified.World.Feature.StructureUA.VillageUA;
import net.TelepathicGrunt.UltraAmplified.World.Feature.StructureUA.VillageUAConfig;
import net.TelepathicGrunt.UltraAmplified.World.Feature.StructureUA.WitchHutUA;
import net.TelepathicGrunt.UltraAmplified.World.Feature.StructureUA.WoodlandMansionUA;
