...
import net.TelepathicGrunt.UltraAmplified.World.Feature.Structure.NetherBridgeUA;
...
public class FeatureUA
{
	...
	public static void onRegisterFeature(RegistryEvent.Register<Feature<?>> event)
	{
		...
		UltraAmplified.Logger.debug("FEATURE REGISTER");
		   ...
		   DESERT_TEMPLE_UA = (Structure<NoFeatureConfig>) registerStructure(DESERT_TEMPLE_UA, "desert_pyramid_ua");
		   ...
		   WITCH_HUT_UA = (WitchHutUA) registerStructure(WITCH_HUT_UA, "swamp_hut_ua");
