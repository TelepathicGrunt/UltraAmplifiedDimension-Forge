...
{
    private static final StructureNetherBridgePiecesUA.PieceWeight[] PRIMARY_COMPONENTS = new StructureNetherBridgePiecesUA.PieceWeight[] {new StructureNetherBridgePiecesUA.PieceWeight(StructureNetherBridgePiecesUA.Straight.class, 30, 0, true), new StructureNetherBridgePiecesUA.PieceWeight(StructureNetherBridgePiecesUA.Crossing3.class, 10, 4), new StructureNetherBridgePiecesUA.PieceWeight(StructureNetherBridgePiecesUA.Crossing.class, 10, 4), new StructureNetherBridgePiecesUA.PieceWeight(StructureNetherBridgePiecesUA.Stairs.class, 10, 3), new StructureNetherBridgePiecesUA.PieceWeight(StructureNetherBridgePiecesUA.Throne.class, 5, 2), new StructureNetherBridgePiecesUA.PieceWeight(StructureNetherBridgePiecesUA.Entrance.class, 5, 1)};
    private static final StructureNetherBridgePiecesUA.PieceWeight[] SECONDARY_COMPONENTS = new StructureNetherBridgePiecesUA.PieceWeight[] {new StructureNetherBridgePiecesUA.PieceWeight(StructureNetherBridgePiecesUA.Corridor5.class, 25, 0, true), new StructureNetherBridgePiecesUA.PieceWeight(StructureNetherBridgePiecesUA.Crossing2.class, 15, 5), new StructureNetherBridgePiecesUA.PieceWeight(StructureNetherBridgePiecesUA.Corridor2.class, 5, 10), new StructureNetherBridgePiecesUA.PieceWeight(StructureNetherBridgePiecesUA.Corridor.class, 5, 10), new StructureNetherBridgePiecesUA.PieceWeight(StructureNetherBridgePiecesUA.Corridor3.class, 10, 3, true), new StructureNetherBridgePiecesUA.PieceWeight(StructureNetherBridgePiecesUA.Corridor4.class, 7, 2), new StructureNetherBridgePiecesUA.PieceWeight(StructureNetherBridgePiecesUA.NetherStalkRoom.class, 5, 2)};

    public static void registerNetherFortressPieces()
    {
        MapGenStructureIO.registerStructureComponent(StructureNetherBridgePiecesUA.Crossing3.class, "NeBCr");
        MapGenStructureIO.registerStructureComponent(StructureNetherBridgePiecesUA.End.class, "NeBEF");
        MapGenStructureIO.registerStructureComponent(StructureNetherBridgePiecesUA.Straight.class, "NeBS");
        MapGenStructureIO.registerStructureComponent(StructureNetherBridgePiecesUA.Corridor3.class, "NeCCS");
        MapGenStructureIO.registerStructureComponent(StructureNetherBridgePiecesUA.Corridor4.class, "NeCTB");
        MapGenStructureIO.registerStructureComponent(StructureNetherBridgePiecesUA.Entrance.class, "NeCE");
        MapGenStructureIO.registerStructureComponent(StructureNetherBridgePiecesUA.Crossing2.class, "NeSCSC");
        MapGenStructureIO.registerStructureComponent(StructureNetherBridgePiecesUA.Corridor.class, "NeSCLT");
        MapGenStructureIO.registerStructureComponent(StructureNetherBridgePiecesUA.Corridor5.class, "NeSC");
        MapGenStructureIO.registerStructureComponent(StructureNetherBridgePiecesUA.Corridor2.class, "NeSCRT");
        MapGenStructureIO.registerStructureComponent(StructureNetherBridgePiecesUA.NetherStalkRoom.class, "NeCSR");
        MapGenStructureIO.registerStructureComponent(StructureNetherBridgePiecesUA.Throne.class, "NeMT");
        MapGenStructureIO.registerStructureComponent(StructureNetherBridgePiecesUA.Crossing.class, "NeRC");
        MapGenStructureIO.registerStructureComponent(StructureNetherBridgePiecesUA.Stairs.class, "NeSR");
        MapGenStructureIO.registerStructureComponent(StructureNetherBridgePiecesUA.Start.class, "NeStart");
    }

    private static StructureNetherBridgePiecesUA.Piece findAndCreateBridgePieceFactory(StructureNetherBridgePiecesUA.PieceWeight p_175887_0_, List<StructureComponent> p_175887_1_, Random p_175887_2_, int p_175887_3_, int p_175887_4_, int p_175887_5_, EnumFacing p_175887_6_, int p_175887_7_)
    {
        Class <? extends StructureNetherBridgePiecesUA.Piece > oclass = p_175887_0_.weightClass;
        StructureNetherBridgePiecesUA.Piece structurenetherbridgepieces$piece = null;

        if (oclass == StructureNetherBridgePiecesUA.Straight.class)
        {
            structurenetherbridgepieces$piece = StructureNetherBridgePiecesUA.Straight.createPiece(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
        }
        else if (oclass == StructureNetherBridgePiecesUA.Crossing3.class)
        {
            structurenetherbridgepieces$piece = StructureNetherBridgePiecesUA.Crossing3.createPiece(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
        }
        else if (oclass == StructureNetherBridgePiecesUA.Crossing.class)
        {
            structurenetherbridgepieces$piece = StructureNetherBridgePiecesUA.Crossing.createPiece(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
        }
        else if (oclass == StructureNetherBridgePiecesUA.Stairs.class)
        {
            structurenetherbridgepieces$piece = StructureNetherBridgePiecesUA.Stairs.createPiece(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_7_, p_175887_6_);
        }
        else if (oclass == StructureNetherBridgePiecesUA.Throne.class)
        {
            structurenetherbridgepieces$piece = StructureNetherBridgePiecesUA.Throne.createPiece(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_7_, p_175887_6_);
        }
        else if (oclass == StructureNetherBridgePiecesUA.Entrance.class)
        {
            structurenetherbridgepieces$piece = StructureNetherBridgePiecesUA.Entrance.createPiece(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
        }
        else if (oclass == StructureNetherBridgePiecesUA.Corridor5.class)
        {
            structurenetherbridgepieces$piece = StructureNetherBridgePiecesUA.Corridor5.createPiece(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
        }
        else if (oclass == StructureNetherBridgePiecesUA.Corridor2.class)
        {
            structurenetherbridgepieces$piece = StructureNetherBridgePiecesUA.Corridor2.createPiece(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
        }
        else if (oclass == StructureNetherBridgePiecesUA.Corridor.class)
        {
            structurenetherbridgepieces$piece = StructureNetherBridgePiecesUA.Corridor.createPiece(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
        }
        else if (oclass == StructureNetherBridgePiecesUA.Corridor3.class)
        {
            structurenetherbridgepieces$piece = StructureNetherBridgePiecesUA.Corridor3.createPiece(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
        }
        else if (oclass == StructureNetherBridgePiecesUA.Corridor4.class)
        {
            structurenetherbridgepieces$piece = StructureNetherBridgePiecesUA.Corridor4.createPiece(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
        }
        else if (oclass == StructureNetherBridgePiecesUA.Crossing2.class)
        {
            structurenetherbridgepieces$piece = StructureNetherBridgePiecesUA.Crossing2.createPiece(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
        }
        else if (oclass == StructureNetherBridgePiecesUA.NetherStalkRoom.class)
        {
            structurenetherbridgepieces$piece = StructureNetherBridgePiecesUA.NetherStalkRoom.createPiece(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
        }

        return structurenetherbridgepieces$piece;
    }

    public static class Corridor extends StructureNetherBridgePiecesUA.Piece
    {
        ...
        {
            this.getNextComponentX((StructureNetherBridgePiecesUA.Start)componentIn, listIn, rand, 0, 1, true);
        }

        public static StructureNetherBridgePiecesUA.Corridor createPiece(List<StructureComponent> p_175879_0_, Random p_175879_1_, int p_175879_2_, int p_175879_3_, int p_175879_4_, EnumFacing p_175879_5_, int p_175879_6_)
        {
            ...
            return isAboveGround(structureboundingbox) && StructureComponent.findIntersecting(p_175879_0_, structureboundingbox) == null ? new StructureNetherBridgePiecesUA.Corridor(p_175879_6_, p_175879_1_, structureboundingbox, p_175879_5_) : null;
        }
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            if (UAConfig.StructuresOptions.ConfigUA.chestGeneration && randomIn.nextBoolean() && this.chest && structureBoundingBoxIn.isVecInside(new BlockPos(this.getXWithOffset(3, 3), this.getYWithOffset(2), this.getZWithOffset(3, 3))))
            {
                this.chest = false;
    ...
    public static class Corridor2 extends StructureNetherBridgePiecesUA.Piece
    {
        private boolean chest;
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
        {
            this.getNextComponentZ((StructureNetherBridgePiecesUA.Start)componentIn, listIn, rand, 0, 1, true);
        }

        public static StructureNetherBridgePiecesUA.Corridor2 createPiece(List<StructureComponent> p_175876_0_, Random p_175876_1_, int p_175876_2_, int p_175876_3_, int p_175876_4_, EnumFacing p_175876_5_, int p_175876_6_)
        {
            ...
            return isAboveGround(structureboundingbox) && StructureComponent.findIntersecting(p_175876_0_, structureboundingbox) == null ? new StructureNetherBridgePiecesUA.Corridor2(p_175876_6_, p_175876_1_, structureboundingbox, p_175876_5_) : null;
        }
    ...
    public static class Corridor3 extends StructureNetherBridgePiecesUA.Piece
    {
        public Corridor3()
        {
        }
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
        {
            this.getNextComponentNormal((StructureNetherBridgePiecesUA.Start)componentIn, listIn, rand, 1, 0, true);
        }

        public static StructureNetherBridgePiecesUA.Corridor3 createPiece(List<StructureComponent> p_175883_0_, Random p_175883_1_, int p_175883_2_, int p_175883_3_, int p_175883_4_, EnumFacing p_175883_5_, int p_175883_6_)
        {
            ...
            return isAboveGround(structureboundingbox) && StructureComponent.findIntersecting(p_175883_0_, structureboundingbox) == null ? new StructureNetherBridgePiecesUA.Corridor3(p_175883_6_, p_175883_1_, structureboundingbox, p_175883_5_) : null;
        }
    ...
    public static class Corridor4 extends StructureNetherBridgePiecesUA.Piece
    {
        public Corridor4()
        {
        }
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
        {
            ...
            this.getNextComponentX((StructureNetherBridgePiecesUA.Start)componentIn, listIn, rand, 0, i, rand.nextInt(8) > 0);
            this.getNextComponentZ((StructureNetherBridgePiecesUA.Start)componentIn, listIn, rand, 0, i, rand.nextInt(8) > 0);
        }

        public static StructureNetherBridgePiecesUA.Corridor4 createPiece(List<StructureComponent> p_175880_0_, Random p_175880_1_, int p_175880_2_, int p_175880_3_, int p_175880_4_, EnumFacing p_175880_5_, int p_175880_6_)
        {
            ...
            return isAboveGround(structureboundingbox) && StructureComponent.findIntersecting(p_175880_0_, structureboundingbox) == null ? new StructureNetherBridgePiecesUA.Corridor4(p_175880_6_, p_175880_1_, structureboundingbox, p_175880_5_) : null;
        }
    ...
    public static class Corridor5 extends StructureNetherBridgePiecesUA.Piece
    {
        public Corridor5()
        {
        }
        ...
        public static StructureNetherBridgePiecesUA.Corridor5 createPiece(List<StructureComponent> p_175877_0_, Random p_175877_1_, int p_175877_2_, int p_175877_3_, int p_175877_4_, EnumFacing p_175877_5_, int p_175877_6_)
        {
            ...
            return isAboveGround(structureboundingbox) && StructureComponent.findIntersecting(p_175877_0_, structureboundingbox) == null ? new StructureNetherBridgePiecesUA.Corridor5(p_175877_6_, p_175877_1_, structureboundingbox, p_175877_5_) : null;
        }
    ...
    public static class Crossing extends StructureNetherBridgePiecesUA.Piece
    {
        public Crossing()
        {
        }
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
        {
            this.getNextComponentNormal((StructureNetherBridgePiecesUA.Start)componentIn, listIn, rand, 2, 0, false);
            this.getNextComponentX((StructureNetherBridgePiecesUA.Start)componentIn, listIn, rand, 0, 2, false);
            this.getNextComponentZ((StructureNetherBridgePiecesUA.Start)componentIn, listIn, rand, 0, 2, false);
        }

        public static StructureNetherBridgePiecesUA.Crossing createPiece(List<StructureComponent> p_175873_0_, Random p_175873_1_, int p_175873_2_, int p_175873_3_, int p_175873_4_, EnumFacing p_175873_5_, int p_175873_6_)
        {
            ...
            return isAboveGround(structureboundingbox) && StructureComponent.findIntersecting(p_175873_0_, structureboundingbox) == null ? new StructureNetherBridgePiecesUA.Crossing(p_175873_6_, p_175873_1_, structureboundingbox, p_175873_5_) : null;
        }
    ...
    public static class Crossing2 extends StructureNetherBridgePiecesUA.Piece
    {
        public Crossing2()
        {
        }
        ...
        public static StructureNetherBridgePiecesUA.Crossing2 createPiece(List<StructureComponent> p_175878_0_, Random p_175878_1_, int p_175878_2_, int p_175878_3_, int p_175878_4_, EnumFacing p_175878_5_, int p_175878_6_)
        {
            ...
            return isAboveGround(structureboundingbox) && StructureComponent.findIntersecting(p_175878_0_, structureboundingbox) == null ? new StructureNetherBridgePiecesUA.Crossing2(p_175878_6_, p_175878_1_, structureboundingbox, p_175878_5_) : null;
        }
    ...
    public static class Crossing3 extends StructureNetherBridgePiecesUA.Piece
    {
        public Crossing3()
        {
        }
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
        {
            this.getNextComponentNormal((StructureNetherBridgePiecesUA.Start)componentIn, listIn, rand, 8, 3, false);
            this.getNextComponentX((StructureNetherBridgePiecesUA.Start)componentIn, listIn, rand, 3, 8, false);
            this.getNextComponentZ((StructureNetherBridgePiecesUA.Start)componentIn, listIn, rand, 3, 8, false);
        }

        public static StructureNetherBridgePiecesUA.Crossing3 createPiece(List<StructureComponent> p_175885_0_, Random p_175885_1_, int p_175885_2_, int p_175885_3_, int p_175885_4_, EnumFacing p_175885_5_, int p_175885_6_)
        {
            ...
            return isAboveGround(structureboundingbox) && StructureComponent.findIntersecting(p_175885_0_, structureboundingbox) == null ? new StructureNetherBridgePiecesUA.Crossing3(p_175885_6_, p_175885_1_, structureboundingbox, p_175885_5_) : null;
        }
    ...
    public static class End extends StructureNetherBridgePiecesUA.Piece
    {
        ...
        public static StructureNetherBridgePiecesUA.End createPiece(List<StructureComponent> p_175884_0_, Random p_175884_1_, int p_175884_2_, int p_175884_3_, int p_175884_4_, EnumFacing p_175884_5_, int p_175884_6_)
        {
            ...
            return isAboveGround(structureboundingbox) && StructureComponent.findIntersecting(p_175884_0_, structureboundingbox) == null ? new StructureNetherBridgePiecesUA.End(p_175884_6_, p_175884_1_, structureboundingbox, p_175884_5_) : null;
        }
    ...
    public static class Entrance extends StructureNetherBridgePiecesUA.Piece
    {
        public Entrance()
        {
        }
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
        {
            this.getNextComponentNormal((StructureNetherBridgePiecesUA.Start)componentIn, listIn, rand, 5, 3, true);
        }

        public static StructureNetherBridgePiecesUA.Entrance createPiece(List<StructureComponent> p_175881_0_, Random p_175881_1_, int p_175881_2_, int p_175881_3_, int p_175881_4_, EnumFacing p_175881_5_, int p_175881_6_)
        {
            ...
            return isAboveGround(structureboundingbox) && StructureComponent.findIntersecting(p_175881_0_, structureboundingbox) == null ? new StructureNetherBridgePiecesUA.Entrance(p_175881_6_, p_175881_1_, structureboundingbox, p_175881_5_) : null;
        }
    ...
    public static class NetherStalkRoom extends StructureNetherBridgePiecesUA.Piece
    {
        ...
        {
            this.getNextComponentNormal((StructureNetherBridgePiecesUA.Start)componentIn, listIn, rand, 5, 3, true);
            this.getNextComponentNormal((StructureNetherBridgePiecesUA.Start)componentIn, listIn, rand, 5, 11, true);
        }

        public static StructureNetherBridgePiecesUA.NetherStalkRoom createPiece(List<StructureComponent> p_175875_0_, Random p_175875_1_, int p_175875_2_, int p_175875_3_, int p_175875_4_, EnumFacing p_175875_5_, int p_175875_6_)
        {
            ...
            return isAboveGround(structureboundingbox) && StructureComponent.findIntersecting(p_175875_0_, structureboundingbox) == null ? new StructureNetherBridgePiecesUA.NetherStalkRoom(p_175875_6_, p_175875_1_, structureboundingbox, p_175875_5_) : null;
        }
    ...
    abstract static class Piece extends StructureComponent
    {
        ...
        private int getTotalWeight(List<StructureNetherBridgePiecesUA.PieceWeight> p_74960_1_)
        {
            boolean flag = false;
            int i = 0;

            for (StructureNetherBridgePiecesUA.PieceWeight structurenetherbridgepieces$pieceweight : p_74960_1_)
            {
        ...
        private StructureNetherBridgePiecesUA.Piece generatePiece(StructureNetherBridgePiecesUA.Start p_175871_1_, List<StructureNetherBridgePiecesUA.PieceWeight> p_175871_2_, List<StructureComponent> p_175871_3_, Random p_175871_4_, int p_175871_5_, int p_175871_6_, int p_175871_7_, EnumFacing p_175871_8_, int p_175871_9_)
        {
            ...
            while (j < 5 && flag)
            {
                ...
                for (StructureNetherBridgePiecesUA.PieceWeight structurenetherbridgepieces$pieceweight : p_175871_2_)
                {
                    ...
                    if (k < 0)
                    {
                        ...
                        StructureNetherBridgePiecesUA.Piece structurenetherbridgepieces$piece = StructureNetherBridgePiecesUA.findAndCreateBridgePieceFactory(structurenetherbridgepieces$pieceweight, p_175871_3_, p_175871_4_, p_175871_5_, p_175871_6_, p_175871_7_, p_175871_8_, p_175871_9_);
            ...
            return StructureNetherBridgePiecesUA.End.createPiece(p_175871_3_, p_175871_4_, p_175871_5_, p_175871_6_, p_175871_7_, p_175871_8_, p_175871_9_);
        }

        private StructureComponent generateAndAddPiece(StructureNetherBridgePiecesUA.Start p_175870_1_, List<StructureComponent> p_175870_2_, Random p_175870_3_, int p_175870_4_, int p_175870_5_, int p_175870_6_, @Nullable EnumFacing p_175870_7_, int p_175870_8_, boolean p_175870_9_)
        {
            if (Math.abs(p_175870_4_ - p_175870_1_.getBoundingBox().minX) <= 112 && Math.abs(p_175870_6_ - p_175870_1_.getBoundingBox().minZ) <= 112)
            {
                List<StructureNetherBridgePiecesUA.PieceWeight> list = p_175870_1_.primaryWeights;
            ...
            {
                return StructureNetherBridgePiecesUA.End.createPiece(p_175870_2_, p_175870_3_, p_175870_4_, p_175870_5_, p_175870_6_, p_175870_7_, p_175870_8_);
            }
        }

        @Nullable
        protected StructureComponent getNextComponentNormal(StructureNetherBridgePiecesUA.Start p_74963_1_, List<StructureComponent> p_74963_2_, Random p_74963_3_, int p_74963_4_, int p_74963_5_, boolean p_74963_6_)
        {
            EnumFacing enumfacing = this.getCoordBaseMode();
        ...
        @Nullable
        protected StructureComponent getNextComponentX(StructureNetherBridgePiecesUA.Start p_74961_1_, List<StructureComponent> p_74961_2_, Random p_74961_3_, int p_74961_4_, int p_74961_5_, boolean p_74961_6_)
        {
            EnumFacing enumfacing = this.getCoordBaseMode();
        ...
        @Nullable
        protected StructureComponent getNextComponentZ(StructureNetherBridgePiecesUA.Start p_74965_1_, List<StructureComponent> p_74965_2_, Random p_74965_3_, int p_74965_4_, int p_74965_5_, boolean p_74965_6_)
        {
            EnumFacing enumfacing = this.getCoordBaseMode();
    ...
    {
        public Class <? extends StructureNetherBridgePiecesUA.Piece > weightClass;
        public final int weight;
        public int placeCount;
        public int maxPlaceCount;
        public boolean allowInRow;

        public PieceWeight(Class <? extends StructureNetherBridgePiecesUA.Piece > weightClass, int weight, int maximumCount, boolean allowMultipleInRow)
        {
        ...
        public PieceWeight(Class <? extends StructureNetherBridgePiecesUA.Piece > weightClass, int weight, int maximumCount)
        {
    ...
    public static class Stairs extends StructureNetherBridgePiecesUA.Piece
    {
        public Stairs()
        {
        }
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
        {
            this.getNextComponentZ((StructureNetherBridgePiecesUA.Start)componentIn, listIn, rand, 6, 2, false);
        }

        public static StructureNetherBridgePiecesUA.Stairs createPiece(List<StructureComponent> p_175872_0_, Random p_175872_1_, int p_175872_2_, int p_175872_3_, int p_175872_4_, int p_175872_5_, EnumFacing p_175872_6_)
        {
            ...
            return isAboveGround(structureboundingbox) && StructureComponent.findIntersecting(p_175872_0_, structureboundingbox) == null ? new StructureNetherBridgePiecesUA.Stairs(p_175872_5_, p_175872_1_, structureboundingbox, p_175872_6_) : null;
        }
    ...
    public static class Start extends StructureNetherBridgePiecesUA.Crossing3
    {
        public StructureNetherBridgePiecesUA.PieceWeight theNetherBridgePieceWeight;
        public List<StructureNetherBridgePiecesUA.PieceWeight> primaryWeights;
        public List<StructureNetherBridgePiecesUA.PieceWeight> secondaryWeights;
        ...
        public Start(Random p_i2059_1_, int p_i2059_2_, int p_i2059_3_)
        {
            ...
            this.primaryWeights = Lists.<StructureNetherBridgePiecesUA.PieceWeight>newArrayList();

            for (StructureNetherBridgePiecesUA.PieceWeight structurenetherbridgepieces$pieceweight : StructureNetherBridgePiecesUA.PRIMARY_COMPONENTS)
            {
                structurenetherbridgepieces$pieceweight.placeCount = 0;
                this.primaryWeights.add(structurenetherbridgepieces$pieceweight);
            }

            this.secondaryWeights = Lists.<StructureNetherBridgePiecesUA.PieceWeight>newArrayList();

            for (StructureNetherBridgePiecesUA.PieceWeight structurenetherbridgepieces$pieceweight1 : StructureNetherBridgePiecesUA.SECONDARY_COMPONENTS)
            {
    ...
    public static class Straight extends StructureNetherBridgePiecesUA.Piece
    {
        public Straight()
        {
        }
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
        {
            this.getNextComponentNormal((StructureNetherBridgePiecesUA.Start)componentIn, listIn, rand, 1, 3, false);
        }

        public static StructureNetherBridgePiecesUA.Straight createPiece(List<StructureComponent> p_175882_0_, Random p_175882_1_, int p_175882_2_, int p_175882_3_, int p_175882_4_, EnumFacing p_175882_5_, int p_175882_6_)
        {
            ...
            return isAboveGround(structureboundingbox) && StructureComponent.findIntersecting(p_175882_0_, structureboundingbox) == null ? new StructureNetherBridgePiecesUA.Straight(p_175882_6_, p_175882_1_, structureboundingbox, p_175882_5_) : null;
        }
    ...
    public static class Throne extends StructureNetherBridgePiecesUA.Piece
    {
        ...
        public static StructureNetherBridgePiecesUA.Throne createPiece(List<StructureComponent> p_175874_0_, Random p_175874_1_, int p_175874_2_, int p_175874_3_, int p_175874_4_, int p_175874_5_, EnumFacing p_175874_6_)
        {
            ...
            return isAboveGround(structureboundingbox) && StructureComponent.findIntersecting(p_175874_0_, structureboundingbox) == null ? new StructureNetherBridgePiecesUA.Throne(p_175874_5_, p_175874_1_, structureboundingbox, p_175874_6_) : null;
        }
