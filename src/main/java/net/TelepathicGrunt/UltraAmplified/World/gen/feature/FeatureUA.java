...
public class FeatureUA
{
	   ...
	   public static Structure<NoFeatureConfig> WITCH_HUT_UA = new WitchHutUA(NoFeatureConfig::deserialize);
	...
	public static void onRegisterFeature(RegistryEvent.Register<Feature<?>> event)
	{
		...
		UltraAmplified.Logger.debug("FEATURE REGISTER");
		   ...
		   WITCH_HUT_UA = (Structure<NoFeatureConfig>) registerFeature(WITCH_HUT_UA, "swamp_hut_ua");
