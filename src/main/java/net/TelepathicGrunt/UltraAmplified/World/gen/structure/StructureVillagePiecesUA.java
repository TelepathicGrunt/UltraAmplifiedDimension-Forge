...
public class StructureVillagePiecesUA
{
    ...
    {
        MapGenStructureIO.registerStructureComponent(StructureVillagePiecesUA.House1.class, "ViBH");
        MapGenStructureIO.registerStructureComponent(StructureVillagePiecesUA.Field1.class, "ViDF");
        MapGenStructureIO.registerStructureComponent(StructureVillagePiecesUA.Field2.class, "ViF");
        MapGenStructureIO.registerStructureComponent(StructureVillagePiecesUA.Torch.class, "ViL");
        MapGenStructureIO.registerStructureComponent(StructureVillagePiecesUA.Hall.class, "ViPH");
        MapGenStructureIO.registerStructureComponent(StructureVillagePiecesUA.House4Garden.class, "ViSH");
        MapGenStructureIO.registerStructureComponent(StructureVillagePiecesUA.WoodHut.class, "ViSmH");
        MapGenStructureIO.registerStructureComponent(StructureVillagePiecesUA.Church.class, "ViST");
        MapGenStructureIO.registerStructureComponent(StructureVillagePiecesUA.House2.class, "ViS");
        MapGenStructureIO.registerStructureComponent(StructureVillagePiecesUA.Start.class, "ViStart");
        MapGenStructureIO.registerStructureComponent(StructureVillagePiecesUA.Path.class, "ViSR");
        MapGenStructureIO.registerStructureComponent(StructureVillagePiecesUA.House3.class, "ViTRH");
        MapGenStructureIO.registerStructureComponent(StructureVillagePiecesUA.Well.class, "ViW");
    }

    public static List<StructureVillagePiecesUA.PieceWeight> getStructureVillageWeightedPieceList(Random random, int size)
    {
        List<StructureVillagePiecesUA.PieceWeight> list = Lists.<StructureVillagePiecesUA.PieceWeight>newArrayList();
        list.add(new StructureVillagePiecesUA.PieceWeight(StructureVillagePiecesUA.House4Garden.class, 4, MathHelper.getInt(random, 2 + size, 4 + size * 2)));
        list.add(new StructureVillagePiecesUA.PieceWeight(StructureVillagePiecesUA.Church.class, 20, MathHelper.getInt(random, 0 + size, 1 + size)));
        list.add(new StructureVillagePiecesUA.PieceWeight(StructureVillagePiecesUA.House1.class, 20, MathHelper.getInt(random, 0 + size, 2 + size)));
        list.add(new StructureVillagePiecesUA.PieceWeight(StructureVillagePiecesUA.WoodHut.class, 3, MathHelper.getInt(random, 2 + size, 5 + size * 3)));
        list.add(new StructureVillagePiecesUA.PieceWeight(StructureVillagePiecesUA.Hall.class, 15, MathHelper.getInt(random, 0 + size, 2 + size)));
        list.add(new StructureVillagePiecesUA.PieceWeight(StructureVillagePiecesUA.Field1.class, 3, MathHelper.getInt(random, 1 + size, 4 + size)));
        list.add(new StructureVillagePiecesUA.PieceWeight(StructureVillagePiecesUA.Field2.class, 3, MathHelper.getInt(random, 2 + size, 4 + size * 2)));
        list.add(new StructureVillagePiecesUA.PieceWeight(StructureVillagePiecesUA.House2.class, 15, MathHelper.getInt(random, 0, 1 + size)));
        list.add(new StructureVillagePiecesUA.PieceWeight(StructureVillagePiecesUA.House3.class, 8, MathHelper.getInt(random, 0 + size, 3 + size * 2)));
        Iterator<StructureVillagePiecesUA.PieceWeight> iterator = list.iterator();

        while (iterator.hasNext())
        {
            if (((StructureVillagePiecesUA.PieceWeight)iterator.next()).villagePiecesLimit == 0)
            {
                iterator.remove();
            }
        }
    ...
    private static int updatePieceWeight(List<StructureVillagePiecesUA.PieceWeight> p_75079_0_)
    {
        boolean flag = false;
        int i = 0;

        for (StructureVillagePiecesUA.PieceWeight structurevillagepieces$pieceweight : p_75079_0_)
        {
    ...
    private static StructureVillagePiecesUA.Village findAndCreateComponentFactory(StructureVillagePiecesUA.Start start, StructureVillagePiecesUA.PieceWeight weight, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        Class <? extends StructureVillagePiecesUA.Village > oclass = weight.villagePieceClass;
        StructureVillagePiecesUA.Village structurevillagepieces$village = null;

        if (oclass == StructureVillagePiecesUA.House4Garden.class)
        {
            structurevillagepieces$village = StructureVillagePiecesUA.House4Garden.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureVillagePiecesUA.Church.class)
        {
            structurevillagepieces$village = StructureVillagePiecesUA.Church.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureVillagePiecesUA.House1.class)
        {
            structurevillagepieces$village = StructureVillagePiecesUA.House1.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureVillagePiecesUA.WoodHut.class)
        {
            structurevillagepieces$village = StructureVillagePiecesUA.WoodHut.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureVillagePiecesUA.Hall.class)
        {
            structurevillagepieces$village = StructureVillagePiecesUA.Hall.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureVillagePiecesUA.Field1.class)
        {
            structurevillagepieces$village = StructureVillagePiecesUA.Field1.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureVillagePiecesUA.Field2.class)
        {
            structurevillagepieces$village = StructureVillagePiecesUA.Field2.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureVillagePiecesUA.House2.class)
        {
            structurevillagepieces$village = StructureVillagePiecesUA.House2.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureVillagePiecesUA.House3.class)
        {
            structurevillagepieces$village = StructureVillagePiecesUA.House3.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }

        return structurevillagepieces$village;
    }

    private static StructureVillagePiecesUA.Village generateComponent(StructureVillagePiecesUA.Start start, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        ...
        else
        {
            ...
            while (j < 5)
            {
                ...
                for (StructureVillagePiecesUA.PieceWeight structurevillagepieces$pieceweight : start.structureVillageWeightedPieceList)
                {
                    ...
                    if (k < 0)
                    {
                        ...
                        StructureVillagePiecesUA.Village structurevillagepieces$village = findAndCreateComponentFactory(start, structurevillagepieces$pieceweight, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
            ...
            StructureBoundingBox structureboundingbox = StructureVillagePiecesUA.Torch.findPieceBox(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing);

            if (structureboundingbox != null)
            {
                return new StructureVillagePiecesUA.Torch(start, componentType, rand, structureboundingbox, facing);
            }
            else
            {
                return null;
    ...
    private static StructureComponent generateAndAddComponent(StructureVillagePiecesUA.Start start, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        if (componentType > 50)
        {
            return null;
    ...
    private static StructureComponent generateAndAddRoadPiece(StructureVillagePiecesUA.Start start, List<StructureComponent> p_176069_1_, Random rand, int p_176069_3_, int p_176069_4_, int p_176069_5_, EnumFacing facing, int p_176069_7_)
    {
        ...
        {
            StructureBoundingBox structureboundingbox = StructureVillagePiecesUA.Path.findPieceBox(start, p_176069_1_, rand, p_176069_3_, p_176069_4_, p_176069_5_, facing);

            if (structureboundingbox != null && structureboundingbox.minY > 10)
            {
                StructureComponent structurecomponent = new StructureVillagePiecesUA.Path(start, p_176069_7_, rand, structureboundingbox, facing);
    ...
    public static class Church extends StructureVillagePiecesUA.Village
    {
        public Church()
        {
        }

        public Church(StructureVillagePiecesUA.Start start, int type, Random rand, StructureBoundingBox p_i45564_4_, EnumFacing facing)
        {
            super(start, type);
        ...
        public static StructureVillagePiecesUA.Church createPiece(StructureVillagePiecesUA.Start start, List<StructureComponent> p_175854_1_, Random rand, int p_175854_3_, int p_175854_4_, int p_175854_5_, EnumFacing facing, int p_175854_7_)
        {
            ...
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175854_1_, structureboundingbox) == null ? new StructureVillagePiecesUA.Church(start, p_175854_7_, rand, structureboundingbox, facing) : null;
        }
    ...
    public static class Field1 extends StructureVillagePiecesUA.Village
    {
        ...
        public Field1(StructureVillagePiecesUA.Start start, int type, Random rand, StructureBoundingBox p_i45570_4_, EnumFacing facing)
        {
            super(start, type);
            this.setCoordBaseMode(facing);
        ...
        public static StructureVillagePiecesUA.Field1 createPiece(StructureVillagePiecesUA.Start start, List<StructureComponent> p_175851_1_, Random rand, int p_175851_3_, int p_175851_4_, int p_175851_5_, EnumFacing facing, int p_175851_7_)
        {
    ...
    public static class Field2 extends StructureVillagePiecesUA.Village
    {
        private Block cropTypeA;
        private Block cropTypeB;
        ...
        public Field2(StructureVillagePiecesUA.Start start, int p_i45569_2_, Random rand, StructureBoundingBox p_i45569_4_, EnumFacing facing)
        {
        ...
        public static StructureVillagePiecesUA.Field2 createPiece(StructureVillagePiecesUA.Start start, List<StructureComponent> p_175852_1_, Random rand, int p_175852_3_, int p_175852_4_, int p_175852_5_, EnumFacing facing, int p_175852_7_)
        {
    ...
    public static class Hall extends StructureVillagePiecesUA.Village
    {
        public Hall()
        {
        }

        public Hall(StructureVillagePiecesUA.Start start, int type, Random rand, StructureBoundingBox p_i45567_4_, EnumFacing facing)
        {
            super(start, type);
            this.setCoordBaseMode(facing);
        ...
        public static StructureVillagePiecesUA.Hall createPiece(StructureVillagePiecesUA.Start start, List<StructureComponent> p_175857_1_, Random rand, int p_175857_3_, int p_175857_4_, int p_175857_5_, EnumFacing facing, int p_175857_7_)
        {
            ...
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175857_1_, structureboundingbox) == null ? new StructureVillagePiecesUA.Hall(start, p_175857_7_, rand, structureboundingbox, facing) : null;
        }
    ...
    public static class House1 extends StructureVillagePiecesUA.Village
    {
        public House1()
        {
        }

        public House1(StructureVillagePiecesUA.Start start, int type, Random rand, StructureBoundingBox p_i45571_4_, EnumFacing facing)
        {
            super(start, type);
            this.setCoordBaseMode(facing);
        ...
        public static StructureVillagePiecesUA.House1 createPiece(StructureVillagePiecesUA.Start start, List<StructureComponent> p_175850_1_, Random rand, int p_175850_3_, int p_175850_4_, int p_175850_5_, EnumFacing facing, int p_175850_7_)
        {
            ...
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175850_1_, structureboundingbox) == null ? new StructureVillagePiecesUA.House1(start, p_175850_7_, rand, structureboundingbox, facing) : null;
        }
    ...
    public static class House2 extends StructureVillagePiecesUA.Village
    {
        ...
        public House2(StructureVillagePiecesUA.Start start, int type, Random rand, StructureBoundingBox p_i45563_4_, EnumFacing facing)
        {
            super(start, type);
            this.setCoordBaseMode(facing);
        ...
        public static StructureVillagePiecesUA.House2 createPiece(StructureVillagePiecesUA.Start start, List<StructureComponent> p_175855_1_, Random rand, int p_175855_3_, int p_175855_4_, int p_175855_5_, EnumFacing facing, int p_175855_7_)
        {
            ...
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175855_1_, structureboundingbox) == null ? new StructureVillagePiecesUA.House2(start, p_175855_7_, rand, structureboundingbox, facing) : null;
        }
    ...
    public static class House3 extends StructureVillagePiecesUA.Village
    {
        public House3()
        {
        }

        public House3(StructureVillagePiecesUA.Start start, int type, Random rand, StructureBoundingBox p_i45561_4_, EnumFacing facing)
        {
            super(start, type);
            this.setCoordBaseMode(facing);
        ...
        public static StructureVillagePiecesUA.House3 createPiece(StructureVillagePiecesUA.Start start, List<StructureComponent> p_175849_1_, Random rand, int p_175849_3_, int p_175849_4_, int p_175849_5_, EnumFacing facing, int p_175849_7_)
        {
            ...
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175849_1_, structureboundingbox) == null ? new StructureVillagePiecesUA.House3(start, p_175849_7_, rand, structureboundingbox, facing) : null;
        }
    ...
    public static class House4Garden extends StructureVillagePiecesUA.Village
    {
        ...
        public House4Garden(StructureVillagePiecesUA.Start start, int p_i45566_2_, Random rand, StructureBoundingBox p_i45566_4_, EnumFacing facing)
        {
        ...
        public static StructureVillagePiecesUA.House4Garden createPiece(StructureVillagePiecesUA.Start start, List<StructureComponent> p_175858_1_, Random rand, int p_175858_3_, int p_175858_4_, int p_175858_5_, EnumFacing facing, int p_175858_7_)
        {
            ...
            return StructureComponent.findIntersecting(p_175858_1_, structureboundingbox) != null ? null : new StructureVillagePiecesUA.House4Garden(start, p_175858_7_, rand, structureboundingbox, facing);
        }
    ...
    public static class Path extends StructureVillagePiecesUA.Road
    {
        private int length;
        ...
        public Path(StructureVillagePiecesUA.Start start, int p_i45562_2_, Random rand, StructureBoundingBox p_i45562_4_, EnumFacing facing)
        {
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
        {
            ...
            {
                StructureComponent structurecomponent = this.getNextComponentNN((StructureVillagePiecesUA.Start)componentIn, listIn, rand, 0, i);
            ...
            {
                StructureComponent structurecomponent1 = this.getNextComponentPP((StructureVillagePiecesUA.Start)componentIn, listIn, rand, 0, j);
            ...
            if (flag && rand.nextInt(3) > 0 && enumfacing != null)
            {
                switch (enumfacing)
                {
                    case NORTH:
                    default:
                        StructureVillagePiecesUA.generateAndAddRoadPiece((StructureVillagePiecesUA.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.WEST, this.getComponentType());
                        break;

                    case SOUTH:
                        StructureVillagePiecesUA.generateAndAddRoadPiece((StructureVillagePiecesUA.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.maxZ - 2, EnumFacing.WEST, this.getComponentType());
                        break;

                    case WEST:
                        StructureVillagePiecesUA.generateAndAddRoadPiece((StructureVillagePiecesUA.Start)componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                        break;

                    case EAST:
                        StructureVillagePiecesUA.generateAndAddRoadPiece((StructureVillagePiecesUA.Start)componentIn, listIn, rand, this.boundingBox.maxX - 2, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                }
            }
            ...
            if (flag && rand.nextInt(3) > 0 && enumfacing != null)
            {
                switch (enumfacing)
                {
                    case NORTH:
                    default:
                        StructureVillagePiecesUA.generateAndAddRoadPiece((StructureVillagePiecesUA.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.EAST, this.getComponentType());
                        break;

                    case SOUTH:
                        StructureVillagePiecesUA.generateAndAddRoadPiece((StructureVillagePiecesUA.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.maxZ - 2, EnumFacing.EAST, this.getComponentType());
                        break;

                    case WEST:
                        StructureVillagePiecesUA.generateAndAddRoadPiece((StructureVillagePiecesUA.Start)componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                        break;

                    case EAST:
                        StructureVillagePiecesUA.generateAndAddRoadPiece((StructureVillagePiecesUA.Start)componentIn, listIn, rand, this.boundingBox.maxX - 2, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                }
            }
        }

        public static StructureBoundingBox findPieceBox(StructureVillagePiecesUA.Start start, List<StructureComponent> p_175848_1_, Random rand, int p_175848_3_, int p_175848_4_, int p_175848_5_, EnumFacing facing)
        {
                ...
                for (int j = this.boundingBox.minZ; j <= this.boundingBox.maxZ; ++j)
                {
                    ...
                    if (structureBoundingBoxIn.isVecInside(blockpos))
                    {
                        ...
                        while (blockpos.getY() >= worldIn.getSeaLevel() - 1)
                        {
                            ...
                            if (iblockstate4.getBlock() == Blocks.SAND || iblockstate4.getBlock() == Blocks.SANDSTONE || iblockstate4.getBlock() == Blocks.RED_SANDSTONE || iblockstate4.getBlock() == Blocks.SNOW || iblockstate4.getBlock() == Blocks.STONE || iblockstate4.getBlock() == Blocks.NETHERRACK || iblockstate4.getBlock() == Blocks.END_STONE || iblockstate4.getBlock() == Blocks.STAINED_HARDENED_CLAY)
                            {
    ...
    {
        public Class <? extends StructureVillagePiecesUA.Village > villagePieceClass;
        public final int villagePieceWeight;
        public int villagePiecesSpawned;
        public int villagePiecesLimit;

        public PieceWeight(Class <? extends StructureVillagePiecesUA.Village > p_i2098_1_, int p_i2098_2_, int p_i2098_3_)
        {
    ...
    public abstract static class Road extends StructureVillagePiecesUA.Village
    {
        public Road()
        {
        }

        protected Road(StructureVillagePiecesUA.Start start, int type)
        {
            super(start, type);
        }
    }

    public static class Start extends StructureVillagePiecesUA.Well
    {
        public BiomeProvider worldChunkMngr;
        public int terrainType;
        public StructureVillagePiecesUA.PieceWeight structVillagePieceWeight;
        public List<StructureVillagePiecesUA.PieceWeight> structureVillageWeightedPieceList;
        ...
        public Start(BiomeProvider chunkManagerIn, int p_i2104_2_, Random rand, int x, int z, List<StructureVillagePiecesUA.PieceWeight> p_i2104_6_, int p_i2104_7_)
        {
            super((StructureVillagePiecesUA.Start)null, 0, rand, x, z);
    ...
    public static class Torch extends StructureVillagePiecesUA.Village
    {
        public Torch()
        {
        }

        public Torch(StructureVillagePiecesUA.Start start, int p_i45568_2_, Random rand, StructureBoundingBox p_i45568_4_, EnumFacing facing)
        {
        ...
        public static StructureBoundingBox findPieceBox(StructureVillagePiecesUA.Start start, List<StructureComponent> p_175856_1_, Random rand, int p_175856_3_, int p_175856_4_, int p_175856_5_, EnumFacing facing)
        {
    ...
    abstract static class Village extends StructureComponent
    {
        ...
        protected Village(StructureVillagePiecesUA.Start start, int type)
        {
            super(type);
        ...
        @Nullable
        protected StructureComponent getNextComponentNN(StructureVillagePiecesUA.Start start, List<StructureComponent> structureComponents, Random rand, int p_74891_4_, int p_74891_5_)
        {
            EnumFacing enumfacing = this.getCoordBaseMode();
            ...
            if (enumfacing != null)
            {
                switch (enumfacing)
                {
                    case NORTH:
                    default:
                        return StructureVillagePiecesUA.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ + p_74891_5_, EnumFacing.WEST, this.getComponentType());

                    case SOUTH:
                        return StructureVillagePiecesUA.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ + p_74891_5_, EnumFacing.WEST, this.getComponentType());

                    case WEST:
                        return StructureVillagePiecesUA.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74891_5_, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
        ...
        @Nullable
        protected StructureComponent getNextComponentPP(StructureVillagePiecesUA.Start start, List<StructureComponent> structureComponents, Random rand, int p_74894_4_, int p_74894_5_)
        {
            EnumFacing enumfacing = this.getCoordBaseMode();
            ...
            if (enumfacing != null)
            {
                switch (enumfacing)
                {
                    case NORTH:
                    default:
                        return StructureVillagePiecesUA.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_, this.boundingBox.minZ + p_74894_5_, EnumFacing.EAST, this.getComponentType());

                    case SOUTH:
                        return StructureVillagePiecesUA.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_, this.boundingBox.minZ + p_74894_5_, EnumFacing.EAST, this.getComponentType());

                    case WEST:
                        return StructureVillagePiecesUA.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74894_5_, this.boundingBox.minY + p_74894_4_, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
            ...
            if (this.villagersSpawned < count)
            {
                for (int i = this.villagersSpawned; i < count; ++i)
                {
                    ...
                    else
                    {
                        ...
                        entityvillager.setProfession(chooseForgeProfession(i, entityvillager.getProfessionForge()));
        ...
        protected IBlockState getBiomeSpecificBlockState(IBlockState blockstateIn)
        {
            ...
            else if (this.structureType == 6)
            {
                if (blockstateIn.getBlock() == Blocks.LOG || blockstateIn.getBlock() == Blocks.LOG2)
                {
                    return Blocks.PURPUR_PILLAR.getDefaultState().withProperty(BlockRotatedPillar.AXIS, EnumFacing.Axis.Y);
                }
                ...
                if (blockstateIn.getBlock() == Blocks.OAK_STAIRS || blockstateIn.getBlock() == Blocks.STONE_STAIRS)
                {
                    return Blocks.PURPUR_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, blockstateIn.getValue(BlockStairs.FACING));
                }
                
                if (blockstateIn.getBlock() == Blocks.TORCH)
                {
                    return Blocks.END_ROD.getDefaultState().withProperty(BlockEndRod.FACING, blockstateIn.getValue(BlockTorch.FACING));
                }
                
                if (blockstateIn.getBlock() == Blocks.COBBLESTONE || blockstateIn.getBlock() == Blocks.GRAVEL)
                {
            ...
            else if (this.structureType == 7)
            {
                ...
                if (blockstateIn.getBlock() == Blocks.OAK_STAIRS || blockstateIn.getBlock() == Blocks.STONE_STAIRS)
                {
                    return Blocks.NETHER_BRICK_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, blockstateIn.getValue(BlockStairs.FACING));
                }
            ...
            else if (this.structureType == 9)
            {
                ...
                if (blockstateIn.getBlock() == Blocks.GRAVEL || blockstateIn.getBlock() == Blocks.DIRT)
                {
                    return Blocks.ICE.getDefaultState();
                }
            }
        ...
        protected void func_189926_a(World p_189926_1_, EnumFacing p_189926_2_, int p_189926_3_, int p_189926_4_, int p_189926_5_, StructureBoundingBox p_189926_6_)
        {
            if (!this.isZombieInfested)
            {
                this.setBlockState(p_189926_1_, getBiomeSpecificBlockState(Blocks.TORCH.getDefaultState().withProperty(BlockTorch.FACING, p_189926_2_)), p_189926_3_, p_189926_4_, p_189926_5_, p_189926_6_);
            }
        }
    ...
    public static class Well extends StructureVillagePiecesUA.Village
    {
        public Well()
        {
        }

        public Well(StructureVillagePiecesUA.Start start, int type, Random rand, int x, int z)
        {
            super(start, type);
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
        {
            StructureVillagePiecesUA.generateAndAddRoadPiece((StructureVillagePiecesUA.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.WEST, this.getComponentType());
            StructureVillagePiecesUA.generateAndAddRoadPiece((StructureVillagePiecesUA.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.EAST, this.getComponentType());
            StructureVillagePiecesUA.generateAndAddRoadPiece((StructureVillagePiecesUA.Start)componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
            StructureVillagePiecesUA.generateAndAddRoadPiece((StructureVillagePiecesUA.Start)componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
        }
    ...
    public static class WoodHut extends StructureVillagePiecesUA.Village
    {
        ...
        public WoodHut(StructureVillagePiecesUA.Start start, int type, Random rand, StructureBoundingBox structurebb, EnumFacing facing)
        {
            super(start, type);
            this.setCoordBaseMode(facing);
        ...
        public static StructureVillagePiecesUA.WoodHut createPiece(StructureVillagePiecesUA.Start start, List<StructureComponent> p_175853_1_, Random rand, int p_175853_3_, int p_175853_4_, int p_175853_5_, EnumFacing facing, int p_175853_7_)
        {
            ...
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175853_1_, structureboundingbox) == null ? new StructureVillagePiecesUA.WoodHut(start, p_175853_7_, rand, structureboundingbox, facing) : null;
        }
