...
{
    private static final StructureStrongholdPiecesUA.PieceWeight[] PIECE_WEIGHTS = new StructureStrongholdPiecesUA.PieceWeight[] {new StructureStrongholdPiecesUA.PieceWeight(StructureStrongholdPiecesUA.Straight.class, 40, 0), new StructureStrongholdPiecesUA.PieceWeight(StructureStrongholdPiecesUA.Prison.class, 5, 8), new StructureStrongholdPiecesUA.PieceWeight(StructureStrongholdPiecesUA.LeftTurn.class, 20, 0), new StructureStrongholdPiecesUA.PieceWeight(StructureStrongholdPiecesUA.RightTurn.class, 20, 0), new StructureStrongholdPiecesUA.PieceWeight(StructureStrongholdPiecesUA.RoomCrossing.class, 10, 9), new StructureStrongholdPiecesUA.PieceWeight(StructureStrongholdPiecesUA.StairsStraight.class, 5, 7), new StructureStrongholdPiecesUA.PieceWeight(StructureStrongholdPiecesUA.Stairs.class, 5, 7), new StructureStrongholdPiecesUA.PieceWeight(StructureStrongholdPiecesUA.Crossing.class, 5, 7), new StructureStrongholdPiecesUA.PieceWeight(StructureStrongholdPiecesUA.ChestCorridor.class, 5, 16), new StructureStrongholdPiecesUA.PieceWeight(StructureStrongholdPiecesUA.Library.class, 10, 6)
        {
        ...
        }, new StructureStrongholdPiecesUA.PieceWeight(StructureStrongholdPiecesUA.PortalRoom.class, 20, 1)
        {
            public boolean canSpawnMoreStructuresOfType(int p_75189_1_)
            {
    ...
    private static List<StructureStrongholdPiecesUA.PieceWeight> structurePieceList;
    private static Class <? extends StructureStrongholdPiecesUA.Stronghold > strongComponentType;
    static int totalWeight;
    private static final StructureStrongholdPiecesUA.Stones STRONGHOLD_STONES = new StructureStrongholdPiecesUA.Stones();

    public static void registerStrongholdPieces()
    {
        MapGenStructureIO.registerStructureComponent(StructureStrongholdPiecesUA.ChestCorridor.class, "SHCC");
        MapGenStructureIO.registerStructureComponent(StructureStrongholdPiecesUA.Corridor.class, "SHFC");
        MapGenStructureIO.registerStructureComponent(StructureStrongholdPiecesUA.Crossing.class, "SH5C");
        MapGenStructureIO.registerStructureComponent(StructureStrongholdPiecesUA.LeftTurn.class, "SHLT");
        MapGenStructureIO.registerStructureComponent(StructureStrongholdPiecesUA.Library.class, "SHLi");
        MapGenStructureIO.registerStructureComponent(StructureStrongholdPiecesUA.PortalRoom.class, "SHPR");
        MapGenStructureIO.registerStructureComponent(StructureStrongholdPiecesUA.Prison.class, "SHPH");
        MapGenStructureIO.registerStructureComponent(StructureStrongholdPiecesUA.RightTurn.class, "SHRT");
        MapGenStructureIO.registerStructureComponent(StructureStrongholdPiecesUA.RoomCrossing.class, "SHRC");
        MapGenStructureIO.registerStructureComponent(StructureStrongholdPiecesUA.Stairs.class, "SHSD");
        MapGenStructureIO.registerStructureComponent(StructureStrongholdPiecesUA.Stairs2.class, "SHStart");
        MapGenStructureIO.registerStructureComponent(StructureStrongholdPiecesUA.Straight.class, "SHS");
        MapGenStructureIO.registerStructureComponent(StructureStrongholdPiecesUA.StairsStraight.class, "SHSSD");
    }
    ...
    {
        structurePieceList = Lists.<StructureStrongholdPiecesUA.PieceWeight>newArrayList();

        for (StructureStrongholdPiecesUA.PieceWeight structurestrongholdpieces$pieceweight : PIECE_WEIGHTS)
        {
    ...
    private static boolean canAddStructurePieces()
    {
        ...
        for (StructureStrongholdPiecesUA.PieceWeight structurestrongholdpieces$pieceweight : structurePieceList)
        {
    ...
    private static StructureStrongholdPiecesUA.Stronghold findAndCreatePieceFactory(Class <? extends StructureStrongholdPiecesUA.Stronghold > clazz, List<StructureComponent> p_175954_1_, Random p_175954_2_, int p_175954_3_, int p_175954_4_, int p_175954_5_, @Nullable EnumFacing p_175954_6_, int p_175954_7_)
    {
        StructureStrongholdPiecesUA.Stronghold structurestrongholdpieces$stronghold = null;

        if (clazz == StructureStrongholdPiecesUA.Straight.class)
        {
            structurestrongholdpieces$stronghold = StructureStrongholdPiecesUA.Straight.createPiece(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        else if (clazz == StructureStrongholdPiecesUA.Prison.class)
        {
            structurestrongholdpieces$stronghold = StructureStrongholdPiecesUA.Prison.createPiece(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        else if (clazz == StructureStrongholdPiecesUA.LeftTurn.class)
        {
            structurestrongholdpieces$stronghold = StructureStrongholdPiecesUA.LeftTurn.createPiece(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        else if (clazz == StructureStrongholdPiecesUA.RightTurn.class)
        {
            structurestrongholdpieces$stronghold = StructureStrongholdPiecesUA.RightTurn.createPiece(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        else if (clazz == StructureStrongholdPiecesUA.RoomCrossing.class)
        {
            structurestrongholdpieces$stronghold = StructureStrongholdPiecesUA.RoomCrossing.createPiece(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        else if (clazz == StructureStrongholdPiecesUA.StairsStraight.class)
        {
            structurestrongholdpieces$stronghold = StructureStrongholdPiecesUA.StairsStraight.createPiece(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        else if (clazz == StructureStrongholdPiecesUA.Stairs.class)
        {
            structurestrongholdpieces$stronghold = StructureStrongholdPiecesUA.Stairs.createPiece(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        else if (clazz == StructureStrongholdPiecesUA.Crossing.class)
        {
            structurestrongholdpieces$stronghold = StructureStrongholdPiecesUA.Crossing.createPiece(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        else if (clazz == StructureStrongholdPiecesUA.ChestCorridor.class)
        {
            structurestrongholdpieces$stronghold = StructureStrongholdPiecesUA.ChestCorridor.createPiece(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        else if (clazz == StructureStrongholdPiecesUA.Library.class)
        {
            structurestrongholdpieces$stronghold = StructureStrongholdPiecesUA.Library.createPiece(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        else if (clazz == StructureStrongholdPiecesUA.PortalRoom.class)
        {
            structurestrongholdpieces$stronghold = StructureStrongholdPiecesUA.PortalRoom.createPiece(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }

        return structurestrongholdpieces$stronghold;
    }

    private static StructureStrongholdPiecesUA.Stronghold generatePieceFromSmallDoor(StructureStrongholdPiecesUA.Stairs2 p_175955_0_, List<StructureComponent> p_175955_1_, Random p_175955_2_, int p_175955_3_, int p_175955_4_, int p_175955_5_, EnumFacing p_175955_6_, int p_175955_7_)
    {
        ...
        else
        {
            ...
            {
                StructureStrongholdPiecesUA.Stronghold structurestrongholdpieces$stronghold = findAndCreatePieceFactory(strongComponentType, p_175955_1_, p_175955_2_, p_175955_3_, p_175955_4_, p_175955_5_, p_175955_6_, p_175955_7_);
                strongComponentType = null;
            ...
            while (j < 5)
            {
                ...
                for (StructureStrongholdPiecesUA.PieceWeight structurestrongholdpieces$pieceweight : structurePieceList)
                {
                    ...
                    if (i < 0)
                    {
                        ...
                        StructureStrongholdPiecesUA.Stronghold structurestrongholdpieces$stronghold1 = findAndCreatePieceFactory(structurestrongholdpieces$pieceweight.pieceClass, p_175955_1_, p_175955_2_, p_175955_3_, p_175955_4_, p_175955_5_, p_175955_6_, p_175955_7_);
            ...
            StructureBoundingBox structureboundingbox = StructureStrongholdPiecesUA.Corridor.findPieceBox(p_175955_1_, p_175955_2_, p_175955_3_, p_175955_4_, p_175955_5_, p_175955_6_);

            if (structureboundingbox != null && structureboundingbox.minY > 1)
            {
                return new StructureStrongholdPiecesUA.Corridor(p_175955_7_, p_175955_2_, structureboundingbox, p_175955_6_);
            }
            else
            {
                return null;
    ...
    private static StructureComponent generateAndAddPiece(StructureStrongholdPiecesUA.Stairs2 p_175953_0_, List<StructureComponent> p_175953_1_, Random p_175953_2_, int p_175953_3_, int p_175953_4_, int p_175953_5_, @Nullable EnumFacing p_175953_6_, int p_175953_7_)
    {
        if (p_175953_7_ > 50)
        {
            return null;
    ...
    public static class ChestCorridor extends StructureStrongholdPiecesUA.Stronghold
    {
        ...
        {
            this.getNextComponentNormal((StructureStrongholdPiecesUA.Stairs2)componentIn, listIn, rand, 1, 1);
        }

        public static StructureStrongholdPiecesUA.ChestCorridor createPiece(List<StructureComponent> p_175868_0_, Random p_175868_1_, int p_175868_2_, int p_175868_3_, int p_175868_4_, EnumFacing p_175868_5_, int p_175868_6_)
        {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            {
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 0, 0, 0, 4, 4, 6, false, randomIn, StructureStrongholdPiecesUA.STRONGHOLD_STONES);
                this.placeDoor(worldIn, randomIn, structureBoundingBoxIn, this.entryDoor, 1, 1, 0);
                this.placeDoor(worldIn, randomIn, structureBoundingBoxIn, StructureStrongholdPiecesUA.Stronghold.Door.OPENING, 1, 1, 6);
    ...
    public static class Corridor extends StructureStrongholdPiecesUA.Stronghold
    {
        private int steps;
    ...
    public static class Crossing extends StructureStrongholdPiecesUA.Stronghold
    {
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
        {
            ...
            this.getNextComponentNormal((StructureStrongholdPiecesUA.Stairs2)componentIn, listIn, rand, 5, 1);

            if (this.leftLow)
            {
                this.getNextComponentX((StructureStrongholdPiecesUA.Stairs2)componentIn, listIn, rand, i, 1);
            }

            if (this.leftHigh)
            {
                this.getNextComponentX((StructureStrongholdPiecesUA.Stairs2)componentIn, listIn, rand, j, 7);
            }

            if (this.rightLow)
            {
                this.getNextComponentZ((StructureStrongholdPiecesUA.Stairs2)componentIn, listIn, rand, i, 1);
            }

            if (this.rightHigh)
            {
                this.getNextComponentZ((StructureStrongholdPiecesUA.Stairs2)componentIn, listIn, rand, j, 7);
            }
        }

        public static StructureStrongholdPiecesUA.Crossing createPiece(List<StructureComponent> p_175866_0_, Random p_175866_1_, int p_175866_2_, int p_175866_3_, int p_175866_4_, EnumFacing p_175866_5_, int p_175866_6_)
        {
            ...
            return canStrongholdGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175866_0_, structureboundingbox) == null ? new StructureStrongholdPiecesUA.Crossing(p_175866_6_, p_175866_1_, structureboundingbox, p_175866_5_) : null;
        }
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            {
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 0, 0, 0, 9, 8, 10, false, randomIn, StructureStrongholdPiecesUA.STRONGHOLD_STONES);
                ...
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 1, 2, 1, 8, 2, 6, false, randomIn, StructureStrongholdPiecesUA.STRONGHOLD_STONES);
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 4, 1, 5, 4, 4, 9, false, randomIn, StructureStrongholdPiecesUA.STRONGHOLD_STONES);
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 8, 1, 5, 8, 4, 9, false, randomIn, StructureStrongholdPiecesUA.STRONGHOLD_STONES);
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 1, 4, 7, 3, 4, 9, false, randomIn, StructureStrongholdPiecesUA.STRONGHOLD_STONES);
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 1, 3, 5, 3, 3, 6, false, randomIn, StructureStrongholdPiecesUA.STRONGHOLD_STONES);
                ...
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 5, 1, 7, 7, 1, 8, false, randomIn, StructureStrongholdPiecesUA.STRONGHOLD_STONES);
    ...
    public static class LeftTurn extends StructureStrongholdPiecesUA.Stronghold
    {
        public LeftTurn()
        {
        }
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
        {
            ...
            {
                this.getNextComponentZ((StructureStrongholdPiecesUA.Stairs2)componentIn, listIn, rand, 1, 1);
            }
            else
            {
                this.getNextComponentX((StructureStrongholdPiecesUA.Stairs2)componentIn, listIn, rand, 1, 1);
            }
        }

        public static StructureStrongholdPiecesUA.LeftTurn createPiece(List<StructureComponent> p_175867_0_, Random p_175867_1_, int p_175867_2_, int p_175867_3_, int p_175867_4_, EnumFacing p_175867_5_, int p_175867_6_)
        {
            ...
            return canStrongholdGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175867_0_, structureboundingbox) == null ? new StructureStrongholdPiecesUA.LeftTurn(p_175867_6_, p_175867_1_, structureboundingbox, p_175867_5_) : null;
        }
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            {
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 0, 0, 0, 4, 4, 4, false, randomIn, StructureStrongholdPiecesUA.STRONGHOLD_STONES);
                this.placeDoor(worldIn, randomIn, structureBoundingBoxIn, this.entryDoor, 1, 1, 0);
                EnumFacing enumfacing = this.getCoordBaseMode();
    ...
    public static class Library extends StructureStrongholdPiecesUA.Stronghold
    {
        ...
        public static StructureStrongholdPiecesUA.Library createPiece(List<StructureComponent> p_175864_0_, Random p_175864_1_, int p_175864_2_, int p_175864_3_, int p_175864_4_, EnumFacing p_175864_5_, int p_175864_6_)
        {
            ...
            return new StructureStrongholdPiecesUA.Library(p_175864_6_, p_175864_1_, structureboundingbox, p_175864_5_);
        }
    ...
    {
        public Class <? extends StructureStrongholdPiecesUA.Stronghold > pieceClass;
        public final int pieceWeight;
        public int instancesSpawned;
        public int instancesLimit;

        public PieceWeight(Class <? extends StructureStrongholdPiecesUA.Stronghold > p_i2076_1_, int p_i2076_2_, int p_i2076_3_)
        {
    ...
    public static class PortalRoom extends StructureStrongholdPiecesUA.Stronghold
    {
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
        {
            if (componentIn != null)
            {
                ((StructureStrongholdPiecesUA.Stairs2)componentIn).strongholdPortalRoom = this;
            }
        }

        public static StructureStrongholdPiecesUA.PortalRoom createPiece(List<StructureComponent> p_175865_0_, Random p_175865_1_, int p_175865_2_, int p_175865_3_, int p_175865_4_, EnumFacing p_175865_5_, int p_175865_6_)
        {
            ...
            return canStrongholdGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175865_0_, structureboundingbox) == null ? new StructureStrongholdPiecesUA.PortalRoom(p_175865_6_, p_175865_1_, structureboundingbox, p_175865_5_) : null;
        }

        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 0, 0, 0, 10, 7, 15, false, randomIn, StructureStrongholdPiecesUA.STRONGHOLD_STONES);
            this.placeDoor(worldIn, randomIn, structureBoundingBoxIn, StructureStrongholdPiecesUA.Stronghold.Door.GRATES, 4, 1, 0);
            int i = 6;
            this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 1, i, 1, 1, i, 14, false, randomIn, StructureStrongholdPiecesUA.STRONGHOLD_STONES);
            this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 9, i, 1, 9, i, 14, false, randomIn, StructureStrongholdPiecesUA.STRONGHOLD_STONES);
            this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 2, i, 1, 8, i, 2, false, randomIn, StructureStrongholdPiecesUA.STRONGHOLD_STONES);
            this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 2, i, 14, 8, i, 14, false, randomIn, StructureStrongholdPiecesUA.STRONGHOLD_STONES);
            this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 1, 1, 1, 2, 1, 4, false, randomIn, StructureStrongholdPiecesUA.STRONGHOLD_STONES);
            this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 8, 1, 1, 9, 1, 4, false, randomIn, StructureStrongholdPiecesUA.STRONGHOLD_STONES);
            ...
            this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 3, 1, 8, 7, 1, 12, false, randomIn, StructureStrongholdPiecesUA.STRONGHOLD_STONES);
            ...
            this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 4, 1, 5, 6, 1, 7, false, randomIn, StructureStrongholdPiecesUA.STRONGHOLD_STONES);
            this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 4, 2, 6, 6, 2, 7, false, randomIn, StructureStrongholdPiecesUA.STRONGHOLD_STONES);
            this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 4, 3, 7, 6, 3, 7, false, randomIn, StructureStrongholdPiecesUA.STRONGHOLD_STONES);
            ...
            if (!this.hasSpawner)
            {
                ...
                if (structureBoundingBoxIn.isVecInside(blockpos))
                {
                    ...
                    {
                    	((TileEntityMobSpawner)tileentity).getSpawnerBaseLogic().setEntityId(EntityList.getKey(EntityEndermite.class));
                    }
                }
            }
    ...
    public static class Prison extends StructureStrongholdPiecesUA.Stronghold
    {
        public Prison()
        {
        }
        ...
        public static StructureStrongholdPiecesUA.Prison createPiece(List<StructureComponent> p_175860_0_, Random p_175860_1_, int p_175860_2_, int p_175860_3_, int p_175860_4_, EnumFacing p_175860_5_, int p_175860_6_)
        {
            ...
            return canStrongholdGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175860_0_, structureboundingbox) == null ? new StructureStrongholdPiecesUA.Prison(p_175860_6_, p_175860_1_, structureboundingbox, p_175860_5_) : null;
        }
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            {
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 0, 0, 0, 8, 4, 10, false, randomIn, StructureStrongholdPiecesUA.STRONGHOLD_STONES);
                this.placeDoor(worldIn, randomIn, structureBoundingBoxIn, this.entryDoor, 1, 1, 0);
                ...
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 4, 1, 1, 4, 3, 1, false, randomIn, StructureStrongholdPiecesUA.STRONGHOLD_STONES);
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 4, 1, 3, 4, 3, 3, false, randomIn, StructureStrongholdPiecesUA.STRONGHOLD_STONES);
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 4, 1, 7, 4, 3, 7, false, randomIn, StructureStrongholdPiecesUA.STRONGHOLD_STONES);
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 4, 1, 9, 4, 3, 9, false, randomIn, StructureStrongholdPiecesUA.STRONGHOLD_STONES);
    ...
    public static class RightTurn extends StructureStrongholdPiecesUA.LeftTurn
    {
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
        {
            EnumFacing enumfacing = this.getCoordBaseMode();
    ...
    public static class RoomCrossing extends StructureStrongholdPiecesUA.Stronghold
    {
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
        {
            this.getNextComponentNormal((StructureStrongholdPiecesUA.Stairs2)componentIn, listIn, rand, 4, 1);
            this.getNextComponentX((StructureStrongholdPiecesUA.Stairs2)componentIn, listIn, rand, 1, 4);
            this.getNextComponentZ((StructureStrongholdPiecesUA.Stairs2)componentIn, listIn, rand, 1, 4);
        }

        public static StructureStrongholdPiecesUA.RoomCrossing createPiece(List<StructureComponent> p_175859_0_, Random p_175859_1_, int p_175859_2_, int p_175859_3_, int p_175859_4_, EnumFacing p_175859_5_, int p_175859_6_)
        {
            ...
            return canStrongholdGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175859_0_, structureboundingbox) == null ? new StructureStrongholdPiecesUA.RoomCrossing(p_175859_6_, p_175859_1_, structureboundingbox, p_175859_5_) : null;
        }
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            {
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 0, 0, 0, 10, 6, 10, false, randomIn, StructureStrongholdPiecesUA.STRONGHOLD_STONES);
                this.placeDoor(worldIn, randomIn, structureBoundingBoxIn, this.entryDoor, 4, 1, 0);
    ...
    public static class Stairs extends StructureStrongholdPiecesUA.Stronghold
    {
        ...
        public Stairs(int p_i2081_1_, Random p_i2081_2_, int p_i2081_3_, int p_i2081_4_)
        {
            ...
            this.entryDoor = StructureStrongholdPiecesUA.Stronghold.Door.OPENING;
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
        {
            if (this.source)
            {
                StructureStrongholdPiecesUA.strongComponentType = StructureStrongholdPiecesUA.Crossing.class;
            }

            this.getNextComponentNormal((StructureStrongholdPiecesUA.Stairs2)componentIn, listIn, rand, 1, 1);
        }

        public static StructureStrongholdPiecesUA.Stairs createPiece(List<StructureComponent> p_175863_0_, Random p_175863_1_, int p_175863_2_, int p_175863_3_, int p_175863_4_, EnumFacing p_175863_5_, int p_175863_6_)
        {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            {
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 0, 0, 0, 4, 10, 4, false, randomIn, StructureStrongholdPiecesUA.STRONGHOLD_STONES);
                this.placeDoor(worldIn, randomIn, structureBoundingBoxIn, this.entryDoor, 1, 7, 0);
                this.placeDoor(worldIn, randomIn, structureBoundingBoxIn, StructureStrongholdPiecesUA.Stronghold.Door.OPENING, 1, 1, 4);
    ...
    public static class Stairs2 extends StructureStrongholdPiecesUA.Stairs
    {
        public StructureStrongholdPiecesUA.PieceWeight strongholdPieceWeight;
        public StructureStrongholdPiecesUA.PortalRoom strongholdPortalRoom;
    ...
    public static class StairsStraight extends StructureStrongholdPiecesUA.Stronghold
    {
        ...
        public static StructureStrongholdPiecesUA.StairsStraight createPiece(List<StructureComponent> p_175861_0_, Random p_175861_1_, int p_175861_2_, int p_175861_3_, int p_175861_4_, EnumFacing p_175861_5_, int p_175861_6_)
        {
            ...
            return canStrongholdGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175861_0_, structureboundingbox) == null ? new StructureStrongholdPiecesUA.StairsStraight(p_175861_6_, p_175861_1_, structureboundingbox, p_175861_5_) : null;
        }
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            {
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 0, 0, 0, 4, 10, 7, false, randomIn, StructureStrongholdPiecesUA.STRONGHOLD_STONES);
                this.placeDoor(worldIn, randomIn, structureBoundingBoxIn, this.entryDoor, 1, 7, 0);
                this.placeDoor(worldIn, randomIn, structureBoundingBoxIn, StructureStrongholdPiecesUA.Stronghold.Door.OPENING, 1, 1, 7);
    ...
    public static class Straight extends StructureStrongholdPiecesUA.Stronghold
    {
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
        {
            ...
            if (this.expandsX)
            {
                this.getNextComponentX((StructureStrongholdPiecesUA.Stairs2)componentIn, listIn, rand, 1, 2);
            }

            if (this.expandsZ)
            {
                this.getNextComponentZ((StructureStrongholdPiecesUA.Stairs2)componentIn, listIn, rand, 1, 2);
            }
        }

        public static StructureStrongholdPiecesUA.Straight createPiece(List<StructureComponent> p_175862_0_, Random p_175862_1_, int p_175862_2_, int p_175862_3_, int p_175862_4_, EnumFacing p_175862_5_, int p_175862_6_)
        {
            ...
            return canStrongholdGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175862_0_, structureboundingbox) == null ? new StructureStrongholdPiecesUA.Straight(p_175862_6_, p_175862_1_, structureboundingbox, p_175862_5_) : null;
        }
    ...
    {
        protected StructureStrongholdPiecesUA.Stronghold.Door entryDoor = StructureStrongholdPiecesUA.Stronghold.Door.OPENING;
        ...
        protected void readStructureFromNBT(NBTTagCompound tagCompound, TemplateManager p_143011_2_)
        {
            this.entryDoor = StructureStrongholdPiecesUA.Stronghold.Door.valueOf(tagCompound.getString("EntryDoor"));
        }

        protected void placeDoor(World worldIn, Random p_74990_2_, StructureBoundingBox p_74990_3_, StructureStrongholdPiecesUA.Stronghold.Door p_74990_4_, int p_74990_5_, int p_74990_6_, int p_74990_7_)
        {
            switch (p_74990_4_)
            {
                case OPENING:
        ...
        protected StructureStrongholdPiecesUA.Stronghold.Door getRandomDoor(Random p_74988_1_)
        {
            ...
            switch (i)
            {
                ...
                case 1:
                default:
                    return StructureStrongholdPiecesUA.Stronghold.Door.OPENING;

                case 2:
                    return StructureStrongholdPiecesUA.Stronghold.Door.WOOD_DOOR;

                case 3:
                    return StructureStrongholdPiecesUA.Stronghold.Door.GRATES;

                case 4:
                    return StructureStrongholdPiecesUA.Stronghold.Door.IRON_DOOR;
            }
        }

        @Nullable
        protected StructureComponent getNextComponentNormal(StructureStrongholdPiecesUA.Stairs2 p_74986_1_, List<StructureComponent> p_74986_2_, Random p_74986_3_, int p_74986_4_, int p_74986_5_)
        {
            EnumFacing enumfacing = this.getCoordBaseMode();
            ...
            if (enumfacing != null)
            {
                ...
                {
                    case NORTH:
                        return StructureStrongholdPiecesUA.generateAndAddPiece(p_74986_1_, p_74986_2_, p_74986_3_, this.boundingBox.minX + p_74986_4_, this.boundingBox.minY + p_74986_5_, this.boundingBox.minZ - 1, enumfacing, this.getComponentType());

                    case SOUTH:
                        return StructureStrongholdPiecesUA.generateAndAddPiece(p_74986_1_, p_74986_2_, p_74986_3_, this.boundingBox.minX + p_74986_4_, this.boundingBox.minY + p_74986_5_, this.boundingBox.maxZ + 1, enumfacing, this.getComponentType());

                    case WEST:
                        return StructureStrongholdPiecesUA.generateAndAddPiece(p_74986_1_, p_74986_2_, p_74986_3_, this.boundingBox.minX - 1, this.boundingBox.minY + p_74986_5_, this.boundingBox.minZ + p_74986_4_, enumfacing, this.getComponentType());

                    case EAST:
                        return StructureStrongholdPiecesUA.generateAndAddPiece(p_74986_1_, p_74986_2_, p_74986_3_, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74986_5_, this.boundingBox.minZ + p_74986_4_, enumfacing, this.getComponentType());
                }
            }
        ...
        @Nullable
        protected StructureComponent getNextComponentX(StructureStrongholdPiecesUA.Stairs2 p_74989_1_, List<StructureComponent> p_74989_2_, Random p_74989_3_, int p_74989_4_, int p_74989_5_)
        {
            EnumFacing enumfacing = this.getCoordBaseMode();
            ...
            if (enumfacing != null)
            {
                ...
                {
                    case NORTH:
                        return StructureStrongholdPiecesUA.generateAndAddPiece(p_74989_1_, p_74989_2_, p_74989_3_, this.boundingBox.minX - 1, this.boundingBox.minY + p_74989_4_, this.boundingBox.minZ + p_74989_5_, EnumFacing.WEST, this.getComponentType());

                    case SOUTH:
                        return StructureStrongholdPiecesUA.generateAndAddPiece(p_74989_1_, p_74989_2_, p_74989_3_, this.boundingBox.minX - 1, this.boundingBox.minY + p_74989_4_, this.boundingBox.minZ + p_74989_5_, EnumFacing.WEST, this.getComponentType());

                    case WEST:
                        return StructureStrongholdPiecesUA.generateAndAddPiece(p_74989_1_, p_74989_2_, p_74989_3_, this.boundingBox.minX + p_74989_5_, this.boundingBox.minY + p_74989_4_, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
        ...
        @Nullable
        protected StructureComponent getNextComponentZ(StructureStrongholdPiecesUA.Stairs2 p_74987_1_, List<StructureComponent> p_74987_2_, Random p_74987_3_, int p_74987_4_, int p_74987_5_)
        {
            EnumFacing enumfacing = this.getCoordBaseMode();
            ...
            if (enumfacing != null)
            {
                ...
                {
                    case NORTH:
                        return StructureStrongholdPiecesUA.generateAndAddPiece(p_74987_1_, p_74987_2_, p_74987_3_, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74987_4_, this.boundingBox.minZ + p_74987_5_, EnumFacing.EAST, this.getComponentType());

                    case SOUTH:
                        return StructureStrongholdPiecesUA.generateAndAddPiece(p_74987_1_, p_74987_2_, p_74987_3_, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74987_4_, this.boundingBox.minZ + p_74987_5_, EnumFacing.EAST, this.getComponentType());

                    case WEST:
                        return StructureStrongholdPiecesUA.generateAndAddPiece(p_74987_1_, p_74987_2_, p_74987_3_, this.boundingBox.minX + p_74987_5_, this.boundingBox.minY + p_74987_4_, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
