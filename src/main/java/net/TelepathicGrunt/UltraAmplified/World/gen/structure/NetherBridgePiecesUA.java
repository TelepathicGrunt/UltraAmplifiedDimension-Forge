...
public class NetherBridgePiecesUA
{
    ...
    {
        StructureIO.registerStructureComponent(NetherBridgePiecesUA.Crossing3.class, "NeBCr");
        StructureIO.registerStructureComponent(NetherBridgePiecesUA.End.class, "NeBEF");
        StructureIO.registerStructureComponent(NetherBridgePiecesUA.Straight.class, "NeBS");
        StructureIO.registerStructureComponent(NetherBridgePiecesUA.Corridor3.class, "NeCCS");
        StructureIO.registerStructureComponent(NetherBridgePiecesUA.Corridor4.class, "NeCTB");
        StructureIO.registerStructureComponent(NetherBridgePiecesUA.Entrance.class, "NeCE");
        StructureIO.registerStructureComponent(NetherBridgePiecesUA.Crossing2.class, "NeSCSC");
        StructureIO.registerStructureComponent(NetherBridgePiecesUA.Corridor.class, "NeSCLT");
        StructureIO.registerStructureComponent(NetherBridgePiecesUA.Corridor5.class, "NeSC");
        StructureIO.registerStructureComponent(NetherBridgePiecesUA.Corridor2.class, "NeSCRT");
        StructureIO.registerStructureComponent(NetherBridgePiecesUA.NetherStalkRoom.class, "NeCSR");
        StructureIO.registerStructureComponent(NetherBridgePiecesUA.Throne.class, "NeMT");
        StructureIO.registerStructureComponent(NetherBridgePiecesUA.Crossing.class, "NeRC");
        StructureIO.registerStructureComponent(NetherBridgePiecesUA.Stairs.class, "NeSR");
        StructureIO.registerStructureComponent(NetherBridgePiecesUA.Start.class, "NeStart");
    }

    private static NetherBridgePiecesUA.Piece findAndCreateBridgePieceFactory(NetherBridgePiecesUA.PieceWeight p_175887_0_, List<StructurePiece> p_175887_1_, Random p_175887_2_, int p_175887_3_, int p_175887_4_, int p_175887_5_, EnumFacing p_175887_6_, int p_175887_7_)
    {
    ...
    public static class Corridor extends NetherBridgePiecesUA.Piece
    {
        ...
        public static NetherBridgePiecesUA.Corridor createPiece(List<StructurePiece> p_175879_0_, Random p_175879_1_, int p_175879_2_, int p_175879_3_, int p_175879_4_, EnumFacing p_175879_5_, int p_175879_6_)
        {
        ...
        public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) 
        {
            ...
            if (Config.chestGeneration && randomIn.nextBoolean() && this.chest && structureBoundingBoxIn.isVecInside(new BlockPos(this.getXWithOffset(3, 3), this.getYWithOffset(2), this.getZWithOffset(3, 3))))
            {
                this.chest = false;
    ...
    public static class Corridor2 extends NetherBridgePiecesUA.Piece
    {
        ...
        public static NetherBridgePiecesUA.Corridor2 createPiece(List<StructurePiece> p_175876_0_, Random p_175876_1_, int p_175876_2_, int p_175876_3_, int p_175876_4_, EnumFacing p_175876_5_, int p_175876_6_)
        {
    ...
    public static class Corridor3 extends NetherBridgePiecesUA.Piece
    {
        ...
        public static NetherBridgePiecesUA.Corridor3 createPiece(List<StructurePiece> p_175883_0_, Random p_175883_1_, int p_175883_2_, int p_175883_3_, int p_175883_4_, EnumFacing p_175883_5_, int p_175883_6_)
        {
            ...
            return isAboveGround(mutableBoundingBox) && StructurePiece.findIntersecting(p_175883_0_, mutableBoundingBox) == null ? new NetherBridgePiecesUA.Corridor3(p_175883_6_, p_175883_1_, mutableBoundingBox, p_175883_5_) : null;
        }
    ...
    public static class Corridor4 extends NetherBridgePiecesUA.Piece
    {
        ...
        public static NetherBridgePiecesUA.Corridor4 createPiece(List<StructurePiece> p_175880_0_, Random p_175880_1_, int p_175880_2_, int p_175880_3_, int p_175880_4_, EnumFacing p_175880_5_, int p_175880_6_)
        {
            ...
            return isAboveGround(mutableBoundingBox) && StructurePiece.findIntersecting(p_175880_0_, mutableBoundingBox) == null ? new NetherBridgePiecesUA.Corridor4(p_175880_6_, p_175880_1_, mutableBoundingBox, p_175880_5_) : null;
        }
    ...
    public static class Corridor5 extends NetherBridgePiecesUA.Piece
    {
        ...
        public static NetherBridgePiecesUA.Corridor5 createPiece(List<StructurePiece> p_175877_0_, Random p_175877_1_, int p_175877_2_, int p_175877_3_, int p_175877_4_, EnumFacing p_175877_5_, int p_175877_6_)
        {
            ...
            return isAboveGround(mutableBoundingBox) && StructurePiece.findIntersecting(p_175877_0_, mutableBoundingBox) == null ? new NetherBridgePiecesUA.Corridor5(p_175877_6_, p_175877_1_, mutableBoundingBox, p_175877_5_) : null;
        }
    ...
    public static class Crossing extends NetherBridgePiecesUA.Piece
    {
        ...
        public static NetherBridgePiecesUA.Crossing createPiece(List<StructurePiece> p_175873_0_, Random p_175873_1_, int p_175873_2_, int p_175873_3_, int p_175873_4_, EnumFacing p_175873_5_, int p_175873_6_)
        {
            ...
            return isAboveGround(mutableBoundingBox) && StructurePiece.findIntersecting(p_175873_0_, mutableBoundingBox) == null ? new NetherBridgePiecesUA.Crossing(p_175873_6_, p_175873_1_, mutableBoundingBox, p_175873_5_) : null;
        }
    ...
    public static class Crossing2 extends NetherBridgePiecesUA.Piece
    {
        ...
        public static NetherBridgePiecesUA.Crossing2 createPiece(List<StructurePiece> p_175878_0_, Random p_175878_1_, int p_175878_2_, int p_175878_3_, int p_175878_4_, EnumFacing p_175878_5_, int p_175878_6_)
        {
            ...
            return isAboveGround(mutableBoundingBox) && StructurePiece.findIntersecting(p_175878_0_, mutableBoundingBox) == null ? new NetherBridgePiecesUA.Crossing2(p_175878_6_, p_175878_1_, mutableBoundingBox, p_175878_5_) : null;
        }
    ...
    public static class Crossing3 extends NetherBridgePiecesUA.Piece
    {
        ...
        public static NetherBridgePiecesUA.Crossing3 createPiece(List<StructurePiece> p_175885_0_, Random p_175885_1_, int p_175885_2_, int p_175885_3_, int p_175885_4_, EnumFacing p_175885_5_, int p_175885_6_)
        {
            ...
            return isAboveGround(mutableBoundingBox) && StructurePiece.findIntersecting(p_175885_0_, mutableBoundingBox) == null ? new NetherBridgePiecesUA.Crossing3(p_175885_6_, p_175885_1_, mutableBoundingBox, p_175885_5_) : null;
        }
    ...
    public static class End extends NetherBridgePiecesUA.Piece
    {
        ...
        public static NetherBridgePiecesUA.End createPiece(List<StructurePiece> p_175884_0_, Random p_175884_1_, int p_175884_2_, int p_175884_3_, int p_175884_4_, EnumFacing p_175884_5_, int p_175884_6_)
        {
    ...
    public static class Entrance extends NetherBridgePiecesUA.Piece
    {
        ...
        public static NetherBridgePiecesUA.Entrance createPiece(List<StructurePiece> p_175881_0_, Random p_175881_1_, int p_175881_2_, int p_175881_3_, int p_175881_4_, EnumFacing p_175881_5_, int p_175881_6_)
        {
        ...
        public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPos)
        {
            ...
            for (int k = 3; k <= 9; k += 2)
            {
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 7, k, 1, 8, k, iblockstate.with(BlockFence.WEST, Boolean.valueOf(true)), iblockstate.with(BlockFence.WEST, Boolean.valueOf(true)), false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 11, 7, k, 11, 8, k, iblockstate.with(BlockFence.EAST, Boolean.valueOf(true)), iblockstate.with(BlockFence.EAST, Boolean.valueOf(true)), false);
            }
    ...
    public static class NetherStalkRoom extends NetherBridgePiecesUA.Piece
    {
        ...
        public static NetherBridgePiecesUA.NetherStalkRoom createPiece(List<StructurePiece> p_175875_0_, Random p_175875_1_, int p_175875_2_, int p_175875_3_, int p_175875_4_, EnumFacing p_175875_5_, int p_175875_6_)
        {
            ...
            return isAboveGround(mutableBoundingBox) && StructurePiece.findIntersecting(p_175875_0_, mutableBoundingBox) == null ? new NetherBridgePiecesUA.NetherStalkRoom(p_175875_6_, p_175875_1_, mutableBoundingBox, p_175875_5_) : null;
        }
    ...
    abstract static class Piece extends StructurePiece
    {
        ...
        private NetherBridgePiecesUA.Piece generatePiece(NetherBridgePiecesUA.Start p_175871_1_, List<NetherBridgePiecesUA.PieceWeight> p_175871_2_, List<StructurePiece> p_175871_3_, Random p_175871_4_, int p_175871_5_, int p_175871_6_, int p_175871_7_, EnumFacing p_175871_8_, int p_175871_9_)
        {
        ...
        private StructurePiece generateAndAddPiece(NetherBridgePiecesUA.Start p_175870_1_, List<StructurePiece> p_175870_2_, Random p_175870_3_, int p_175870_4_, int p_175870_5_, int p_175870_6_, @Nullable EnumFacing p_175870_7_, int p_175870_8_, boolean p_175870_9_)
        {
    ...
    public static class Stairs extends NetherBridgePiecesUA.Piece
    {
        ...
        public static NetherBridgePiecesUA.Stairs createPiece(List<StructurePiece> p_175872_0_, Random p_175872_1_, int p_175872_2_, int p_175872_3_, int p_175872_4_, int p_175872_5_, EnumFacing p_175872_6_)
        {
            ...
            return isAboveGround(mutableBoundingBox) && StructurePiece.findIntersecting(p_175872_0_, mutableBoundingBox) == null ? new NetherBridgePiecesUA.Stairs(p_175872_5_, p_175872_1_, mutableBoundingBox, p_175872_6_) : null;
        }
    ...
    public static class Straight extends NetherBridgePiecesUA.Piece
    {
        ...
        public static NetherBridgePiecesUA.Straight createPiece(List<StructurePiece> p_175882_0_, Random p_175882_1_, int p_175882_2_, int p_175882_3_, int p_175882_4_, EnumFacing p_175882_5_, int p_175882_6_)
        {
        ...
        public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPos)
        {
            ...
            IBlockState iblockstate3 = iblockstate1.with(BlockFence.WEST, Boolean.valueOf(true));
    ...
    public static class Throne extends NetherBridgePiecesUA.Piece
    {
        ...
        public static NetherBridgePiecesUA.Throne createPiece(List<StructurePiece> p_175874_0_, Random p_175874_1_, int p_175874_2_, int p_175874_3_, int p_175874_4_, int p_175874_5_, EnumFacing p_175874_6_)
        {
            ...
            return isAboveGround(mutableBoundingBox) && StructurePiece.findIntersecting(p_175874_0_, mutableBoundingBox) == null ? new NetherBridgePiecesUA.Throne(p_175874_5_, p_175874_1_, mutableBoundingBox, p_175874_6_) : null;
        }
