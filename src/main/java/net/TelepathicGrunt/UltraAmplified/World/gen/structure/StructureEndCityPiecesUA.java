...
public class StructureEndCityPiecesUA
{
    ...
    private static final StructureEndCityPiecesUA.IGenerator HOUSE_TOWER_GENERATOR = new StructureEndCityPiecesUA.IGenerator()
    {
         ...
         public boolean generate(TemplateManager p_191086_1_, int p_191086_2_, StructureEndCityPiecesUA.CityTemplate p_191086_3_, BlockPos p_191086_4_, List<StructureComponent> p_191086_5_, Random p_191086_6_)
         {
             if (p_191086_2_ > 8)
             {
                 return false;
             ...
             else
             {
                 ...
                 StructureEndCityPiecesUA.CityTemplate structureendcitypieces$citytemplate = StructureEndCityPiecesUA.addHelper(p_191086_5_, StructureEndCityPiecesUA.addPiece(p_191086_1_, p_191086_3_, p_191086_4_, "base_floor", rotation, true));
                 int i = 2;
                 ...
                 else if (i == 1)
                 {
                     ...
                     StructureEndCityPiecesUA.recursiveChildren(p_191086_1_, StructureEndCityPiecesUA.TOWER_GENERATOR, p_191086_2_ + 1, structureendcitypieces$citytemplate, (BlockPos)null, p_191086_5_, p_191086_6_);
                 }
                 else if (i == 2)
                 {
                     structureendcitypieces$citytemplate = StructureEndCityPiecesUA.addHelper(p_191086_5_, StructureEndCityPiecesUA.addPiece(p_191086_1_, structureendcitypieces$citytemplate, new BlockPos(-1, 0, -1), "second_floor_2", rotation, false));
     ...
     private static final StructureEndCityPiecesUA.IGenerator TOWER_GENERATOR = new StructureEndCityPiecesUA.IGenerator()
     {
         ...
         public boolean generate(TemplateManager p_191086_1_, int p_191086_2_, StructureEndCityPiecesUA.CityTemplate p_191086_3_, BlockPos p_191086_4_, List<StructureComponent> p_191086_5_, Random p_191086_6_)
         {
             ...
             StructureEndCityPiecesUA.CityTemplate structureendcitypieces$citytemplate1 = lvt_8_1_;
             int i = 3;
             ...
             if (structureendcitypieces$citytemplate1 != null)
             {
                 for (Tuple<Rotation, BlockPos> tuple : StructureEndCityPiecesUA.TOWER_BRIDGES)
                 {
                         ...
                         StructureEndCityPiecesUA.CityTemplate structureendcitypieces$citytemplate2 = StructureEndCityPiecesUA.addHelper(p_191086_5_, StructureEndCityPiecesUA.addPiece(p_191086_1_, structureendcitypieces$citytemplate1, tuple.getSecond(), "bridge_end", rotation.add(tuple.getFirst()), true));
                         StructureEndCityPiecesUA.recursiveChildren(p_191086_1_, StructureEndCityPiecesUA.TOWER_BRIDGE_GENERATOR, p_191086_2_ + 1, structureendcitypieces$citytemplate2, (BlockPos)null, p_191086_5_, p_191086_6_);
     ...
     private static final StructureEndCityPiecesUA.IGenerator TOWER_BRIDGE_GENERATOR = new StructureEndCityPiecesUA.IGenerator()
     {
         ...
         public boolean generate(TemplateManager p_191086_1_, int p_191086_2_, StructureEndCityPiecesUA.CityTemplate p_191086_3_, BlockPos p_191086_4_, List<StructureComponent> p_191086_5_, Random p_191086_6_)
         {
             Rotation rotation = p_191086_3_.placeSettings.getRotation();
             int i = 4;
             StructureEndCityPiecesUA.CityTemplate structureendcitypieces$citytemplate = StructureEndCityPiecesUA.addHelper(p_191086_5_, StructureEndCityPiecesUA.addPiece(p_191086_1_, p_191086_3_, new BlockPos(0, 0, -4), "bridge_piece", rotation, true));
             ...
             for (int k = 0; k < i; ++k)
             {
                 ...
                 else
                 {
                     if (p_191086_6_.nextBoolean())
                     {
                         structureendcitypieces$citytemplate = StructureEndCityPiecesUA.addHelper(p_191086_5_, StructureEndCityPiecesUA.addPiece(p_191086_1_, structureendcitypieces$citytemplate, new BlockPos(0, j, -4), "bridge_steep_stairs", rotation, true));
                     }
                     else
                     {
                         structureendcitypieces$citytemplate = StructureEndCityPiecesUA.addHelper(p_191086_5_, StructureEndCityPiecesUA.addPiece(p_191086_1_, structureendcitypieces$citytemplate, new BlockPos(0, j, -8), "bridge_gentle_stairs", rotation, true));
                     }
             ...
             else if (!StructureEndCityPiecesUA.recursiveChildren(p_191086_1_, StructureEndCityPiecesUA.HOUSE_TOWER_GENERATOR, p_191086_2_ + 1, structureendcitypieces$citytemplate, new BlockPos(-3, j + 1, -11), p_191086_5_, p_191086_6_))
             {
                 return false;
             }

             structureendcitypieces$citytemplate = StructureEndCityPiecesUA.addHelper(p_191086_5_, StructureEndCityPiecesUA.addPiece(p_191086_1_, structureendcitypieces$citytemplate, new BlockPos(4, j, 0), "bridge_end", rotation.add(Rotation.CLOCKWISE_180), true));
             structureendcitypieces$citytemplate.componentType = -1;
             return true;
         }
     };
     ...
     private static final StructureEndCityPiecesUA.IGenerator FAT_TOWER_GENERATOR = new StructureEndCityPiecesUA.IGenerator()
     {
         ...
         {
             Rotation rotation = p_191086_3_.placeSettings.getRotation();
             StructureEndCityPiecesUA.CityTemplate structureendcitypieces$citytemplate = StructureEndCityPiecesUA.addHelper(p_191086_5_, StructureEndCityPiecesUA.addPiece(p_191086_1_, p_191086_3_, new BlockPos(-3, 4, -3), "fat_tower_base", rotation, true));
             ...
             for (int i = 0; i < 4; ++i)
             {
                 ...
                 {
                         StructureEndCityPiecesUA.CityTemplate structureendcitypieces$citytemplate1 = StructureEndCityPiecesUA.addHelper(p_191086_5_, StructureEndCityPiecesUA.addPiece(p_191086_1_, structureendcitypieces$citytemplate, tuple.getSecond(), "bridge_end", rotation.add(tuple.getFirst()), true));
                         StructureEndCityPiecesUA.recursiveChildren(p_191086_1_, StructureEndCityPiecesUA.TOWER_BRIDGE_GENERATOR, p_191086_2_ + 1, structureendcitypieces$citytemplate1, (BlockPos)null, p_191086_5_, p_191086_6_);
     ...
     {
         MapGenStructureIO.registerStructureComponent(StructureEndCityPiecesUA.CityTemplate.class, "ECP");
     }
     ...
     {
         StructureEndCityPiecesUA.CityTemplate structureendcitypieces$citytemplate = new StructureEndCityPiecesUA.CityTemplate(p_191090_0_, p_191090_3_, p_191090_1_.templatePosition, p_191090_4_, owerwrite);
     ...
     public static void startHouseTower(TemplateManager p_191087_0_, BlockPos p_191087_1_, Rotation p_191087_2_, List<StructureComponent> p_191087_3_, Random p_191087_4_)
     {
         ...
         StructureEndCityPiecesUA.CityTemplate structureendcitypieces$citytemplate = addHelper(p_191087_3_, new StructureEndCityPiecesUA.CityTemplate(p_191087_0_, "base_floor", p_191087_1_, p_191087_2_, true));
     ...
     private static StructureEndCityPiecesUA.CityTemplate addHelper(List<StructureComponent> p_189935_0_, StructureEndCityPiecesUA.CityTemplate p_189935_1_)
     {
         p_189935_0_.add(p_189935_1_);
         return p_189935_1_;
     }

     private static boolean recursiveChildren(TemplateManager p_191088_0_, StructureEndCityPiecesUA.IGenerator p_191088_1_, int p_191088_2_, StructureEndCityPiecesUA.CityTemplate p_191088_3_, BlockPos p_191088_4_, List<StructureComponent> p_191088_5_, Random p_191088_6_)
     {
         if (p_191088_2_ > 8)
         {
             return false;
     ...
     interface IGenerator
     {
         ...
         boolean generate(TemplateManager p_191086_1_, int p_191086_2_, StructureEndCityPiecesUA.CityTemplate p_191086_3_, BlockPos p_191086_4_, List<StructureComponent> p_191086_5_, Random p_191086_6_);
     }
 }