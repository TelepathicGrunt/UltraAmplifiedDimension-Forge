...
public class StructureMineshaftPiecesUA
{
    ...
    {
    	StructureIO.registerStructureComponent(StructureMineshaftPiecesUA.Corridor.class, "MSCorridor");
    	StructureIO.registerStructureComponent(StructureMineshaftPiecesUA.Cross.class, "MSCrossing");
    	StructureIO.registerStructureComponent(StructureMineshaftPiecesUA.Room.class, "MSRoom");
        StructureIO.registerStructureComponent(StructureMineshaftPiecesUA.Stairs.class, "MSStairs");
    }

    private static StructureMineshaftPiecesUA.Peice createRandomShaftPiece(List<StructurePiece> p_189940_0_, Random p_189940_1_, int p_189940_2_, int p_189940_3_, int p_189940_4_, @Nullable EnumFacing p_189940_5_, int p_189940_6_, MapGenMineshaftUA.Type p_189940_7_)
    {
        int i = p_189940_1_.nextInt(100);

        if (i >= 80)
        {
            MutableBoundingBox MutableBoundingBox = StructureMineshaftPiecesUA.Cross.findCrossing(p_189940_0_, p_189940_1_, p_189940_2_, p_189940_3_, p_189940_4_, p_189940_5_);

            if (MutableBoundingBox != null)
            {
                return new StructureMineshaftPiecesUA.Cross(p_189940_6_, p_189940_1_, MutableBoundingBox, p_189940_5_, p_189940_7_);
            }
        }
        else if (i >= 70)
        {
            MutableBoundingBox MutableBoundingBox1 = StructureMineshaftPiecesUA.Stairs.findStairs(p_189940_0_, p_189940_1_, p_189940_2_, p_189940_3_, p_189940_4_, p_189940_5_);

            if (MutableBoundingBox1 != null)
            {
                return new StructureMineshaftPiecesUA.Stairs(p_189940_6_, p_189940_1_, MutableBoundingBox1, p_189940_5_, p_189940_7_);
            }
        }
        else
        {
            MutableBoundingBox MutableBoundingBox2 = StructureMineshaftPiecesUA.Corridor.findCorridorSize(p_189940_0_, p_189940_1_, p_189940_2_, p_189940_3_, p_189940_4_, p_189940_5_);

            if (MutableBoundingBox2 != null)
            {
                return new StructureMineshaftPiecesUA.Corridor(p_189940_6_, p_189940_1_, MutableBoundingBox2, p_189940_5_, p_189940_7_);
            }
        }
    ...
    private static StructureMineshaftPiecesUA.Peice generateAndAddPiece(StructurePiece p_189938_0_, List<StructurePiece> p_189938_1_, Random p_189938_2_, int p_189938_3_, int p_189938_4_, int p_189938_5_, EnumFacing p_189938_6_, int p_189938_7_)
    {
        if (p_189938_7_ > 8)
        {
            return null;
        ...
        {
        	MapGenMineshaftUA.Type mapgenmineshaft$type = ((StructureMineshaftPiecesUA.Peice)p_189938_0_).mineShaftType;
            StructureMineshaftPiecesUA.Peice structuremineshaftpieces$peice = createRandomShaftPiece(p_189938_1_, p_189938_2_, p_189938_3_, p_189938_4_, p_189938_5_, p_189938_6_, p_189938_7_ + 1, mapgenmineshaft$type);
    ...
    public static class Corridor extends StructureMineshaftPiecesUA.Peice
    {
        ...
        public Corridor(int p_i47140_1_, Random p_i47140_2_, MutableBoundingBox p_i47140_3_, EnumFacing p_i47140_4_, MapGenMineshaftUA.Type p_i47140_5_)
        {
            ...
            if (enumfacing != null)
            {
                switch (enumfacing)
                {
                    ...
                    default:
                        if (j <= 1)
                        {
                            StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ - 1, enumfacing, i);
                        }
                        else if (j == 2)
                        {
                            StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ, EnumFacing.WEST, i);
                        }
                        else
                        {
                            StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ, EnumFacing.EAST, i);
                        }
                    ...
                    case SOUTH:
                        if (j <= 1)
                        {
                            StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ + 1, enumfacing, i);
                        }
                        else if (j == 2)
                        {
                            StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ - 3, EnumFacing.WEST, i);
                        }
                        else
                        {
                            StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ - 3, EnumFacing.EAST, i);
                        }
                    ...
                    case WEST:
                        if (j <= 1)
                        {
                            StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ, enumfacing, i);
                        }
                        else if (j == 2)
                        {
                            StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ - 1, EnumFacing.NORTH, i);
                        }
                        else
                        {
                            StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
                        }
                    ...
                    case EAST:
                        if (j <= 1)
                        {
                            StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ, enumfacing, i);
                        }
                        else if (j == 2)
                        {
                            StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX - 3, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ - 1, EnumFacing.NORTH, i);
                        }
                        else
                        {
                            StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX - 3, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
                        }
                }
            }
            ...
            if (i < 8)
            {
                if (enumfacing != EnumFacing.NORTH && enumfacing != EnumFacing.SOUTH)
                {
                    for (int i1 = this.boundingBox.minX + 3; i1 + 3 <= this.boundingBox.maxX; i1 += 5)
                    {
                        ...
                        if (j1 == 0)
                        {
                            StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, i1, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, i + 1);
                        }
                        else if (j1 == 1)
                        {
                            StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, i1, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i + 1);
                        }
                    }
                }
                else
                {
                    for (int k = this.boundingBox.minZ + 3; k + 3 <= this.boundingBox.maxZ; k += 5)
                    {
                        ...
                        if (l == 0)
                        {
                            StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, k, EnumFacing.WEST, i + 1);
                        }
                        else if (l == 1)
                        {
                            StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, k, EnumFacing.EAST, i + 1);
                        }
                    }
                }
            }
            ...
            if (this.isSupportingBox(worldIn, boundingBox, x, p_189921_7_, y, z))
            {
                ...
                else
                {
                    ...
                    else if(this.mineShaftType == Type.HELL) 
                    {
	                    ...
	                    this.randomlyPlaceBlock(worldIn, boundingBox, random, 0.08F, x + 1, y, z - 1, Blocks.TORCH.getDefaultState().with(BlockTorchWall.HORIZONTAL_FACING, EnumFacing.SOUTH));
	                    this.randomlyPlaceBlock(worldIn, boundingBox, random, 0.08F, x + 1, y, z + 1, Blocks.TORCH.getDefaultState().with(BlockTorchWall.HORIZONTAL_FACING, EnumFacing.NORTH));
                    }
                }
            }
        }
    ...
    public static class Cross extends StructureMineshaftPiecesUA.Peice
    {
        ...
        public Cross(int p_i47139_1_, Random p_i47139_2_, MutableBoundingBox p_i47139_3_, @Nullable EnumFacing p_i47139_4_, MapGenMineshaftUA.Type p_i47139_5_)
        {
        ...
        public void buildComponent(StructurePiece componentIn, List<StructurePiece> listIn, Random rand)
        {
            ...
            switch (this.corridorDirection)
            {
                case NORTH:
                default:
                    StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, i);
                    StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ + 1, EnumFacing.WEST, i);
                    StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ + 1, EnumFacing.EAST, i);
                    break;

                case SOUTH:
                    StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
                    StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ + 1, EnumFacing.WEST, i);
                    StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ + 1, EnumFacing.EAST, i);
                    break;
            ...
            if (this.isMultipleFloors)
            {
                if (rand.nextBoolean())
                {
                    StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.minY + 3 + 1, this.boundingBox.minZ - 1, EnumFacing.NORTH, i);
                }

                if (rand.nextBoolean())
                {
                    StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY + 3 + 1, this.boundingBox.minZ + 1, EnumFacing.WEST, i);
                }

                if (rand.nextBoolean())
                {
                    StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + 3 + 1, this.boundingBox.minZ + 1, EnumFacing.EAST, i);
                }

                if (rand.nextBoolean())
                {
                    StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.minY + 3 + 1, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
                }
            }
        }
    ...
    abstract static class Peice extends StructurePiece
    {
        ...
        protected void readStructureFromNBT(NBTTagCompound tagCompound, TemplateManager p_143011_2_)
        {
            this.mineShaftType = MapGenMineshaftUA.Type.byId(tagCompound.getInt("MST"));
        }
    ...
    public static class Room extends StructureMineshaftPiecesUA.Peice
    {
        ...
        public void buildComponent(StructurePiece componentIn, List<StructurePiece> listIn, Random rand)
        {
            ...
            for (int j = 0; j < this.boundingBox.getXSize(); j = l + 4)
            {
                ...
                StructureMineshaftPiecesUA.Peice structuremineshaftpieces$peice = StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX + l, this.boundingBox.minY + rand.nextInt(k) + 1, this.boundingBox.minZ - 1, EnumFacing.NORTH, i);
            ...
            for (int i1 = 0; i1 < this.boundingBox.getXSize(); i1 = l + 4)
            {
                ...
                StructureMineshaftPiecesUA.Peice structuremineshaftpieces$peice1 = StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX + l, this.boundingBox.minY + rand.nextInt(k) + 1, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
            ...
            for (int j1 = 0; j1 < this.boundingBox.getZSize(); j1 = l + 4)
            {
                ...
                StructureMineshaftPiecesUA.Peice structuremineshaftpieces$peice2 = StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY + rand.nextInt(k) + 1, this.boundingBox.minZ + l, EnumFacing.WEST, i);
            ...
            for (int k1 = 0; k1 < this.boundingBox.getZSize(); k1 = l + 4)
            {
                ...
                StructurePiece StructurePiece = StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + rand.nextInt(k) + 1, this.boundingBox.minZ + l, EnumFacing.EAST, i);
        ...
        public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox MutableBoundingBoxIn, ChunkPos p_74875_4_)
        {
        	...
        	if(this.mineShaftType == MapGenMineshaftUA.Type.HELL) 
            {
        	...
        	if(this.boundingBox.getYSize() > 100) {
                this.fillWithBlocks(worldIn, MutableBoundingBoxIn, this.boundingBox.minX-10, this.boundingBox.minY, this.boundingBox.minZ-10, this.boundingBox.maxX+10, this.boundingBox.minY, this.boundingBox.maxZ+10, flooring, CAVE_AIR, false);
                this.fillWithBlocks(worldIn, MutableBoundingBoxIn, this.boundingBox.minX-10, this.boundingBox.minY + 1, this.boundingBox.minZ-10, this.boundingBox.maxX+10, Math.min(this.boundingBox.minY + 3, this.boundingBox.maxY), this.boundingBox.maxZ+10, CAVE_AIR, CAVE_AIR, false);
                ...
                this.randomlyRareFillWithBlocks(worldIn, MutableBoundingBoxIn, this.boundingBox.minX-10, this.boundingBox.minY + 4, this.boundingBox.minZ-10, this.boundingBox.maxX+10, this.boundingBox.maxY, this.boundingBox.maxZ+10, CAVE_AIR, false);
                return true;
       		}
        	else {
                ...
                this.fillWithBlocks(worldIn, MutableBoundingBoxIn, this.boundingBox.minX, this.boundingBox.minY + 1, this.boundingBox.minZ, this.boundingBox.maxX, Math.min(this.boundingBox.minY + 3, this.boundingBox.maxY), this.boundingBox.maxZ+10, CAVE_AIR, CAVE_AIR, false);
    ...
    public static class Stairs extends StructureMineshaftPiecesUA.Peice
    {
        public Stairs()
        {
        }

        public Stairs(int p_i47136_1_, Random p_i47136_2_, MutableBoundingBox p_i47136_3_, EnumFacing p_i47136_4_, MapGenMineshaftUA.Type p_i47136_5_)
        {
        ...
        public void buildComponent(StructurePiece componentIn, List<StructurePiece> listIn, Random rand)
        {
            ...
            if (enumfacing != null)
            {
                switch (enumfacing)
                {
                    case NORTH:
                    default:
                        StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, i);
                        break;

                    case SOUTH:
                        StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
                        break;

                    case WEST:
                        StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.WEST, i);
                        break;

                    case EAST:
                        StructureMineshaftPiecesUA.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.EAST, i);
                }
            }
        }
