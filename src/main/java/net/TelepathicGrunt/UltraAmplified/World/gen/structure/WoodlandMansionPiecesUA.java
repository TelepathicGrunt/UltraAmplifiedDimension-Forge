...
public class WoodlandMansionPiecesUA
{
    ...
    {
        MapGenStructureIO.registerStructureComponent(WoodlandMansionPiecesUA.MansionTemplate.class, "WMP");
    }

    public static void generateMansion(TemplateManager p_191152_0_, BlockPos p_191152_1_, Rotation p_191152_2_, List<WoodlandMansionPiecesUA.MansionTemplate> p_191152_3_, Random p_191152_4_)
    {
        WoodlandMansionPiecesUA.Grid woodlandmansionpieces$grid = new WoodlandMansionPiecesUA.Grid(p_191152_4_);
        WoodlandMansionPiecesUA.Placer woodlandmansionpieces$placer = new WoodlandMansionPiecesUA.Placer(p_191152_0_, p_191152_4_);
        woodlandmansionpieces$placer.createMansion(p_191152_1_, p_191152_2_, p_191152_3_, woodlandmansionpieces$grid);
    }

    static class FirstFloor extends WoodlandMansionPiecesUA.RoomCollection
        {
            private FirstFloor()
            {
            }
    ...
    static class Grid
        {
            ...
            private final WoodlandMansionPiecesUA.SimpleGrid baseGrid;
            private final WoodlandMansionPiecesUA.SimpleGrid thirdFloorGrid;
            private final WoodlandMansionPiecesUA.SimpleGrid[] floorRooms;
            ...
            public Grid(Random randomIn)
            {
                ...
                this.floorRooms = new WoodlandMansionPiecesUA.SimpleGrid[3];
                this.floorRooms[0] = new WoodlandMansionPiecesUA.SimpleGrid(11, 11, 5);
                this.floorRooms[1] = new WoodlandMansionPiecesUA.SimpleGrid(11, 11, 5);
                this.floorRooms[2] = new WoodlandMansionPiecesUA.SimpleGrid(11, 11, 5);
                ...
                this.thirdFloorGrid = new WoodlandMansionPiecesUA.SimpleGrid(this.baseGrid.width, this.baseGrid.height, 5);
                this.setupThirdFloor();
                this.identifyRooms(this.thirdFloorGrid, this.floorRooms[2]);
            }

            public static boolean isHouse(WoodlandMansionPiecesUA.SimpleGrid p_191109_0_, int p_191109_1_, int p_191109_2_)
            {
                int i = p_191109_0_.get(p_191109_1_, p_191109_2_);
                return i == 1 || i == 2 || i == 3 || i == 4;
            }

            public boolean isRoomId(WoodlandMansionPiecesUA.SimpleGrid p_191114_1_, int p_191114_2_, int p_191114_3_, int p_191114_4_, int p_191114_5_)
            {
                return (this.floorRooms[p_191114_4_].get(p_191114_2_, p_191114_3_) & 65535) == p_191114_5_;
            }

            @Nullable
            public EnumFacing get1x2RoomDirection(WoodlandMansionPiecesUA.SimpleGrid p_191113_1_, int p_191113_2_, int p_191113_3_, int p_191113_4_, int p_191113_5_)
            {
            ...
            private void recursiveCorridor(WoodlandMansionPiecesUA.SimpleGrid p_191110_1_, int p_191110_2_, int p_191110_3_, EnumFacing p_191110_4_, int p_191110_5_)
            {
                if (p_191110_5_ > 0)
                {
            ...
            private boolean cleanEdges(WoodlandMansionPiecesUA.SimpleGrid p_191111_1_)
            {
                boolean flag = false;
            ...
            private void setupThirdFloor()
            {
                ...
                WoodlandMansionPiecesUA.SimpleGrid woodlandmansionpieces$simplegrid = this.floorRooms[1];
            ...
            private void identifyRooms(WoodlandMansionPiecesUA.SimpleGrid p_191116_1_, WoodlandMansionPiecesUA.SimpleGrid p_191116_2_)
            {
                List<Tuple<Integer, Integer>> list = Lists.<Tuple<Integer, Integer>>newArrayList();
    ...
    static class Placer
        {
            ...
            public void createMansion(BlockPos p_191125_1_, Rotation p_191125_2_, List<WoodlandMansionPiecesUA.MansionTemplate> p_191125_3_, WoodlandMansionPiecesUA.Grid p_191125_4_)
            {
                WoodlandMansionPiecesUA.PlacementData woodlandmansionpieces$placementdata = new WoodlandMansionPiecesUA.PlacementData();
                ...
                WoodlandMansionPiecesUA.PlacementData woodlandmansionpieces$placementdata1 = new WoodlandMansionPiecesUA.PlacementData();
                ...
                WoodlandMansionPiecesUA.SimpleGrid woodlandmansionpieces$simplegrid = p_191125_4_.baseGrid;
                WoodlandMansionPiecesUA.SimpleGrid woodlandmansionpieces$simplegrid1 = p_191125_4_.thirdFloorGrid;
                ...
                WoodlandMansionPiecesUA.PlacementData woodlandmansionpieces$placementdata2 = new WoodlandMansionPiecesUA.PlacementData();
                ...
                for (int k = 0; k < woodlandmansionpieces$simplegrid1.height && !flag; ++k)
                {
                    ...
                    {
                        if (WoodlandMansionPiecesUA.Grid.isHouse(woodlandmansionpieces$simplegrid1, l, k))
                        {
                ...
                this.createRoof(p_191125_3_, p_191125_1_.up(27), p_191125_2_, woodlandmansionpieces$simplegrid1, (WoodlandMansionPiecesUA.SimpleGrid)null);
                ...
                WoodlandMansionPiecesUA.RoomCollection[] awoodlandmansionpieces$roomcollection = new WoodlandMansionPiecesUA.RoomCollection[3];
                awoodlandmansionpieces$roomcollection[0] = new WoodlandMansionPiecesUA.FirstFloor();
                awoodlandmansionpieces$roomcollection[1] = new WoodlandMansionPiecesUA.SecondFloor();
                awoodlandmansionpieces$roomcollection[2] = new WoodlandMansionPiecesUA.ThirdFloor();

                for (int l2 = 0; l2 < 3; ++l2)
                {
                    BlockPos blockpos = p_191125_1_.up(8 * l2 + (l2 == 2 ? 3 : 0));
                    WoodlandMansionPiecesUA.SimpleGrid woodlandmansionpieces$simplegrid2 = p_191125_4_.floorRooms[l2];
                    WoodlandMansionPiecesUA.SimpleGrid woodlandmansionpieces$simplegrid3 = l2 == 2 ? woodlandmansionpieces$simplegrid1 : woodlandmansionpieces$simplegrid;
                    ...
                    for (int i1 = 0; i1 < woodlandmansionpieces$simplegrid3.height; ++i1)
                    {
                        for (int j1 = 0; j1 < woodlandmansionpieces$simplegrid3.width; ++j1)
                        {
                            if (woodlandmansionpieces$simplegrid3.get(j1, i1) == 1)
                            {
                                ...
                                p_191125_3_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, "corridor_floor", blockpos1, p_191125_2_));

                                if (woodlandmansionpieces$simplegrid3.get(j1, i1 - 1) == 1 || (woodlandmansionpieces$simplegrid2.get(j1, i1 - 1) & 8388608) == 8388608)
                                {
                                    p_191125_3_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, "carpet_north", blockpos1.offset(p_191125_2_.rotate(EnumFacing.EAST), 1).up(), p_191125_2_));
                                }

                                if (woodlandmansionpieces$simplegrid3.get(j1 + 1, i1) == 1 || (woodlandmansionpieces$simplegrid2.get(j1 + 1, i1) & 8388608) == 8388608)
                                {
                                    p_191125_3_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, "carpet_east", blockpos1.offset(p_191125_2_.rotate(EnumFacing.SOUTH), 1).offset(p_191125_2_.rotate(EnumFacing.EAST), 5).up(), p_191125_2_));
                                }

                                if (woodlandmansionpieces$simplegrid3.get(j1, i1 + 1) == 1 || (woodlandmansionpieces$simplegrid2.get(j1, i1 + 1) & 8388608) == 8388608)
                                {
                                    p_191125_3_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, s, blockpos1.offset(p_191125_2_.rotate(EnumFacing.SOUTH), 5).offset(p_191125_2_.rotate(EnumFacing.WEST), 1), p_191125_2_));
                                }

                                if (woodlandmansionpieces$simplegrid3.get(j1 - 1, i1) == 1 || (woodlandmansionpieces$simplegrid2.get(j1 - 1, i1) & 8388608) == 8388608)
                                {
                                    p_191125_3_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, s1, blockpos1.offset(p_191125_2_.rotate(EnumFacing.WEST), 1).offset(p_191125_2_.rotate(EnumFacing.NORTH), 1), p_191125_2_));
                                }
                            }
                        }
                    }
                    ...
                    for (int k1 = 0; k1 < woodlandmansionpieces$simplegrid3.height; ++k1)
                    {
                        for (int l1 = 0; l1 < woodlandmansionpieces$simplegrid3.width; ++l1)
                        {
                            ...
                            if (woodlandmansionpieces$simplegrid3.get(l1, k1) == 2 || flag1)
                            {
                                ...
                                if (WoodlandMansionPiecesUA.Grid.isHouse(woodlandmansionpieces$simplegrid3, l1 - 1, k1) && !p_191125_4_.isRoomId(woodlandmansionpieces$simplegrid3, l1 - 1, k1, l2, k2))
                                {
                                    p_191125_3_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, enumfacing1 == EnumFacing.WEST ? s3 : s2, blockpos2, p_191125_2_));
                                }
                                ...
                                if (woodlandmansionpieces$simplegrid3.get(l1 + 1, k1) == 1 && !flag1)
                                {
                                    ...
                                    p_191125_3_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, enumfacing1 == EnumFacing.EAST ? s3 : s2, blockpos3, p_191125_2_));
                                }

                                if (WoodlandMansionPiecesUA.Grid.isHouse(woodlandmansionpieces$simplegrid3, l1, k1 + 1) && !p_191125_4_.isRoomId(woodlandmansionpieces$simplegrid3, l1, k1 + 1, l2, k2))
                                {
                                    ...
                                    p_191125_3_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, enumfacing1 == EnumFacing.SOUTH ? s3 : s2, blockpos4, p_191125_2_.add(Rotation.CLOCKWISE_90)));
                                }
                                ...
                                if (woodlandmansionpieces$simplegrid3.get(l1, k1 - 1) == 1 && !flag1)
                                {
                                    ...
                                    p_191125_3_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, enumfacing1 == EnumFacing.NORTH ? s3 : s2, blockpos5, p_191125_2_.add(Rotation.CLOCKWISE_90)));
                                }
            ...
            private void traverseOuterWalls(List<WoodlandMansionPiecesUA.MansionTemplate> p_191130_1_, WoodlandMansionPiecesUA.PlacementData p_191130_2_, WoodlandMansionPiecesUA.SimpleGrid p_191130_3_, EnumFacing p_191130_4_, int p_191130_5_, int p_191130_6_, int p_191130_7_, int p_191130_8_)
            {
                int i = p_191130_5_;
                int j = p_191130_6_;
            ...
            private void createRoof(List<WoodlandMansionPiecesUA.MansionTemplate> p_191123_1_, BlockPos p_191123_2_, Rotation p_191123_3_, WoodlandMansionPiecesUA.SimpleGrid p_191123_4_, @Nullable WoodlandMansionPiecesUA.SimpleGrid p_191123_5_)
            {
                for (int i = 0; i < p_191123_4_.height; ++i)
                {
                    for (int j = 0; j < p_191123_4_.width; ++j)
                    {
                        ...
                        boolean flag = p_191123_5_ != null && WoodlandMansionPiecesUA.Grid.isHouse(p_191123_5_, j, i);

                        if (WoodlandMansionPiecesUA.Grid.isHouse(p_191123_4_, j, i) && !flag)
                        {
                            p_191123_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, "roof", lvt_8_3_.up(3), p_191123_3_));

                            if (!WoodlandMansionPiecesUA.Grid.isHouse(p_191123_4_, j + 1, i))
                            {
                                BlockPos blockpos1 = lvt_8_3_.offset(p_191123_3_.rotate(EnumFacing.EAST), 6);
                                p_191123_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, "roof_front", blockpos1, p_191123_3_));
                            }
                            ...
                            if (!WoodlandMansionPiecesUA.Grid.isHouse(p_191123_4_, j - 1, i))
                            {
                                ...
                                p_191123_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, "roof_front", blockpos5, p_191123_3_.add(Rotation.CLOCKWISE_180)));
                            }

                            if (!WoodlandMansionPiecesUA.Grid.isHouse(p_191123_4_, j, i - 1))
                            {
                                BlockPos blockpos6 = lvt_8_3_.offset(p_191123_3_.rotate(EnumFacing.WEST), 1);
                                p_191123_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, "roof_front", blockpos6, p_191123_3_.add(Rotation.COUNTERCLOCKWISE_90)));
                            }
                            ...
                            if (!WoodlandMansionPiecesUA.Grid.isHouse(p_191123_4_, j, i + 1))
                            {
                                ...
                                p_191123_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, "roof_front", blockpos7, p_191123_3_.add(Rotation.CLOCKWISE_90)));
                            }
                        }
                    }
                }
                ...
                if (p_191123_5_ != null)
                {
                    for (int k = 0; k < p_191123_4_.height; ++k)
                    {
                        for (int i1 = 0; i1 < p_191123_4_.width; ++i1)
                        {
                            ...
                            boolean flag1 = WoodlandMansionPiecesUA.Grid.isHouse(p_191123_5_, i1, k);

                            if (WoodlandMansionPiecesUA.Grid.isHouse(p_191123_4_, i1, k) && flag1)
                            {
                                if (!WoodlandMansionPiecesUA.Grid.isHouse(p_191123_4_, i1 + 1, k))
                                {
                                    BlockPos blockpos8 = blockpos3.offset(p_191123_3_.rotate(EnumFacing.EAST), 7);
                                    p_191123_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, "small_wall", blockpos8, p_191123_3_));
                                }
                                ...
                                if (!WoodlandMansionPiecesUA.Grid.isHouse(p_191123_4_, i1 - 1, k))
                                {
                                    ...
                                    p_191123_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, "small_wall", blockpos9, p_191123_3_.add(Rotation.CLOCKWISE_180)));
                                }

                                if (!WoodlandMansionPiecesUA.Grid.isHouse(p_191123_4_, i1, k - 1))
                                {
                                    ...
                                    p_191123_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, "small_wall", blockpos10, p_191123_3_.add(Rotation.COUNTERCLOCKWISE_90)));
                                }
                                ...
                                if (!WoodlandMansionPiecesUA.Grid.isHouse(p_191123_4_, i1, k + 1))
                                {
                                    ...
                                    p_191123_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, "small_wall", blockpos11, p_191123_3_.add(Rotation.CLOCKWISE_90)));
                                }
                                ...
                                if (!WoodlandMansionPiecesUA.Grid.isHouse(p_191123_4_, i1 + 1, k))
                                {
                                    if (!WoodlandMansionPiecesUA.Grid.isHouse(p_191123_4_, i1, k - 1))
                                    {
                                        ...
                                        p_191123_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, "small_wall_corner", blockpos12, p_191123_3_));
                                    }
                                    ...
                                    if (!WoodlandMansionPiecesUA.Grid.isHouse(p_191123_4_, i1, k + 1))
                                    {
                                        ...
                                        p_191123_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, "small_wall_corner", blockpos13, p_191123_3_.add(Rotation.CLOCKWISE_90)));
                                    }
                                }
                                ...
                                if (!WoodlandMansionPiecesUA.Grid.isHouse(p_191123_4_, i1 - 1, k))
                                {
                                    if (!WoodlandMansionPiecesUA.Grid.isHouse(p_191123_4_, i1, k - 1))
                                    {
                                        ...
                                        p_191123_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, "small_wall_corner", blockpos14, p_191123_3_.add(Rotation.COUNTERCLOCKWISE_90)));
                                    }
                                    ...
                                    if (!WoodlandMansionPiecesUA.Grid.isHouse(p_191123_4_, i1, k + 1))
                                    {
                                        ...
                                        p_191123_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, "small_wall_corner", blockpos15, p_191123_3_.add(Rotation.CLOCKWISE_180)));
                                    }
                                }
                            }
                        }
                ...
                for (int l = 0; l < p_191123_4_.height; ++l)
                {
                    for (int j1 = 0; j1 < p_191123_4_.width; ++j1)
                    {
                        ...
                        boolean flag2 = p_191123_5_ != null && WoodlandMansionPiecesUA.Grid.isHouse(p_191123_5_, j1, l);

                        if (WoodlandMansionPiecesUA.Grid.isHouse(p_191123_4_, j1, l) && !flag2)
                        {
                            if (!WoodlandMansionPiecesUA.Grid.isHouse(p_191123_4_, j1 + 1, l))
                            {
                                BlockPos blockpos16 = blockpos4.offset(p_191123_3_.rotate(EnumFacing.EAST), 6);

                                if (!WoodlandMansionPiecesUA.Grid.isHouse(p_191123_4_, j1, l + 1))
                                {
                                    BlockPos blockpos2 = blockpos16.offset(p_191123_3_.rotate(EnumFacing.SOUTH), 6);
                                    p_191123_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, "roof_corner", blockpos2, p_191123_3_));
                                }
                                else if (WoodlandMansionPiecesUA.Grid.isHouse(p_191123_4_, j1 + 1, l + 1))
                                {
                                    BlockPos blockpos18 = blockpos16.offset(p_191123_3_.rotate(EnumFacing.SOUTH), 5);
                                    p_191123_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, "roof_inner_corner", blockpos18, p_191123_3_));
                                }

                                if (!WoodlandMansionPiecesUA.Grid.isHouse(p_191123_4_, j1, l - 1))
                                {
                                    p_191123_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, "roof_corner", blockpos16, p_191123_3_.add(Rotation.COUNTERCLOCKWISE_90)));
                                }
                                else if (WoodlandMansionPiecesUA.Grid.isHouse(p_191123_4_, j1 + 1, l - 1))
                                {
                                    ...
                                    p_191123_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, "roof_inner_corner", blockpos19, p_191123_3_.add(Rotation.CLOCKWISE_90)));
                                }
                            }
                            ...
                            if (!WoodlandMansionPiecesUA.Grid.isHouse(p_191123_4_, j1 - 1, l))
                            {
                                ...
                                if (!WoodlandMansionPiecesUA.Grid.isHouse(p_191123_4_, j1, l + 1))
                                {
                                    ...
                                    p_191123_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, "roof_corner", blockpos20, p_191123_3_.add(Rotation.CLOCKWISE_90)));
                                }
                                else if (WoodlandMansionPiecesUA.Grid.isHouse(p_191123_4_, j1 - 1, l + 1))
                                {
                                    ...
                                    p_191123_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, "roof_inner_corner", blockpos21, p_191123_3_.add(Rotation.COUNTERCLOCKWISE_90)));
                                }

                                if (!WoodlandMansionPiecesUA.Grid.isHouse(p_191123_4_, j1, l - 1))
                                {
                                    p_191123_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, "roof_corner", blockpos17, p_191123_3_.add(Rotation.CLOCKWISE_180)));
                                }
                                else if (WoodlandMansionPiecesUA.Grid.isHouse(p_191123_4_, j1 - 1, l - 1))
                                {
                                    BlockPos blockpos22 = blockpos17.offset(p_191123_3_.rotate(EnumFacing.SOUTH), 1);
                                    p_191123_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, "roof_inner_corner", blockpos22, p_191123_3_.add(Rotation.CLOCKWISE_180)));
                                }
                            }
                        }
                    }
            ...
            private void entrance(List<WoodlandMansionPiecesUA.MansionTemplate> p_191133_1_, WoodlandMansionPiecesUA.PlacementData p_191133_2_)
            {
                EnumFacing enumfacing = p_191133_2_.rotation.rotate(EnumFacing.WEST);
                p_191133_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, "entrance", p_191133_2_.position.offset(enumfacing, 9), p_191133_2_.rotation));
                p_191133_2_.position = p_191133_2_.position.offset(p_191133_2_.rotation.rotate(EnumFacing.SOUTH), 16);
            }

            private void traverseWallPiece(List<WoodlandMansionPiecesUA.MansionTemplate> p_191131_1_, WoodlandMansionPiecesUA.PlacementData p_191131_2_)
            {
                p_191131_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, p_191131_2_.wallType, p_191131_2_.position.offset(p_191131_2_.rotation.rotate(EnumFacing.EAST), 7), p_191131_2_.rotation));
                p_191131_2_.position = p_191131_2_.position.offset(p_191131_2_.rotation.rotate(EnumFacing.SOUTH), 8);
            }

            private void traverseTurn(List<WoodlandMansionPiecesUA.MansionTemplate> p_191124_1_, WoodlandMansionPiecesUA.PlacementData p_191124_2_)
            {
                p_191124_2_.position = p_191124_2_.position.offset(p_191124_2_.rotation.rotate(EnumFacing.SOUTH), -1);
                p_191124_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, "wall_corner", p_191124_2_.position, p_191124_2_.rotation));
            ...
            private void traverseInnerTurn(List<WoodlandMansionPiecesUA.MansionTemplate> p_191126_1_, WoodlandMansionPiecesUA.PlacementData p_191126_2_)
            {
            ...
            private void addRoom1x1(List<WoodlandMansionPiecesUA.MansionTemplate> p_191129_1_, BlockPos p_191129_2_, Rotation p_191129_3_, EnumFacing p_191129_4_, WoodlandMansionPiecesUA.RoomCollection p_191129_5_)
            {
                ...
                p_191129_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, s, blockpos1, rotation));
            }

            private void addRoom1x2(List<WoodlandMansionPiecesUA.MansionTemplate> p_191132_1_, BlockPos p_191132_2_, Rotation p_191132_3_, EnumFacing p_191132_4_, EnumFacing p_191132_5_, WoodlandMansionPiecesUA.RoomCollection p_191132_6_, boolean p_191132_7_)
            {
                if (p_191132_5_ == EnumFacing.EAST && p_191132_4_ == EnumFacing.SOUTH)
                {
                    ...
                    p_191132_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, p_191132_6_.get1x2SideEntrance(this.random, p_191132_7_), blockpos13, p_191132_3_));
                }
                else if (p_191132_5_ == EnumFacing.EAST && p_191132_4_ == EnumFacing.NORTH)
                {
                    ...
                    p_191132_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, p_191132_6_.get1x2SideEntrance(this.random, p_191132_7_), blockpos12, p_191132_3_, Mirror.LEFT_RIGHT));
                }
                else if (p_191132_5_ == EnumFacing.WEST && p_191132_4_ == EnumFacing.NORTH)
                {
                    ...
                    p_191132_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, p_191132_6_.get1x2SideEntrance(this.random, p_191132_7_), blockpos11, p_191132_3_.add(Rotation.CLOCKWISE_180)));
                }
                else if (p_191132_5_ == EnumFacing.WEST && p_191132_4_ == EnumFacing.SOUTH)
                {
                    ...
                    p_191132_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, p_191132_6_.get1x2SideEntrance(this.random, p_191132_7_), blockpos10, p_191132_3_, Mirror.FRONT_BACK));
                }
                else if (p_191132_5_ == EnumFacing.SOUTH && p_191132_4_ == EnumFacing.EAST)
                {
                    ...
                    p_191132_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, p_191132_6_.get1x2SideEntrance(this.random, p_191132_7_), blockpos9, p_191132_3_.add(Rotation.CLOCKWISE_90), Mirror.LEFT_RIGHT));
                }
                else if (p_191132_5_ == EnumFacing.SOUTH && p_191132_4_ == EnumFacing.WEST)
                {
                    ...
                    p_191132_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, p_191132_6_.get1x2SideEntrance(this.random, p_191132_7_), blockpos8, p_191132_3_.add(Rotation.CLOCKWISE_90)));
                }
                else if (p_191132_5_ == EnumFacing.NORTH && p_191132_4_ == EnumFacing.WEST)
                {
                    ...
                    p_191132_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, p_191132_6_.get1x2SideEntrance(this.random, p_191132_7_), blockpos7, p_191132_3_.add(Rotation.CLOCKWISE_90), Mirror.FRONT_BACK));
                }
                else if (p_191132_5_ == EnumFacing.NORTH && p_191132_4_ == EnumFacing.EAST)
                {
                    ...
                    p_191132_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, p_191132_6_.get1x2SideEntrance(this.random, p_191132_7_), blockpos6, p_191132_3_.add(Rotation.COUNTERCLOCKWISE_90)));
                }
                else if (p_191132_5_ == EnumFacing.SOUTH && p_191132_4_ == EnumFacing.NORTH)
                {
                    ...
                    p_191132_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, p_191132_6_.get1x2FrontEntrance(this.random, p_191132_7_), blockpos5, p_191132_3_));
                }
                else if (p_191132_5_ == EnumFacing.NORTH && p_191132_4_ == EnumFacing.SOUTH)
                {
                    ...
                    p_191132_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, p_191132_6_.get1x2FrontEntrance(this.random, p_191132_7_), blockpos4, p_191132_3_.add(Rotation.CLOCKWISE_180)));
                }
                else if (p_191132_5_ == EnumFacing.WEST && p_191132_4_ == EnumFacing.EAST)
                {
                    ...
                    p_191132_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, p_191132_6_.get1x2FrontEntrance(this.random, p_191132_7_), blockpos3, p_191132_3_.add(Rotation.CLOCKWISE_90)));
                }
                else if (p_191132_5_ == EnumFacing.EAST && p_191132_4_ == EnumFacing.WEST)
                {
                    ...
                    p_191132_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, p_191132_6_.get1x2FrontEntrance(this.random, p_191132_7_), blockpos2, p_191132_3_.add(Rotation.COUNTERCLOCKWISE_90)));
                }
                else if (p_191132_5_ == EnumFacing.UP && p_191132_4_ == EnumFacing.EAST)
                {
                    ...
                    p_191132_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, p_191132_6_.get1x2Secret(this.random), blockpos1, p_191132_3_.add(Rotation.CLOCKWISE_90)));
                }
                else if (p_191132_5_ == EnumFacing.UP && p_191132_4_ == EnumFacing.SOUTH)
                {
                    ...
                    p_191132_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, p_191132_6_.get1x2Secret(this.random), blockpos, p_191132_3_));
                }
            }

            private void addRoom2x2(List<WoodlandMansionPiecesUA.MansionTemplate> p_191127_1_, BlockPos p_191127_2_, Rotation p_191127_3_, EnumFacing p_191127_4_, EnumFacing p_191127_5_, WoodlandMansionPiecesUA.RoomCollection p_191127_6_)
            {
                int i = 0;
                int j = 0;
                ...
                p_191127_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, p_191127_6_.get2x2(this.random), blockpos, rotation, mirror));
            }

            private void addRoom2x2Secret(List<WoodlandMansionPiecesUA.MansionTemplate> p_191128_1_, BlockPos p_191128_2_, Rotation p_191128_3_, WoodlandMansionPiecesUA.RoomCollection p_191128_4_)
            {
                BlockPos blockpos = p_191128_2_.offset(p_191128_3_.rotate(EnumFacing.EAST), 1);
                p_191128_1_.add(new WoodlandMansionPiecesUA.MansionTemplate(this.templateManager, p_191128_4_.get2x2Secret(this.random), blockpos, p_191128_3_, Mirror.NONE));
            }
        }
    ...
    static class SecondFloor extends WoodlandMansionPiecesUA.RoomCollection
        {
            private SecondFloor()
            {
            }
    ...
    static class ThirdFloor extends WoodlandMansionPiecesUA.SecondFloor
    {
        private ThirdFloor()
        {
        }
